...
Topic: A Redução Retórica do Amor ao Mercado

Context:
Localização: Ato I, Cena 2.
Créssida, em solilóquio, revela que ama Troilo mas decide ocultar sentimentos para inflacionar seu valor: "Men prize the thing ungain'd more than it is."

Justification (COF Integration):
Créssida opera na esfera da *Retórica* e manipulação. Trata o afeto como bem de mercado. Não há "sinceridade do ser", apenas cálculo utilitário.
