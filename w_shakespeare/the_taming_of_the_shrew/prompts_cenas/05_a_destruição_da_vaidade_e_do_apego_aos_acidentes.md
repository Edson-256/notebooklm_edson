...
Topic: A Destruição da Vaidade e do Apego aos Acidentes

Context:
Localização: Ato 3, Cena 2.
Petruchio chega atrasado para o casamento, vestido com roupas velhas e absurdas. Ele afirma que Katherina está se casando com ele, e não com suas roupas. Na igreja, age como um louco.

Justification (COF Integration):
Separação do que é *substância* do que é *acidente*. Petruchio destrói a cerimônia burguesa para mostrar que o casamento é um sacramento de almas, não um desfile de modas.
