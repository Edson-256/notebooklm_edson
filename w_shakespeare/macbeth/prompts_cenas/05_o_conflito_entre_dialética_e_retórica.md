...
Topic: O Conflito entre Dialética e Retórica

Context:
Localização: Ato I, Cena 7.
Macbeth debate consigo e decide desistir do assassinato. Lady Macbeth questiona sua masculinidade e o convence a prosseguir.

Justification (COF Integration):
Macbeth inicia com discurso lógico e dialético preciso. Cede à retórica passional da esposa que o ataca no nível do ego. O intelecto perde para a pressão psicológica.
