...
Topic: A Inação como Cumplicidade Moral

Context:
Localização: 
Lucrécia implora por vingança: "let the traitor die; For sparing justice feeds iniquity."

Justification (COF Integration):
A omissão diante da injustiça degrada a ordem social. A misericórdia desordenada para com o tirano é uma crueldade para com os inocentes.
