...
Topic: O Sacrifício como Restauração da Ordem

Context:
Localização: 
Lucrécia se apunhala. Seu ato desperta Colatino "como de um sonho".

Justification (COF Integration):
O choque de ver a virtude destruída arranca os indivíduos de sua letargia e os força a despertar para a gravidade da existência.
