...
Author: Lew Wallace
Topic: A Ilusão do Poder e a Espera Armada

Context:
Localização: Livro Sétimo, Capítulo I
Ben-Hur, oculto sob a identidade de um simples filho de Judá, passa o inverno na Traconítida arregimentando e treinando três legiões de galileus de acordo com as rígidas táticas romanas. Certo de que o Rei aguardado precisará de um exército terrestre para estabelecer o seu trono e destruir Roma, ele aguarda o momento de agir, até receber a mensagem de que o Nazareno está a caminho.

Justification (COF Integration):
Esta cena é o ápice da tensão entre a Providência Divina e a cosmovisão mundana do homem. Ben-Hur projeta suas próprias ambições de vingança (sua "cápsula individual") sobre o plano transcendente, tentando encaixar o mistério do Messias na mediocridade de um projeto político militar. Para o leitor, é uma oportunidade profunda de experiência vicária: reconhecemos aqui a nossa própria tendência de tentar "ajudar a Deus" utilizando os meios do mundo, reduzindo promessas eternas a sucessos materiais e históricos imediatos.
