...
Topic: A Hierarquia dos Valores e a Alma Imortal

Context:
Localização: 
Lucrécia formula seu testamento: alma aos céus, corpo à terra, honra à faca, vergonha ao ofensor.

Justification (COF Integration):
Distinção antropológica clássica (corpo e alma). Clareza hierárquica impecável apesar do trauma. A culpa ontológica deve recair sobre o agressor.
