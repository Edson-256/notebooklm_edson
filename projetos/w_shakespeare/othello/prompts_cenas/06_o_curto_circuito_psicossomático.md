...
Topic: O Curto-Circuito Psicossomático

Context:
Localização: Ato IV, Cena 1.
As imagens gráficas de Iago fazem Othello colapsar em ataque epiléptico.

Justification (COF Integration):
A linguagem tem poder sobre a constituição humana. As imagens verbais repulsivas atuam diretamente sobre o imaginário, gerando dor tão insuportável que o corpo desliga.
