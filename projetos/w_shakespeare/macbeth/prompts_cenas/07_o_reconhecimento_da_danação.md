...
Topic: O Reconhecimento da Danação

Context:
Localização: Ato II, Cena 2.
Macbeth retorna em choque: não consegue dizer "Amém" e está convencido de que "Macbeth does murder sleep."

Justification (COF Integration):
"Conhecimento por presença." Macbeth descobre que seu ato destruiu sua conexão com a ordem divina. As palavras sagradas entalam em sua garganta.
