...
**Context & Anchoring:**
- **Scene Identifier:** L06-C02-LE_TROU_AUX_RATS_cena001
...
The sources uploaded to NotebookLM contain the full chapters. For this specific audio, you must find and focus **EXCLUSIVELY** on the scene from chapter `L06-C02-LE_TROU_AUX_RATS` that is bounded by the following text:

**Starts at:** "Que le lecteur nous permette de le ramener à la place de Grève, que nous avons quittée hier avec Gringoire pour suivre la Esmeralda."
**Ends at:** "Ce n’était pas du reste chose très rare dans les villes du moyen âge que cette espèce de tombeaux. On rencontrait souvent, dans la"
