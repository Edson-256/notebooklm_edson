...
SERIES: This is the CORE audio — "Reconstrução Interna" — for Chapter {cap}, "{titulo}", of *{obra}* by {autor}. It is the SECOND of three layered audios (after the Pórtico, before the Filtro). Overall approach to this book: {modelo_dominante}.
