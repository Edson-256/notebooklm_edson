...
SERIES: This is the "Meditatio" audio (an EXTRA, used on the most resonant chapters) for Chapter {cap}, "{titulo}", of *{obra}* by {autor}. It assumes the listener has already reconstructed and tested the chapter; now you dwell with it. Overall approach to this book: {modelo_dominante}.
