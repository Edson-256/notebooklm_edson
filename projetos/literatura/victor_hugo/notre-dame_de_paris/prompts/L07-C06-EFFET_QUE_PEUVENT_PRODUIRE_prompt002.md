...
**Context & Anchoring:**
- **Scene Identifier:** L07-C06-EFFET_QUE_PEUVENT_PRODUIRE_cena002
...
The sources uploaded to NotebookLM contain the full chapters. For this specific audio, you must find and focus **EXCLUSIVELY** on the scene from chapter `L07-C06-EFFET_QUE_PEUVENT_PRODUIRE` that is bounded by the following text:

**Starts at:** "Phœbus compta la monnaie et se tournant avec solennité vers Jehan : « Savez-vous, Jehan, qu’il y a vingt-trois sous parisis ! Qui avez-vous donc dévalisé cette nuit, rue Coupe-Gueule ? »"
**Ends at:** "Les enfants des Petits-Carreaux Se font pendre comme des veaux."
