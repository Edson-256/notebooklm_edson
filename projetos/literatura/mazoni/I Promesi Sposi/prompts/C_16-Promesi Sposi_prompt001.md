...
**Context & Anchoring:**
- **Scene Identifier:** C_16-Promesi Sposi_cena001
...
**Starts at:** "-- Scappa, scappa, galantuomo: lì c'è un convento, ecco là una chiesa1; di qui, di là, -- si grida a Renzo da ogni parte. In quanto allo scappare, pensate se aveva bisogno di consigli. Fin dal primo m..."
**Ends at:** "...: dà un'occhiata a quella piazza e alla porta della chiesa, e dice tra sé, sospirando: «m'aveva però dato un buon parere quel frate di ieri: che stessi in chiesa a aspettare, e a fare un po' di bene»."
