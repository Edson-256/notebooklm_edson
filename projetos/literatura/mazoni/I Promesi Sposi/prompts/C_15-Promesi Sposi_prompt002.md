...
**Context & Anchoring:**
- **Scene Identifier:** C_15-Promesi Sposi_cena002
...
The sources uploaded to NotebookLM contain the full chapters. For this specific audio, you must find and focus **EXCLUSIVELY** on the scene from chapter `C_15-Promesi Sposi` that is bounded by the following text:

**Starts at:** "L'oste gli diede l'aiuto richiesto; gli stese per di più la coperta addosso, e gli disse sgarbatamente -- buona notte --, che già quello russava. Poi, per quella specie d'attrattiva, che alle volte ci..."
**Ends at:** "... almeno capitato solo; che avrei chiuso un occhio, per questa sera; e domattina t'avrei fatto intender la ragione. Ma no signore; in compagnia ci vieni; e in compagnia d'un bargello6, per far meglio!»"
