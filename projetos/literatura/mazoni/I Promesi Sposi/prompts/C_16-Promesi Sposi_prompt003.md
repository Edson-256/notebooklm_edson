...
**Context & Anchoring:**
- **Scene Identifier:** C_16-Promesi Sposi_cena003
...
**Starts at:** "-- Siete fuor di strada, -- gli rispose questo; e, pensatoci un poco, parte con parole, parte co' cenni, gl'indicò il giro che doveva fare, per rimettersi sulla strada maestra. Renzo lo ringraziò, fec..."
**Ends at:** "...riusciva in quel giorno, era risoluto di camminare fin che l'ora e la lena glielo permettessero: e d'aspettar poi l'alba, in un campo, in un deserto; dove piacesse a Dio; pur che non fosse un'osteria."
