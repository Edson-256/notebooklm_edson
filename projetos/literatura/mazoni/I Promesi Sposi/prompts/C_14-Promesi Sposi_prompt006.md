...
**Context & Anchoring:**
- **Scene Identifier:** C_14-Promesi Sposi_cena006
...
The sources uploaded to NotebookLM contain the full chapters. For this specific audio, you must find and focus **EXCLUSIVELY** on the scene from chapter `C_14-Promesi Sposi` that is bounded by the following text:

**Starts at:** "-- Ecco come farei. Una meta onesta, che tutti ci potessero campare. E poi, distribuire il pane in ragione delle bocche: perché c'è degl'ingordi indiscreti, che vorrebbero tutto per loro, e fanno a ru..."
**Ends at:** "...iù sono inveterate e radicate in un uomo, tanto più facilmente, appena appena se n'allontani, se ne risente subito; dimodoché se ne ricordi poi per un pezzo; e anche uno sproposito gli serve di scola."
