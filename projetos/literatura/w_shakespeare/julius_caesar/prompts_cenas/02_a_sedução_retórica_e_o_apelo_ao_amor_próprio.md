...
Topic: A Sedução Retórica e o Apelo ao Amor-Próprio

Context:
Localização: Ato I, Cena 2.
Cássio manipula Brutus usando a metáfora do espelho, diminuindo a figura de César e questionando por que o nome de César soaria mais alto que o de Brutus.

Justification (COF Integration):
Aula magistral sobre o uso do *Discurso Retórico* para corrupção da inteligência. Cássio apela ao orgulho e à vaidade para corromper um homem que se julga virtuoso.
