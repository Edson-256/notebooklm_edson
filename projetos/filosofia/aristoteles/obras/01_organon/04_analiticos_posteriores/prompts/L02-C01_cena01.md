═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_04_l02_c01_cena01_analiticos_posteriores

 (Final filename on disk: aristoteles_04_l02_c01_cena01_analiticos_posteriores.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, Part 1 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 35 of 53 for *Posterior Analytics*.
...
1. **Título Principal:** "Guia de Estudos: Analíticos Posteriores — BOOK II, Capítulo Part 1 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Posterior Analytics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 1, bounded by:

**Starts at:** "The kinds of question we ask are as many as the kinds of things which we know. They are in fact four:-(1) whether the connexion of an attribute with a thing is a fact, (2) what is the reason of the co"
**Ends at:** "Where a complex is concerned, then, those are the two questions we ask; but for some objects of inquiry we have a different kind of question to ask, such as whether there is or is not a centaur or a G"
