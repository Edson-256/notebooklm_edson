═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_04_l01_c09_cena01_analiticos_posteriores

 (Final filename on disk: aristoteles_04_l01_c09_cena01_analiticos_posteriores.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 9 of 53 for *Posterior Analytics*.
...
1. **Título Principal:** "Guia de Estudos: Analíticos Posteriores — BOOK I, Capítulo Part 9 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Posterior Analytics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 9, bounded by:

**Starts at:** "It is clear that if the conclusion is to show an attribute inhering as such, nothing can be demonstrated except from its 'appropriate' basic truths. Consequently a proof even from true, indemonstrable"
**Ends at:** "But that is not so: the conclusion must be homogeneous with the basic facts of the science."
