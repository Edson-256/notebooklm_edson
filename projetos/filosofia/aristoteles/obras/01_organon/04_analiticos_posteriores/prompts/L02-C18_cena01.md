═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_04_l02_c18_cena01_analiticos_posteriores

 (Final filename on disk: aristoteles_04_l02_c18_cena01_analiticos_posteriores.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, Part 18 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 52 of 53 for *Posterior Analytics*.
...
1. **Título Principal:** "Guia de Estudos: Analíticos Posteriores — BOOK II, Capítulo Part 18 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Posterior Analytics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 18, bounded by:

**Starts at:** "If immediate premisses are not reached at once, and there is not merely one middle but several middles, i.e. several causes; is the cause of the property's inherence in the several species the middle"
**Ends at:** "To illustrate formally: C is the cause of B's inherence in D; hence C is the cause of A's inherence in D, B of A's inherence in C, while the cause of A's inherence in B is B itself."
