═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_04_l02_c14_cena01_analiticos_posteriores

 (Final filename on disk: aristoteles_04_l02_c14_cena01_analiticos_posteriores.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, Part 14 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 48 of 53 for *Posterior Analytics*.
...
1. **Título Principal:** "Guia de Estudos: Analíticos Posteriores — BOOK II, Capítulo Part 14 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Posterior Analytics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 14, bounded by:

**Starts at:** "In order to formulate the connexions we wish to prove we have to select our analyses and divisions. The method of selection consists in laying down the common genus of all our subjects of investigatio"
**Ends at:** "Yet a further method of selection is by analogy: for we cannot find a single identical name to give to a squid's pounce, a fish's spine, and an animal's bone, although these too possess common propert"
