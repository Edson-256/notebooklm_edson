═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_04_l01_c13_cena01_analiticos_posteriores

 (Final filename on disk: aristoteles_04_l01_c13_cena01_analiticos_posteriores.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 13 of 53 for *Posterior Analytics*.
...
1. **Título Principal:** "Guia de Estudos: Analíticos Posteriores — BOOK I, Capítulo Part 13 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Posterior Analytics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 13, bounded by:

**Starts at:** "Knowledge of the fact differs from knowledge of the reasoned fact."
**Ends at:** "medicine and geometry: it is the physician's business to know that circular wounds heal more slowly, the geometer's to know the reason why."
