═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_01_l02_c08_cena01_categorias

 (Final filename on disk: aristoteles_01_l02_c08_cena01_categorias.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 2, Part 8 (sub-cena 1 of 2).
- **Audio Position in This Work:** This is audio 10 of 19 for *Categories*.
...
1. **Título Principal:** "Guia de Estudos: Categorias — SECTION 2, Capítulo Part 8 (Cena 1/2)"
...
**Starts at:** "By 'quality' I mean that in virtue of which people are said to be such and such. Quality is a term that is used in many senses. One sort of quality let us call 'habit' or 'disposition'. Habit differ"
**Ends at:** "There may be other sorts of quality, but those that are most properly so called have, we may safely say, been enumerated."
