═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_01_l03_c10_cena01_categorias

 (Final filename on disk: aristoteles_01_l03_c10_cena01_categorias.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 3, Part 10 (sub-cena 1 of 2).
- **Audio Position in This Work:** This is audio 13 of 19 for *Categories*.
...
1. **Título Principal:** "Guia de Estudos: Categorias — SECTION 3, Capítulo Part 10 (Cena 1/2)"
...
**Starts at:** "The proposed categories have, then, been adequately dealt with."
**Ends at:** "Sight is not called the sight of blindness."
