═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_01_l03_c11_cena01_categorias

 (Final filename on disk: aristoteles_01_l03_c11_cena01_categorias.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 3, Part 11 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 15 of 19 for *Categories*.
...
1. **Título Principal:** "Guia de Estudos: Categorias — SECTION 3, Capítulo Part 11 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Categories*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 3, Part 11, bounded by:

**Starts at:** "That the contrary of a good is an evil is shown by induction: the contrary of health is disease, of courage, cowardice, and so on. But the contrary of an evil is sometimes a good, sometimes an evil. F"
**Ends at:** "White and black belong to the same genus, colour; justice and injustice, to contrary genera, virtue and vice; while good and evil do not belong to genera, but are themselves actual genera, with terms "
