═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_01_l01_c05_cena01_categorias

 (Final filename on disk: aristoteles_01_l01_c05_cena01_categorias.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 1, Part 5 (sub-cena 1 of 2).
- **Audio Position in This Work:** This is audio 5 of 19 for *Categories*.
...
1. **Título Principal:** "Guia de Estudos: Categorias — SECTION 1, Capítulo Part 5 (Cena 1/2)"
...
The sources uploaded to NotebookLM contain the full text of *Categories*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 1, Part 5, bounded by:

**Starts at:** "Substance, in the truest and primary and most definite sense of the word, is that which is neither predicable of a subject nor present in a subject; for instance, the individual man or horse. But in a"
**Ends at:** "The fact that the parts of substances appear to be present in the whole, as in a subject, should not make us apprehensive lest we should have to admit that such parts are not substances: for in explai"
