═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_01_l02_c07_cena01_categorias

 (Final filename on disk: aristoteles_01_l02_c07_cena01_categorias.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 2, Part 7 (sub-cena 1 of 2).
- **Audio Position in This Work:** This is audio 8 of 19 for *Categories*.
...
1. **Título Principal:** "Guia de Estudos: Categorias — SECTION 2, Capítulo Part 7 (Cena 1/2)"
...
The sources uploaded to NotebookLM contain the full text of *Categories*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 2, Part 7, bounded by:

**Starts at:** "Those things are called relative, which, being either said to be of something else or related to something else, are explained by reference to that other thing. For instance, the word 'superior' is ex"
**Ends at:** "When the terminology is thus correct, it is evident that all correlatives are interdependent."
