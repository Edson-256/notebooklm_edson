═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_06_l03_c30_cena01_refutacoes_sofisticas

 (Final filename on disk: aristoteles_06_l03_c30_cena01_refutacoes_sofisticas.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 3, Part 30 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 30 of 34 for *On Sophistical Refutations*.
...
1. **Título Principal:** "Guia de Estudos: Refutações Sofísticas — SECTION 3, Capítulo Part 30 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Sophistical Refutations*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 3, Part 30, bounded by:

**Starts at:** "To meet those refutations which make several questions into one, one should draw a distinction between them straight away at the start. For a question must be single to which there is a single answer,"
**Ends at:** "But it is clear that if there be not put a single question on a number of points, but the answerer has affirmed or denied one attribute only of one subject only, the absurdity will not come to pass."
