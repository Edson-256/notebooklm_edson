═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_06_l02_c20_cena01_refutacoes_sofisticas

 (Final filename on disk: aristoteles_06_l02_c20_cena01_refutacoes_sofisticas.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 20 of 34 for *On Sophistical Refutations*.
...
1. **Título Principal:** "Guia de Estudos: Refutações Sofísticas — SECTION 2, Capítulo Part 20 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Sophistical Refutations*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 2, Part 20, bounded by:

**Starts at:** "It is evident also how one should solve those refutations that depend upon the division and combination of words: for if the expression means something different when divided and when combined, as soo"
**Ends at:** "But evidently they do not solve it properly: for of arguments that depend upon the same point the solution is the same, whereas this will not fit all cases of the kind nor yet all ways of putting the "
