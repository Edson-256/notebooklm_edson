═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_06_l03_c28_cena01_refutacoes_sofisticas

 (Final filename on disk: aristoteles_06_l03_c28_cena01_refutacoes_sofisticas.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 3, Part 28 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 28 of 34 for *On Sophistical Refutations*.
...
1. **Título Principal:** "Guia de Estudos: Refutações Sofísticas — SECTION 3, Capítulo Part 28 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Sophistical Refutations*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 3, Part 28, bounded by:

**Starts at:** "Also, those refutations that bring one to their conclusion through the consequent you should show up in the course of the argument itself. The mode in which consequences follow is twofold. For the arg"
**Ends at:** "But that is not so; for the sequence is vice versa."
