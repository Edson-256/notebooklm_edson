═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_06_l03_c29_cena01_refutacoes_sofisticas

 (Final filename on disk: aristoteles_06_l03_c29_cena01_refutacoes_sofisticas.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 3, Part 29 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 29 of 34 for *On Sophistical Refutations*.
...
1. **Título Principal:** "Guia de Estudos: Refutações Sofísticas — SECTION 3, Capítulo Part 29 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Sophistical Refutations*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 3, Part 29, bounded by:

**Starts at:** "In the case of any refutations whose reasoning depends on some addition, look and see if upon its subtraction the absurdity follows none the less: and then if so, the answerer should point this out, a"
**Ends at:** "In the case of any refutations whose reasoning depends on some addition, look and see if upon its subtraction the absurdity follows none the less: and then if so, the answerer should point this out, a"
