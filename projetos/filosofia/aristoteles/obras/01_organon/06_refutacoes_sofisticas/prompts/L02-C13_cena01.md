═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_06_l02_c13_cena01_refutacoes_sofisticas

 (Final filename on disk: aristoteles_06_l02_c13_cena01_refutacoes_sofisticas.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 13 of 34 for *On Sophistical Refutations*.
...
1. **Título Principal:** "Guia de Estudos: Refutações Sofísticas — SECTION 2, Capítulo Part 13 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Sophistical Refutations*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 2, Part 13, bounded by:

**Starts at:** "Paradoxes, then, you should seek to elicit by means of these common-place rules. Now as for making any one babble, we have already said what we mean by 'to babble'. This is the object in view in all a"
**Ends at:** "Still it seems, inasmuch as the word is the same, to have the same meaning as well."
