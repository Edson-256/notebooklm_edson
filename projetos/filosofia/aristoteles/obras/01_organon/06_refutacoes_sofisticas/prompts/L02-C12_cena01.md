═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_06_l02_c12_cena01_refutacoes_sofisticas

 (Final filename on disk: aristoteles_06_l02_c12_cena01_refutacoes_sofisticas.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 2, Part 12 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 12 of 34 for *On Sophistical Refutations*.
...
1. **Título Principal:** "Guia de Estudos: Refutações Sofísticas — SECTION 2, Capítulo Part 12 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Sophistical Refutations*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 2, Part 12, bounded by:

**Starts at:** "So much, then, for apparent refutations."
**Ends at:** "To lead a man into paradoxes of this sort is the same as to lead him into the opposition of the standards of nature and law: for the law represents the opinion of the majority, whereas philosophers sp"
