═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_06_l03_c22_cena01_refutacoes_sofisticas

 (Final filename on disk: aristoteles_06_l03_c22_cena01_refutacoes_sofisticas.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 3, Part 22 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 22 of 34 for *On Sophistical Refutations*.
...
1. **Título Principal:** "Guia de Estudos: Refutações Sofísticas — SECTION 3, Capítulo Part 22 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Sophistical Refutations*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 3, Part 22, bounded by:

**Starts at:** "It is clear also how one must meet those fallacies that depend on the identical expressions of things that are not identical, seeing that we are in possession of the kinds of predications. For the one"
**Ends at:** "It is evident then that one must not grant that what is a common predicate applying to a class universally is an individual substance, but must say that denotes either a quality, or a relation, or a q"
