═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_05_l03_c05_cena01_topicos

 (Final filename on disk: aristoteles_05_l03_c05_cena01_topicos.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 34 of 83 for *Topics*.
...
1. **Título Principal:** "Guia de Estudos: Tópicos — BOOK III, Capítulo Part 5 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Topics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, Part 5, bounded by:

**Starts at:** "The commonplace rules relating to comparative degrees and amounts ought to be taken in the most general possible form: for when so taken they are likely to be useful in a larger number of instances. I"
**Ends at:** "if the definition of 'white' be 'a colour which pierces the vision', then that is whiter which is in a greater degree a colour that pierces the vision."
