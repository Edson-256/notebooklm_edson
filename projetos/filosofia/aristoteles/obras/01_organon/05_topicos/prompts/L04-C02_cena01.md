═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_05_l04_c02_cena01_topicos

 (Final filename on disk: aristoteles_05_l04_c02_cena01_topicos.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 37 of 83 for *Topics*.
...
1. **Título Principal:** "Guia de Estudos: Tópicos — BOOK IV, Capítulo Part 2 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Topics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IV, Part 2, bounded by:

**Starts at:** "Look and see, also, if there be any other genus of the given species which neither embraces the genus rendered nor yet falls under it, e.g. suppose any one were to lay down that 'knowledge' is the gen"
**Ends at:** "for 'movement' to be absent from the 'soul', or 'truth and falsehood' from 'opinion', then neither of the terms stated could be its genus or its differentia: for the general view is that the genus and"
