═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_05_l06_c01_cena01_topicos

 (Final filename on disk: aristoteles_05_l06_c01_cena01_topicos.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 50 of 83 for *Topics*.
...
1. **Título Principal:** "Guia de Estudos: Tópicos — BOOK VI, Capítulo Part 1 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Topics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VI, Part 1, bounded by:

**Starts at:** "The discussion of Definitions falls into five parts."
**Ends at:** "Again, each of the aforesaid branches is divided into a number of others."
