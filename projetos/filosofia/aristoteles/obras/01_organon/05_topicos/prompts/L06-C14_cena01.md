═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_05_l06_c14_cena01_topicos

 (Final filename on disk: aristoteles_05_l06_c14_cena01_topicos.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 64 of 83 for *Topics*.
...
1. **Título Principal:** "Guia de Estudos: Tópicos — BOOK VI, Capítulo Part 14 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Topics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VI, Part 14, bounded by:

**Starts at:** "Again, if he have described the whole compounded as the 'composition' of these things (e.g. 'a living creature' as a 'composition of soul and body'), first of all see whether he has omitted to state t"
**Ends at:** "As to definitions, then, let so much suffice."
