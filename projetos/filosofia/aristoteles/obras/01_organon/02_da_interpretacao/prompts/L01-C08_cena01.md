═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_02_l01_c08_cena01_da_interpretacao

 (Final filename on disk: aristoteles_02_l01_c08_cena01_da_interpretacao.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 8 of 14 for *On Interpretation*.
...
1. **Título Principal:** "Guia de Estudos: Da Interpretação — SECTION 1, Capítulo Part 8 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Interpretation*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 1, Part 8, bounded by:

**Starts at:** "An affirmation or denial is single, if it indicates some one fact about some one subject; it matters not whether the subject is universal and whether the statement has a universal character, or whethe"
**Ends at:** "This, then, is another instance of those propositions of which both the positive and the negative forms may be true or false simultaneously."
