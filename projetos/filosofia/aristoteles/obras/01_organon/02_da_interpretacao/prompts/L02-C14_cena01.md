═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_02_l02_c14_cena01_da_interpretacao

 (Final filename on disk: aristoteles_02_l02_c14_cena01_da_interpretacao.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 14 of 14 for *On Interpretation*.
...
1. **Título Principal:** "Guia de Estudos: Da Interpretação — SECTION 2, Capítulo Part 14 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Interpretation*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 2, Part 14, bounded by:

**Starts at:** "The question arises whether an affirmation finds its contrary in a denial or in another affirmation; whether the proposition 'every man is just' finds its contrary in the proposition 'no man is just',"
**Ends at:** "For whereas, when two propositions are true, a man may state both at the same time without inconsistency, contrary propositions are those which state contrary conditions, and contrary conditions canno"
