═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_02_l01_c07_cena01_da_interpretacao

 (Final filename on disk: aristoteles_02_l01_c07_cena01_da_interpretacao.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 7 of 14 for *On Interpretation*.
...
1. **Título Principal:** "Guia de Estudos: Da Interpretação — SECTION 1, Capítulo Part 7 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Interpretation*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 1, Part 7, bounded by:

**Starts at:** "Some things are universal, others individual."
**Ends at:** "We have pointed out, moreover, what the reason of this is and under what circumstances the truth of the one involves the falsity of the other."
