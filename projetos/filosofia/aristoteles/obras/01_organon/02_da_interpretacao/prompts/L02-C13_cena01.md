═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_02_l02_c13_cena01_da_interpretacao

 (Final filename on disk: aristoteles_02_l02_c13_cena01_da_interpretacao.m4a)
═══════════════════════════════════════════════════════════════════════════════

Act as a Senior Humanities Tutor specializing in the formative reading of Aristotle. Your goal is to write a detailed, highly pedagogical study guide (Guia de Estudos) to accompany and support the listener of the deep-dive audio overview of a specific passage from Aristotle's *On Interpretation*.

**Context & Anchoring:**
- **Work:** On Interpretation (Da Interpretação), translated by Edghill.
- **Passage Identifier:** SECTION 2, Part 13 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 13 of 14 for *On Interpretation*.
...
1. **Título Principal:** "Guia de Estudos: Da Interpretação — SECTION 2, Capítulo Part 13 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Interpretation*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 2, Part 13, bounded by:

**Starts at:** "Logical sequences follow in due course when we have arranged the propositions thus. From the proposition 'it may be' it follows that it is contingent, and the relation is reciprocal. It follows also t"
**Ends at:** "Some things are actualities without potentiality, namely, the primary substances; a second class consists of those things which are actual but also potential, whose actuality is in nature prior to the"
