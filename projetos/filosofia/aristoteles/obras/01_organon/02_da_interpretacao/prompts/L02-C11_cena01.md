═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_02_l02_c11_cena01_da_interpretacao

 (Final filename on disk: aristoteles_02_l02_c11_cena01_da_interpretacao.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 11 of 14 for *On Interpretation*.
...
1. **Título Principal:** "Guia de Estudos: Da Interpretação — SECTION 2, Capítulo Part 11 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Interpretation*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 2, Part 11, bounded by:

**Starts at:** "There is no unity about an affirmation or denial which, either positively or negatively, predicates one thing of many subjects, or many things of the same subject, unless that which is indicated by th"
**Ends at:** "But in the case of that which is not, it is not true to say that because it is the object of opinion, it is; for the opinion held about it is that it is not, not that it is."
