═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_03_l02_c03_cena01_analiticos_anteriores

 (Final filename on disk: aristoteles_03_l02_c03_cena01_analiticos_anteriores.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 49 of 73 for *Prior Analytics*.
...
1. **Título Principal:** "Guia de Estudos: Analíticos Anteriores — BOOK II, Capítulo Part 3 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Prior Analytics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 3, bounded by:

**Starts at:** "In the middle figure it is possible in every way to reach a true conclusion through false premisses, whether the syllogisms are universal or particular, viz. when both premisses are wholly false; when"
**Ends at:** "If then A is assumed to belong to the whole of B, and not to follow some C, the premisses are false but the conclusion is true."
