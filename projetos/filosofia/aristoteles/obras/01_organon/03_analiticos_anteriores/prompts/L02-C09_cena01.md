═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_03_l02_c09_cena01_analiticos_anteriores

 (Final filename on disk: aristoteles_03_l02_c09_cena01_analiticos_anteriores.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 55 of 73 for *Prior Analytics*.
...
1. **Título Principal:** "Guia de Estudos: Analíticos Anteriores — BOOK II, Capítulo Part 9 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Prior Analytics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 9, bounded by:

**Starts at:** "In the second figure it is not possible to refute the premiss which concerns the major extreme by establishing something contrary to it, whichever form the conversion of the conclusion may take. For t"
**Ends at:** "The same proof can be given if the universal statement is affirmative."
