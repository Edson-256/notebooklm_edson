═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_03_l02_c15_cena01_analiticos_anteriores

 (Final filename on disk: aristoteles_03_l02_c15_cena01_analiticos_anteriores.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 61 of 73 for *Prior Analytics*.
...
1. **Título Principal:** "Guia de Estudos: Analíticos Anteriores — BOOK II, Capítulo Part 15 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Prior Analytics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 15, bounded by:

**Starts at:** "In what figure it is possible to draw a conclusion from premisses which are opposed, and in what figure this is not possible, will be made clear in this way. Verbally four kinds of opposition are poss"
**Ends at:** "In no other way than this, as was said before, is it possible that the premisses should be really contrary."
