═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_03_l02_c05_cena01_analiticos_anteriores

 (Final filename on disk: aristoteles_03_l02_c05_cena01_analiticos_anteriores.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 51 of 73 for *Prior Analytics*.
...
1. **Título Principal:** "Guia de Estudos: Analíticos Anteriores — BOOK II, Capítulo Part 5 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Prior Analytics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 5, bounded by:

**Starts at:** "Circular and reciprocal proof means proof by means of the conclusion, i.e. by converting one of the premisses simply and inferring the premiss which was assumed in the original syllogism: e.g. suppose"
**Ends at:** "e 'B belongs to some of that to some of which A does not belong': otherwise no syllogism results because the particular premiss is negative."
