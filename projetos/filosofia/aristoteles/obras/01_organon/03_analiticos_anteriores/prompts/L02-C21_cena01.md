═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_03_l02_c21_cena01_analiticos_anteriores

 (Final filename on disk: aristoteles_03_l02_c21_cena01_analiticos_anteriores.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, Part 21 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 67 of 73 for *Prior Analytics*.
...
1. **Título Principal:** "Guia de Estudos: Analíticos Anteriores — BOOK II, Capítulo Part 21 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Prior Analytics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 21, bounded by:

**Starts at:** "It sometimes happens that just as we are deceived in the arrangement of the terms, so error may arise in our thought about them, e.g. if it is possible that the same predicate should belong to more th"
**Ends at:** "But we must consider this matter better."
