═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_03_l01_c11_cena01_analiticos_anteriores

 (Final filename on disk: aristoteles_03_l01_c11_cena01_analiticos_anteriores.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 11 of 73 for *Prior Analytics*.
...
1. **Título Principal:** "Guia de Estudos: Analíticos Anteriores — BOOK I, Capítulo Part 11 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Prior Analytics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 11, bounded by:

**Starts at:** "In the last figure when the terms are related universally to the middle, and both premisses are affirmative, if one of the two is necessary, then the conclusion will be necessary. But if one is negati"
**Ends at:** "But when the negative proposition being particular is necessary, take the terms 'biped', 'moving', 'animal', 'animal' being middle."
