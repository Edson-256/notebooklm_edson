═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_03_l02_c12_cena01_analiticos_anteriores

 (Final filename on disk: aristoteles_03_l02_c12_cena01_analiticos_anteriores.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 58 of 73 for *Prior Analytics*.
...
1. **Título Principal:** "Guia de Estudos: Analíticos Anteriores — BOOK II, Capítulo Part 12 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Prior Analytics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 12, bounded by:

**Starts at:** "It is clear then that in the first figure all problems except the universal affirmative are proved per impossibile. But in the middle and the last figures this also is proved. Suppose that A does not"
**Ends at:** "It is clear then that all the syllogisms can be formed in the middle figure."
