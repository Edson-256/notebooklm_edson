═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_03_l01_c10_cena01_analiticos_anteriores

 (Final filename on disk: aristoteles_03_l01_c10_cena01_analiticos_anteriores.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 10 of 73 for *Prior Analytics*.
...
1. **Título Principal:** "Guia de Estudos: Analíticos Anteriores — BOOK I, Capítulo Part 10 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Prior Analytics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 10, bounded by:

**Starts at:** "In the second figure, if the negative premiss is necessary, then the conclusion will be necessary, but if the affirmative, not necessary. First let the negative be necessary; let A be possible of no B"
**Ends at:** "The point can be demonstrated by means of the same terms."
