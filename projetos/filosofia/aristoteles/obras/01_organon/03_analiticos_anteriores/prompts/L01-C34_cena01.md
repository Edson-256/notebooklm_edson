═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_03_l01_c34_cena01_analiticos_anteriores

 (Final filename on disk: aristoteles_03_l01_c34_cena01_analiticos_anteriores.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, Part 34 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 34 of 73 for *Prior Analytics*.
...
1. **Título Principal:** "Guia de Estudos: Analíticos Anteriores — BOOK I, Capítulo Part 34 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Prior Analytics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 34, bounded by:

**Starts at:** "Men will frequently fall into fallacies through not setting out the terms of the premiss well, e.g. suppose A to be health, B disease, C man. It is true to say that A cannot belong to any B (for healt"
**Ends at:** "It is clear then that in such premisses what possesses the condition ought always to be substituted for the condition and taken as the term."
