═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_03_l01_c04_cena01_analiticos_anteriores

 (Final filename on disk: aristoteles_03_l01_c04_cena01_analiticos_anteriores.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 4 of 73 for *Prior Analytics*.
...
1. **Título Principal:** "Guia de Estudos: Analíticos Anteriores — BOOK I, Capítulo Part 4 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Prior Analytics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 4, bounded by:

**Starts at:** "After these distinctions we now state by what means, when, and how every syllogism is produced; subsequently we must speak of demonstration. Syllogism should be discussed before demonstration because"
**Ends at:** "Such a figure I call the first."
