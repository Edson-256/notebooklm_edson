═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_03_l01_c09_cena01_analiticos_anteriores

 (Final filename on disk: aristoteles_03_l01_c09_cena01_analiticos_anteriores.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 9 of 73 for *Prior Analytics*.
...
1. **Título Principal:** "Guia de Estudos: Analíticos Anteriores — BOOK I, Capítulo Part 9 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Prior Analytics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 9, bounded by:

**Starts at:** "It happens sometimes also that when one premiss is necessary the conclusion is necessary, not however when either premiss is necessary, but only when the major is, e.g. if A is taken as necessarily be"
**Ends at:** "Try the terms movement, animal, white."
