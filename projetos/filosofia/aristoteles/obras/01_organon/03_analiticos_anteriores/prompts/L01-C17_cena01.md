═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_03_l01_c17_cena01_analiticos_anteriores

 (Final filename on disk: aristoteles_03_l01_c17_cena01_analiticos_anteriores.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 17 of 73 for *Prior Analytics*.
...
1. **Título Principal:** "Guia de Estudos: Analíticos Anteriores — BOOK I, Capítulo Part 17 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Prior Analytics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 17, bounded by:

**Starts at:** "In the second figure whenever both premisses are problematic, no syllogism is possible, whether the premisses are affirmative or negative, universal or particular. But when one premiss is assertoric,"
**Ends at:** "Clearly then, if both the premisses are problematic, no syllogism results."
