═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_03_l01_c38_cena01_analiticos_anteriores

 (Final filename on disk: aristoteles_03_l01_c38_cena01_analiticos_anteriores.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, Part 38 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 38 of 73 for *Prior Analytics*.
...
1. **Título Principal:** "Guia de Estudos: Analíticos Anteriores — BOOK I, Capítulo Part 38 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Prior Analytics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 38, bounded by:

**Starts at:** "A term which is repeated in the premisses ought to be joined to the first extreme, not to the middle. I mean for example that if a syllogism should be made proving that there is knowledge of justice,"
**Ends at:** "Clearly then in syllogisms which are thus limited we must take the terms in the way stated."
