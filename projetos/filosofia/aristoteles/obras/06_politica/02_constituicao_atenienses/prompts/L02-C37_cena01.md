═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_30_l02_c37_cena01_constituicao_atenienses

 (Final filename on disk: aristoteles_30_l02_c37_cena01_constituicao_atenienses.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 2, Part 37 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 37 of 69 for *The Athenian Constitution*.
...
1. **Título Principal:** "Guia de Estudos: Constituição dos Atenienses — SECTION 2, Capítulo Part 37 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The Athenian Constitution*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 2, Part 37, bounded by:

**Starts at:** "Now when winter had set in, Thrasybulus and the exiles occupied Phyle, and the force which the Thirty led out to attack them met with a reverse. Thereupon the Thirty decided to disarm the bulk of the"
**Ends at:** "They also sent ambassadors to Lacedaemonian to blacken the character of Theramenes and to ask for help; and the Lacedaemonians, in answer to their appeal, sent Callibius as military governor with abou"
