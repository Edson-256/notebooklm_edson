═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_30_l01_c01_cena01_constituicao_atenienses

 (Final filename on disk: aristoteles_30_l01_c01_cena01_constituicao_atenienses.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 1 of 69 for *The Athenian Constitution*.
...
1. **Título Principal:** "Guia de Estudos: Constituição dos Atenienses — SECTION 1, Capítulo Part 1 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The Athenian Constitution*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 1, Part 1, bounded by:

**Starts at:** "...[They were tried] by a court empanelled from among the noble families, and sworn upon the sacrifices. The part of accuser was taken by Myron. They were found guilty of the sacrilege, and their bodi"
**Ends at:** "In view of this expiation, Epimenides the Cretan performed a purification of the city."
