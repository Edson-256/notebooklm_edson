═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_30_l03_c53_cena01_constituicao_atenienses

 (Final filename on disk: aristoteles_30_l03_c53_cena01_constituicao_atenienses.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 3, Part 53 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 53 of 69 for *The Athenian Constitution*.
...
1. **Título Principal:** "Guia de Estudos: Constituição dos Atenienses — SECTION 3, Capítulo Part 53 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The Athenian Constitution*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 3, Part 53, bounded by:

**Starts at:** "The Forty are also elected by lot, four from each tribe, before whom suitors bring all other cases. Formerly they were thirty in number, and they went on circuit through the demes to hear causes; but"
**Ends at:** "The Eponymi are also used in reference to military expeditions; when the men of military age are despatched on service, a notice is put up stating that the men from such-and such an Archon and Eponymu"
