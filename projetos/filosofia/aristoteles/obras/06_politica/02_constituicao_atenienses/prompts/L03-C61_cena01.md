═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_30_l03_c61_cena01_constituicao_atenienses

 (Final filename on disk: aristoteles_30_l03_c61_cena01_constituicao_atenienses.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 3, Part 61 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 61 of 69 for *The Athenian Constitution*.
...
1. **Título Principal:** "Guia de Estudos: Constituição dos Atenienses — SECTION 3, Capítulo Part 61 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The Athenian Constitution*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 3, Part 61, bounded by:

**Starts at:** "All officers connected with military service are elected by open vote."
**Ends at:** "There is also a treasurer of the Paralus, and another of the Ammonias, similarly elected."
