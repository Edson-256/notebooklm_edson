═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_31_l02_c48_cena01_economicos

 (Final filename on disk: aristoteles_31_l02_c48_cena01_economicos.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK    II, CHAPTER   48 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 24 of 37 for *Economics*.
...
1. **Título Principal:** "Guia de Estudos: Econômicos (atribuído) — BOOK    II, Capítulo CHAPTER   48 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Economics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK    II, CHAPTER   48, bounded by:

**Starts at:** "his instalment, a note is made of it on the tablet ; and he is bound to pay double the amount of the deficiency, or, in default, to be imprisoned. The Council has full"
**Ends at:** "It was embroidered with mythological subjects, and was woven on each occasion by a number of girls, under the superintendence of two of superior family."
