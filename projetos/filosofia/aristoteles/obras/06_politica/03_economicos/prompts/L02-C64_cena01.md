═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_31_l02_c64_cena01_economicos

 (Final filename on disk: aristoteles_31_l02_c64_cena01_economicos.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK    II, CHAPTER   64 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 33 of 37 for *Economics*.
...
1. **Título Principal:** "Guia de Estudos: Econômicos (atribuído) — BOOK    II, Capítulo CHAPTER   64 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Economics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK    II, CHAPTER   64, bounded by:

**Starts at:** "the remainder are black, in the same proportion.1 As the Archon draws out the dice, the crier calls out the names of the individuals chosen. The Ticket-hanger is included"
**Ends at:** "Four cases are taken in each of the categories 1 The correct reading is perhaps ' the five officials '."
