═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_31_l02_c28_cena01_economicos

 (Final filename on disk: aristoteles_31_l02_c28_cena01_economicos.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK    II, CHAPTER  28 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 14 of 37 for *Economics*.
...
1. **Título Principal:** "Guia de Estudos: Econômicos (atribuído) — BOOK    II, Capítulo CHAPTER  28 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Economics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK    II, CHAPTER  28, bounded by:

**Starts at:** "Pisistratus, both of them men of birth and position."
**Ends at:** "Cleitophon concurred with the motion of Pythodorus, but moved that the committee should also investigate the 1 This committee is probably the same as that which we know from Thucydides to have been ap"
