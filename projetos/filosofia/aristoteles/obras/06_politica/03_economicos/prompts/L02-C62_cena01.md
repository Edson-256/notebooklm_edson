═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_31_l02_c62_cena01_economicos

 (Final filename on disk: aristoteles_31_l02_c62_cena01_economicos.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK    II, CHAPTER   62 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 32 of 37 for *Economics*.
...
1. **Título Principal:** "Guia de Estudos: Econômicos (atribuído) — BOOK    II, Capítulo CHAPTER   62 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Economics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK    II, CHAPTER   62, bounded by:

**Starts at:** "including the nine Archons, were elected out of the tribe as a whole, while others, namely those who are now elected in the Theseum, were apportioned among the demes ; bu"
**Ends at:** "Thus the whole body of jurors was divided into ten sections, indicated by the letters from alpha to kappa • and the courts for which jurors were required were indicated by the requisite number of lett"
