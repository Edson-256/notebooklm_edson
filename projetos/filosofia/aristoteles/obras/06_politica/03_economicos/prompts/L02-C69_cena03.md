═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_31_l02_c69_cena03_economicos

 (Final filename on disk: aristoteles_31_l02_c69_cena03_economicos.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK    II, CHAPTER   69 (sub-cena 3 of 3).
- **Audio Position in This Work:** This is audio 37 of 37 for *Economics*.
...
1. **Título Principal:** "Guia de Estudos: Econômicos (atribuído) — BOOK    II, Capítulo CHAPTER   69 (Cena 3/3)"
...
**Starts at:** "See also Archons. Thesmotheteum, 3, 5. Thessalus, 17, 3 ; 18, i. Thctes, 7, 3, 4. Thirty, the, 34, 2 ; 35-4°- Tholus, 43, 3; 44,1- Thrasybulus, 37, I ; 40, 2. Three"
**Ends at:** "PLEASE DO NOT REMOVE CARDS OR SLIPS FROM THIS POCKET UNIVERSITY OF TORONTO LIBRARY HB Aristoteles C0economica."
