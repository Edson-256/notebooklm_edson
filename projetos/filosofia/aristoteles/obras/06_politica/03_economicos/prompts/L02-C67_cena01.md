═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_31_l02_c67_cena01_economicos

 (Final filename on disk: aristoteles_31_l02_c67_cena01_economicos.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK    II, CHAPTER    67 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 34 of 37 for *Economics*.
...
1. **Título Principal:** "Guia de Estudos: Econômicos (atribuído) — BOOK    II, Capítulo CHAPTER    67 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Economics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK    II, CHAPTER    67, bounded by:

**Starts at:** "defined in the law, and the litigants swear to confine their speeches to the point at issue. If it is a day for public causes, the public litigants are called, and only"
**Ends at:** "Each juror receives two ballots, and uses one (pierced or solid according as he votes for the plaintiff or the defendant) to record his vote, and throws the other away."
