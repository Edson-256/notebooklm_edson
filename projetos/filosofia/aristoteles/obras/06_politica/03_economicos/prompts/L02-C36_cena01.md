═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_31_l02_c36_cena01_economicos

 (Final filename on disk: aristoteles_31_l02_c36_cena01_economicos.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK    II, CHAPTER    36 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 18 of 37 for *Economics*.
...
1. **Título Principal:** "Guia de Estudos: Econômicos (atribuído) — BOOK    II, Capítulo CHAPTER    36 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Economics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK    II, CHAPTER    36, bounded by:

**Starts at:** "leader of the people and destroy their despotic power."
**Ends at:** "'2 No other authority seems to distinguish between these two boards of Ten."
