═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_29_l01_c08_cena01_politica

 (Final filename on disk: aristoteles_29_l01_c08_cena01_politica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK ONE, Part VIII (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 8 of 22 for *Politics*.
...
1. **Título Principal:** "Guia de Estudos: Política — BOOK ONE, Capítulo Part VIII (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Politics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK ONE, Part VIII, bounded by:

**Starts at:** "Let us now inquire into property generally, and into the art of getting wealth, in accordance with our usual method, for a slave has been shown to be a part of property. The first question is whether"
**Ends at:** "And so we see that there is a natural art of acquisition which is practiced by managers of households and by statesmen, and what is the reason of this."
