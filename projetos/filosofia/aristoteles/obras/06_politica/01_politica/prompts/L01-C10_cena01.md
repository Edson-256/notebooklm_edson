═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_29_l01_c10_cena01_politica

 (Final filename on disk: aristoteles_29_l01_c10_cena01_politica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK ONE, Part X (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 10 of 22 for *Politics*.
...
1. **Título Principal:** "Guia de Estudos: Política — BOOK ONE, Capítulo Part X (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Politics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK ONE, Part X, bounded by:

**Starts at:** "And we have found the answer to our original question, Whether the art of getting wealth is the business of the manager of a household and of the statesman or not their business? viz., that wealth is"
**Ends at:** "Wherefore of an modes of getting wealth this is the most unnatural."
