═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_29_l02_c02_cena01_politica

 (Final filename on disk: aristoteles_29_l02_c02_cena01_politica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK TWO, Part II (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 15 of 22 for *Politics*.
...
1. **Título Principal:** "Guia de Estudos: Política — BOOK TWO, Capítulo Part II (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Politics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK TWO, Part II, bounded by:

**Starts at:** "There are many difficulties in the community of women."
**Ends at:** "If then self-sufficiency is to be desired, the lesser degree of unity is more desirable than the greater."
