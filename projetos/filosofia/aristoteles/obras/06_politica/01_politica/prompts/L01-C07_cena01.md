═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_29_l01_c07_cena01_politica

 (Final filename on disk: aristoteles_29_l01_c07_cena01_politica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK ONE, Part VII (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 7 of 22 for *Politics*.
...
1. **Título Principal:** "Guia de Estudos: Política — BOOK ONE, Capítulo Part VII (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Politics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK ONE, Part VII, bounded by:

**Starts at:** "The previous remarks are quite enough to show that the rule of a master is not a constitutional rule, and that all the different kinds of rule are not, as some affirm, the same with each other. For th"
**Ends at:** "Enough of the distinction between master and slave."
