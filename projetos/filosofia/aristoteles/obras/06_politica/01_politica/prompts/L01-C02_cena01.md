═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_29_l01_c02_cena01_politica

 (Final filename on disk: aristoteles_29_l01_c02_cena01_politica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK ONE, Part II (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 2 of 22 for *Politics*.
...
1. **Título Principal:** "Guia de Estudos: Política — BOOK ONE, Capítulo Part II (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Politics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK ONE, Part II, bounded by:

**Starts at:** "He who thus considers things in their first growth and origin, whether a state or anything else, will obtain the clearest view of them. In the first place there must be a union of those who cannot exi"
**Ends at:** "But justice is the bond of men in states, for the administration of justice, which is the determination of what is just, is the principle of order in political society."
