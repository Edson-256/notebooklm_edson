═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l06_c01_cena01_etica_nicomaco

 (Final filename on disk: aristoteles_25_l06_c01_cena01_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VI, 1 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 50 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK VI, Capítulo 1 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Nicomachean Ethics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VI, 1, bounded by:

**Starts at:** "Since we have previously said that one ought to choose that which is intermediate, not the excess nor the defect, and that the intermediate is determined by the dictates of the right rule, let us disc"
**Ends at:** "We must, then, learn what is the best state of each of these two parts; for this is the virtue of each."
