═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l06_c04_cena01_etica_nicomaco

 (Final filename on disk: aristoteles_25_l06_c04_cena01_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VI, 4 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 53 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK VI, Capítulo 4 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Nicomachean Ethics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VI, 4, bounded by:

**Starts at:** "In the variable are included both things made and things done; making and acting are different (for their nature we treat even the discussions outside our school as reliable); so that the reasoned sta"
**Ends at:** "Art, then, as has been is a state concerned with making, involving a true course of reasoning, and lack of art on the contrary is a state concerned with making, involving a false course of reasoning; "
