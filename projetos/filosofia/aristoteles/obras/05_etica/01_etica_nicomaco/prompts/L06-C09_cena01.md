═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l06_c09_cena01_etica_nicomaco

 (Final filename on disk: aristoteles_25_l06_c09_cena01_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VI, 9 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 58 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK VI, Capítulo 9 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Nicomachean Ethics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VI, 9, bounded by:

**Starts at:** "There is a difference between inquiry and deliberation; for deliberation is inquiry into a particular kind of thing. We must grasp the nature of excellence in deliberation as well whether it is a form"
**Ends at:** "If, then, it is characteristic of men of practical wisdom to have deliberated well, excellence in deliberation will be correctness with regard to what conduces to the end of which practical wisdom is "
