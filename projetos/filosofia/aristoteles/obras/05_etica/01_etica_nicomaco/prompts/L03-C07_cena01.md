═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l03_c07_cena01_etica_nicomaco

 (Final filename on disk: aristoteles_25_l03_c07_cena01_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK III, 7 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 25 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK III, Capítulo 7 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Nicomachean Ethics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, 7, bounded by:

**Starts at:** "What is terrible is not the same for all men; but we say there are things terrible even beyond human strength. These, then, are terrible to every one- at least to every sensible man; but the terrible"
**Ends at:** "But to die to escape from poverty or love or anything painful is not the mark of a brave man, but rather of a coward; for it is softness to fly from what is troublesome, and such a man endures death n"
