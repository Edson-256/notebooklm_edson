═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l05_c02_cena01_etica_nicomaco

 (Final filename on disk: aristoteles_25_l05_c02_cena01_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK V, 2 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 42 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK V, Capítulo 2 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Nicomachean Ethics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK V, 2, bounded by:

**Starts at:** "But at all events what we are investigating is the justice which is a part of virtue; for there is a justice of this kind, as we maintain. Similarly it is with injustice in the particular sense that w"
**Ends at:** "voluntary and (2) others involuntary- voluntary such transactions as sale, purchase, loan for consumption, pledging, loan for use, depositing, letting (they are called voluntary because the origin of "
