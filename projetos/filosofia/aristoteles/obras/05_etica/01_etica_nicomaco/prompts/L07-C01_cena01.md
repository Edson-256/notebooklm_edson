═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l07_c01_cena01_etica_nicomaco

 (Final filename on disk: aristoteles_25_l07_c01_cena01_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VII, 1 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 63 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK VII, Capítulo 1 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Nicomachean Ethics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VII, 1, bounded by:

**Starts at:** "Let us now make a fresh beginning and point out that of moral states to be avoided there are three kinds-vice, incontinence, brutishness. The contraries of two of these are evident,-one we call virtue"
**Ends at:** "-These, then, are the things that are said."
