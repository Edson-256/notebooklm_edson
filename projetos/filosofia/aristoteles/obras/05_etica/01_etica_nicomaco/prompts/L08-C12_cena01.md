═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l08_c12_cena01_etica_nicomaco

 (Final filename on disk: aristoteles_25_l08_c12_cena01_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VIII, 12 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 88 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK VIII, Capítulo 12 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Nicomachean Ethics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VIII, 12, bounded by:

**Starts at:** "Every form of friendship, then, involves association, as has been said. One might, however, mark off from the rest both the friendship of kindred and that of comrades. Those of fellow-citizens, fellow"
**Ends at:** "How man and wife and in general friend and friend ought mutually to behave seems to be the same question as how it is just for them to behave; for a man does not seem to have the same duties to a frie"
