═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l06_c07_cena01_etica_nicomaco

 (Final filename on disk: aristoteles_25_l06_c07_cena01_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VI, 7 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 56 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK VI, Capítulo 7 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Nicomachean Ethics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VI, 7, bounded by:

**Starts at:** "Wisdom (1) in the arts we ascribe to their most finished exponents, e.g. to Phidias as a sculptor and to Polyclitus as a maker of portrait-statues, and here we mean nothing by wisdom except excellence"
**Ends at:** "But of practical as of philosophic wisdom there must be a controlling kind."
