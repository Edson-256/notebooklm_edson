═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l08_c09_cena01_etica_nicomaco

 (Final filename on disk: aristoteles_25_l08_c09_cena01_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VIII, 9 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 85 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK VIII, Capítulo 9 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Nicomachean Ethics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VIII, 9, bounded by:

**Starts at:** "Friendship and justice seem, as we have said at the outset of our discussion, to be concerned with the same objects and exhibited between the same persons. For in every community there is thought to b"
**Ends at:** "All the communities, then, seem to be parts of the political community; and the particular kinds friendship will correspond to the particular kinds of community."
