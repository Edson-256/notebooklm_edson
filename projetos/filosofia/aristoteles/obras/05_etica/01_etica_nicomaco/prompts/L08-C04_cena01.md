═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l08_c04_cena01_etica_nicomaco

 (Final filename on disk: aristoteles_25_l08_c04_cena01_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VIII, 4 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 80 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK VIII, Capítulo 4 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Nicomachean Ethics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VIII, 4, bounded by:

**Starts at:** "This kind of friendship, then, is perfect both in respect of duration and in all other respects, and in it each gets from each in all respects the same as, or something like what, he gives; which is w"
**Ends at:** "These, then, are friends without qualification; the others are friends incidentally and through a resemblance to these."
