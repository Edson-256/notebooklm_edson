═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l07_c10_cena01_etica_nicomaco

 (Final filename on disk: aristoteles_25_l07_c10_cena01_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VII, 10 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 72 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK VII, Capítulo 10 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Nicomachean Ethics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VII, 10, bounded by:

**Starts at:** "Nor can the same man have practical wisdom and be incontinent; for it has been shown' that a man is at the same time practically wise, and good in respect of character. Further, a man has practical wi"
**Ends at:** "We have now stated what continence, incontinence, endurance, and softness are, and how these states are related to each other."
