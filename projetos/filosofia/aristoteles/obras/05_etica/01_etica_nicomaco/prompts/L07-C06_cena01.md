═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l07_c06_cena01_etica_nicomaco

 (Final filename on disk: aristoteles_25_l07_c06_cena01_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VII, 6 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 68 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK VII, Capítulo 6 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Nicomachean Ethics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VII, 6, bounded by:

**Starts at:** "That incontinence in respect of anger is less disgraceful than that in respect of the appetites is what we will now proceed to see. (1) Anger seems to listen to argument to some extent, but to mishear"
**Ends at:** "Each is in some sense worse; for a bad man will do ten thousand times as much evil as a brute."
