═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l08_c02_cena01_etica_nicomaco

 (Final filename on disk: aristoteles_25_l08_c02_cena01_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VIII, 2 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 78 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK VIII, Capítulo 2 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Nicomachean Ethics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VIII, 2, bounded by:

**Starts at:** "The kinds of friendship may perhaps be cleared up if we first come to know the object of love. For not everything seems to be loved but only the lovable, and this is good, pleasant, or useful; but it"
**Ends at:** "To be friends, then, the must be mutually recognized as bearing goodwill and wishing well to each other for one of the aforesaid reasons."
