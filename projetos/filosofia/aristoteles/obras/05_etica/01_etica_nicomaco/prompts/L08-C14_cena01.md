═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l08_c14_cena01_etica_nicomaco

 (Final filename on disk: aristoteles_25_l08_c14_cena01_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VIII, 14 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 90 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK VIII, Capítulo 14 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Nicomachean Ethics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VIII, 14, bounded by:

**Starts at:** "Differences arise also in friendships based on superiority; for each expects to get more out of them, but when this happens the friendship is dissolved. Not only does the better man think he ought to"
**Ends at:** "-So much for these questions."
