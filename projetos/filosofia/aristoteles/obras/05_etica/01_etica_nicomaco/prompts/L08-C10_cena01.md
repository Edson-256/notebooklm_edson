═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l08_c10_cena01_etica_nicomaco

 (Final filename on disk: aristoteles_25_l08_c10_cena01_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VIII, 10 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 86 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK VIII, Capítulo 10 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Nicomachean Ethics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VIII, 10, bounded by:

**Starts at:** "There are three kinds of constitution, and an equal number of deviation-forms--perversions, as it were, of them. The constitutions are monarchy, aristocracy, and thirdly that which is based on a prope"
**Ends at:** "Democracy is found chiefly in masterless dwellings (for here every one is on an equality), and in those in which the ruler is weak and every one has licence to do as he pleases."
