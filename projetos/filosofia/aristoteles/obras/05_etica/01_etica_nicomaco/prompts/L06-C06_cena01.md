═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l06_c06_cena01_etica_nicomaco

 (Final filename on disk: aristoteles_25_l06_c06_cena01_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VI, 6 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 55 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK VI, Capítulo 6 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Nicomachean Ethics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VI, 6, bounded by:

**Starts at:** "Scientific knowledge is judgement about things that are universal and necessary, and the conclusions of demonstration, and all scientific knowledge, follow from first principles (for scientific knowle"
**Ends at:** "practical wisdom, scientific knowledge, or philosophic wisdom), the remaining alternative is that it is intuitive reason that grasps the first principles."
