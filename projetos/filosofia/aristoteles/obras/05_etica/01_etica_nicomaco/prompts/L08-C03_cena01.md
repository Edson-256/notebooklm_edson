═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l08_c03_cena01_etica_nicomaco

 (Final filename on disk: aristoteles_25_l08_c03_cena01_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VIII, 3 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 79 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK VIII, Capítulo 3 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Nicomachean Ethics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VIII, 3, bounded by:

**Starts at:** "Now these reasons differ from each other in kind; so, therefore, do the corresponding forms of love and friendship. There are therefore three kinds of friendship, equal in number to the things that ar"
**Ends at:** "Those who quickly show the marks of friendship to each other wish to be friends, but are not friends unless they both are lovable and know the fact; for a wish for friendship may arise quickly, but fr"
