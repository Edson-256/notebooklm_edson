═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l09_c12_cena01_etica_nicomaco

 (Final filename on disk: aristoteles_25_l09_c12_cena01_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IX, 12 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 102 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK IX, Capítulo 12 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Nicomachean Ethics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IX, 12, bounded by:

**Starts at:** "Does it not follow, then, that, as for lovers the sight of the beloved is the thing they love most, and they prefer this sense to the others because on it love depends most for its being and for its o"
**Ends at:** "-So much, then, for friendship; our next task must be to discuss pleasure."
