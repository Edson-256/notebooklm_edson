═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l01_c04_cena03_etica_nicomaco

 (Final filename on disk: aristoteles_25_l01_c04_cena03_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, 4 (sub-cena 3 of 6).
- **Audio Position in This Work:** This is audio 6 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK I, Capítulo 4 (Cena 3/6)"
...
**Starts at:** "Presumably, however, to say that happiness is the chief good seems a platitude, and a clearer account of what it is still desired. This might perhaps be given, if we could first ascertain the function"
**Ends at:** "But they are also good and noble, and have each of these attributes in the highest degree, since the good man judges well about these attributes; his judgement is such as we have described."
