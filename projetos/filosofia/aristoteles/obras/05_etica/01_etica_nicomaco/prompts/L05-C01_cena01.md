═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l05_c01_cena01_etica_nicomaco

 (Final filename on disk: aristoteles_25_l05_c01_cena01_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK V, 1 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 41 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK V, Capítulo 1 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Nicomachean Ethics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK V, 1, bounded by:

**Starts at:** "With regards to justice and injustice we must (1) consider what kind of actions they are concerned with, (2) what sort of mean justice is, and (3) between what extremes the just act is intermediate. O"
**Ends at:** "What the difference is between virtue and justice in this sense is plain from what we have said; they are the same but their essence is not the same; what, as a relation to one's neighbour, is justice"
