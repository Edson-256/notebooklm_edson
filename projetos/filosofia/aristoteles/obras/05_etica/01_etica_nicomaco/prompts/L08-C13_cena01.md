═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l08_c13_cena01_etica_nicomaco

 (Final filename on disk: aristoteles_25_l08_c13_cena01_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VIII, 13 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 89 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK VIII, Capítulo 13 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Nicomachean Ethics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VIII, 13, bounded by:

**Starts at:** "There are three kinds of friendship, as we said at the outset of our inquiry, and in respect of each some are friends on an equality and others by virtue of a superiority (for not only can equally goo"
**Ends at:** "In friendships based on virtue on the other hand, complaints do not arise, but the purpose of the doer is a sort of measure; for in purpose lies the essential element of virtue and character."
