═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l09_c10_cena01_etica_nicomaco

 (Final filename on disk: aristoteles_25_l09_c10_cena01_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IX, 10 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 100 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK IX, Capítulo 10 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Nicomachean Ethics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IX, 10, bounded by:

**Starts at:** "Should we, then, make as many friends as possible, or-as in the case of hospitality it is thought to be suitable advice, that one should be 'neither a man of many guests nor a man with none'-will that"
**Ends at:** "In the way proper to fellow-citizens, indeed, it is possible to be the friend of many and yet not be obsequious but a genuinely good man; but one cannot have with many people the friendship based on v"
