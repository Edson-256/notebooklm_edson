═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l03_c08_cena01_etica_nicomaco

 (Final filename on disk: aristoteles_25_l03_c08_cena01_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK III, 8 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 26 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK III, Capítulo 8 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Nicomachean Ethics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, 8, bounded by:

**Starts at:** "Courage, then, is something of this sort, but the name is also applied to five other kinds. First comes the courage of the citizen-soldier; for this is most like true courage. Citizen-soldiers seem"
**Ends at:** "We have, then, described the character both of brave men and of those who are thought to be brave."
