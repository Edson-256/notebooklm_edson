═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l04_c01_cena02_etica_nicomaco

 (Final filename on disk: aristoteles_25_l04_c01_cena02_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IV, 1 (sub-cena 2 of 2).
- **Audio Position in This Work:** This is audio 32 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK IV, Capítulo 1 (Cena 2/2)"
...
The sources uploaded to NotebookLM contain the full text of *Nicomachean Ethics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IV, 1, bounded by:

**Starts at:** "The characteristics of prodigality are not often combined; for it is not easy to give to all if you take from none; private persons soon exhaust their substance with giving, and it is to these that th"
**Ends at:** "So much, then, for liberality and the opposed vices."
