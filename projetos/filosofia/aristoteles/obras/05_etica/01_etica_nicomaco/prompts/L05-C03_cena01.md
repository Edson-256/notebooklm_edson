═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l05_c03_cena01_etica_nicomaco

 (Final filename on disk: aristoteles_25_l05_c03_cena01_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK V, 3 (sub-cena 1 of 7).
- **Audio Position in This Work:** This is audio 43 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK V, Capítulo 3 (Cena 1/7)"
...
**Starts at:** "(A) We have shown that both the unjust man and the unjust act are unfair or unequal; now it is clear that there is also an intermediate between the two unequals involved in either case. And this is th"
**Ends at:** "This, then, is one species of the just."
