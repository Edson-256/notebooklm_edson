═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l06_c12_cena01_etica_nicomaco

 (Final filename on disk: aristoteles_25_l06_c12_cena01_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VI, 12 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 61 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK VI, Capítulo 12 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Nicomachean Ethics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VI, 12, bounded by:

**Starts at:** "Difficulties might be raised as to the utility of these qualities of mind. For (1) philosophic wisdom will contemplate none of the things that will make a man happy (for it is not concerned with any c"
**Ends at:** "Therefore it is evident that it is impossible to be practically wise without being good."
