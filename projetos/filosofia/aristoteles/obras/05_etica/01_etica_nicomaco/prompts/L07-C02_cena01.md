═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l07_c02_cena01_etica_nicomaco

 (Final filename on disk: aristoteles_25_l07_c02_cena01_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VII, 2 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 64 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK VII, Capítulo 2 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Nicomachean Ethics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VII, 2, bounded by:

**Starts at:** "Now we may ask (1) how a man who judges rightly can behave incontinently."
**Ends at:** "No one has all the forms of incontinence, but we say some people are incontinent without qualification."
