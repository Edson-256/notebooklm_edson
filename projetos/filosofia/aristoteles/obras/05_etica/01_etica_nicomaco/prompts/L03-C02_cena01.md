═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l03_c02_cena01_etica_nicomaco

 (Final filename on disk: aristoteles_25_l03_c02_cena01_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK III, 2 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 20 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK III, Capítulo 2 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Nicomachean Ethics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, 2, bounded by:

**Starts at:** "Both the voluntary and the involuntary having been delimited, we must next discuss choice; for it is thought to be most closely bound up with virtue and to discriminate characters better than actions"
**Ends at:** "Even the name seems to suggest that it is what is chosen before other things."
