═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l06_c05_cena01_etica_nicomaco

 (Final filename on disk: aristoteles_25_l06_c05_cena01_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VI, 5 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 54 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK VI, Capítulo 5 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Nicomachean Ethics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VI, 5, bounded by:

**Starts at:** "Regarding practical wisdom we shall get at the truth by considering who are the persons we credit with it. Now it is thought to be the mark of a man of practical wisdom to be able to deliberate well a"
**Ends at:** "But yet it is not only a reasoned state; this is shown by the fact that a state of that sort may forgotten but practical wisdom cannot."
