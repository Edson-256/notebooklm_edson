═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l03_c12_cena01_etica_nicomaco

 (Final filename on disk: aristoteles_25_l03_c12_cena01_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK III, 12 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 30 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK III, Capítulo 12 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Nicomachean Ethics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, 12, bounded by:

**Starts at:** "Self-indulgence is more like a voluntary state than cowardice."
**Ends at:** "Here we conclude our account of temperance."
