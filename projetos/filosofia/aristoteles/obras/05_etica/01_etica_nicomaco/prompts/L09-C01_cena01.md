═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l09_c01_cena01_etica_nicomaco

 (Final filename on disk: aristoteles_25_l09_c01_cena01_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IX, 1 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 91 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK IX, Capítulo 1 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Nicomachean Ethics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IX, 1, bounded by:

**Starts at:** "In all friendships between dissimilars it is, as we have said, proportion that equalizes the parties and preserves the friendship; e.g. in the political form of friendship the shoemaker gets a return"
**Ends at:** "But no doubt the receiver should assess a thing not at what it seems worth when he has it, but at what he assessed it at before he had it."
