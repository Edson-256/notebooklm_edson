═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l05_c03_cena02_etica_nicomaco

 (Final filename on disk: aristoteles_25_l05_c03_cena02_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK V, 3 (sub-cena 2 of 7).
- **Audio Position in This Work:** This is audio 44 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK V, Capítulo 3 (Cena 2/7)"
...
**Starts at:** "(B) The remaining one is the rectificatory, which arises in connexion with transactions both voluntary and involuntary. This form of the just has a different specific character from the former. For th"
**Ends at:** "This is why they give a prominent place to the temple of the Graces-to promote the requital of services; for this is characteristic of grace-we should serve in return one who has shown grace to us, an"
