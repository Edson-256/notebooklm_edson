═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_25_l01_c04_cena02_etica_nicomaco

 (Final filename on disk: aristoteles_25_l01_c04_cena02_etica_nicomaco.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, 4 (sub-cena 2 of 6).
- **Audio Position in This Work:** This is audio 5 of 111 for *Nicomachean Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Nicômaco — BOOK I, Capítulo 4 (Cena 2/6)"
...
**Starts at:** "But let us discuss these matters elsewhere; an objection to what we have said, however, may be discerned in the fact that the Platonists have not been speaking about all goods, and that the goods that"
**Ends at:** "Happiness, then, is something final and self-sufficient, and is the end of action."
