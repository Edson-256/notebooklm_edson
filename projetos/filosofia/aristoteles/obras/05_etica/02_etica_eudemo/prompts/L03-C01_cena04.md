═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_26_l03_c01_cena04_etica_eudemo

 (Final filename on disk: aristoteles_26_l03_c01_cena04_etica_eudemo.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK  III, BOOK  III (sem CHAPTER) (sub-cena 4 of 13).
- **Audio Position in This Work:** This is audio 31 of 71 for *Eudemian Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Eudemo — BOOK  III, Capítulo BOOK  III (sem CHAPTER) (Cena 4/13)"
...
**Starts at:** "27 persons justly be termed brave."
**Ends at:** "33 i We have now given an account that is fairly ade- quate for our present procedure of the kind of things in relation to which Courage is a middle state, and between what vices and for what reason i"
