═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_26_l02_c01_cena01_etica_eudemo

 (Final filename on disk: aristoteles_26_l02_c01_cena01_etica_eudemo.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK  II, BOOK  II (sem CHAPTER) (sub-cena 1 of 18).
- **Audio Position in This Work:** This is audio 10 of 71 for *Eudemian Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Eudemo — BOOK  II, Capítulo BOOK  II (sem CHAPTER) (Cena 1/18)"
...
**Starts at:** "1 I. After this Ave must take a fresh starting-point Ethical and discuss the subjects that follow. (^^Ο^νΧΓγΙ Now all goods are either external or within the ofHappiness s"
**Ends at:** "s we saw is happiness."
