═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_26_l07_c01_cena19_etica_eudemo

 (Final filename on disk: aristoteles_26_l07_c01_cena19_etica_eudemo.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK  VII, BOOK  VII (sem CHAPTER) (sub-cena 19 of 31).
- **Audio Position in This Work:** This is audio 59 of 71 for *Eudemian Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Eudemo — BOOK  VII, Capítulo BOOK  VII (sem CHAPTER) (Cena 19/31)"
...
**Starts at:** "35 cheating. But here too there is a dispute at the outset, if one says that they came together on grounds of utility and the other denies it and says it was on the b"
**Ends at:** "Hence there are many of them, and each is thought to belong to friendship as one, though it does not : for instance, the desire for the friend's existence — for the superior friend and benefactor wish"
