═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_26_l07_c01_cena16_etica_eudemo

 (Final filename on disk: aristoteles_26_l07_c01_cena16_etica_eudemo.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK  VII, BOOK  VII (sem CHAPTER) (sub-cena 16 of 31).
- **Audio Position in This Work:** This is audio 56 of 71 for *Eudemian Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Eudemo — BOOK  VII, Capítulo BOOK  VII (sem CHAPTER) (Cena 16/31)"
...
**Starts at:** "10 And since there are three sorts of friendship, unequal based on goodness, on utility and on pleasure, and fr'enfisiiips two varieties of each sort (for each of th"
**Ends at:** ", -^ I ' for the sake of utility but make it out to be a morai."
