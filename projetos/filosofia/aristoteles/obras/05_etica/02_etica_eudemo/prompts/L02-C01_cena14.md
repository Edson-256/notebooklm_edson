═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_26_l02_c01_cena14_etica_eudemo

 (Final filename on disk: aristoteles_26_l02_c01_cena14_etica_eudemo.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK  II, BOOK  II (sem CHAPTER) (sub-cena 14 of 18).
- **Audio Position in This Work:** This is audio 23 of 71 for *Eudemian Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Eudemo — BOOK  II, Capítulo BOOK  II (sem CHAPTER) (Cena 14/18)"
...
**Starts at:** "4 tarily. But since to understand or know has two meanings, one being to have the knowledge and the other to use it, a man who has knowledge but is not using it would"
**Ends at:** "what his choice is and what its object is, ' object ' meaning that for the sake of which he chooses something else and ' choice ' meaning that which he chooses for the"
