═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_26_l03_c01_cena01_etica_eudemo

 (Final filename on disk: aristoteles_26_l03_c01_cena01_etica_eudemo.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK  III, BOOK  III (sem CHAPTER) (sub-cena 1 of 13).
- **Audio Position in This Work:** This is audio 28 of 71 for *Eudemian Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Eudemo — BOOK  III, Capítulo BOOK  III (sem CHAPTER) (Cena 1/13)"
...
**Starts at:** "1 I. It has then been stated in general terms that the mohal there are middle states in the virtues and that these Virtues. are purposive, and also that the opposite dis"
**Ends at:** "And similarly some things Analogy are formidable absolutely and others to a particular and^\" person : thus the things that the coward qua coward 'Strength."
