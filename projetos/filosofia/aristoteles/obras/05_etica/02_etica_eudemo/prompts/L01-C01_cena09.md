═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_26_l01_c01_cena09_etica_eudemo

 (Final filename on disk: aristoteles_26_l01_c01_cena09_etica_eudemo.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK  I, BOOK  I (sem CHAPTER) (sub-cena 9 of 9).
- **Audio Position in This Work:** This is audio 9 of 71 for *Eudemian Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Eudemo — BOOK  I, Capítulo BOOK  I (sem CHAPTER) (Cena 9/9)"
...
**Starts at:** "° This sentence reads like a mere note."
**Ends at:** "(et infra αίρ^τώτατα Rac)."
