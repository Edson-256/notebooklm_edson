═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_26_l02_c01_cena17_etica_eudemo

 (Final filename on disk: aristoteles_26_l02_c01_cena17_etica_eudemo.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK  II, BOOK  II (sem CHAPTER) (sub-cena 17 of 18).
- **Audio Position in This Work:** This is audio 26 of 71 for *Eudemian Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Eudemo — BOOK  II, Capítulo BOOK  II (sem CHAPTER) (Cena 17/18)"
...
**Starts at:** "give a drug, and a general where he shall pitch his camp) when their End is the good that is the absolute 26 best ; but in contravention of nature and by perver- sion"
**Ends at:** "raised this preliminary question let us continue."
