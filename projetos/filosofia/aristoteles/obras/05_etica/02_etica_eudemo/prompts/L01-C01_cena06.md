═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_26_l01_c01_cena06_etica_eudemo

 (Final filename on disk: aristoteles_26_l01_c01_cena06_etica_eudemo.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK  I, BOOK  I (sem CHAPTER) (sub-cena 6 of 9).
- **Audio Position in This Work:** This is audio 6 of 71 for *Eudemian Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Eudemo — BOOK  I, Capítulo BOOK  I (sem CHAPTER) (Cena 6/9)"
...
**Starts at:** "1 VI. And about all these matters the endeavour The method must be made to seek to convince by means oftoobsirvj^ rational arguments, using observed facts as"
**Ends at:** "An ίδ^α is jjcrceptible i22 EUDEMIAN ETHICS, I."
