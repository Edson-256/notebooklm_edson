═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_26_l01_c01_cena04_etica_eudemo

 (Final filename on disk: aristoteles_26_l01_c01_cena04_etica_eudemo.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK  I, BOOK  I (sem CHAPTER) (sub-cena 4 of 9).
- **Audio Position in This Work:** This is audio 4 of 71 for *Eudemian Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Eudemo — BOOK  I, Capítulo BOOK  I (sem CHAPTER) (Cena 4/9)"
...
**Starts at:** "which it is not easy to make a right judgement, this is especially the case with one about which every- body thinks that it is very easy to judge and that any- body can"
