═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_26_l07_c01_cena17_etica_eudemo

 (Final filename on disk: aristoteles_26_l07_c01_cena17_etica_eudemo.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK  VII, BOOK  VII (sem CHAPTER) (sub-cena 17 of 31).
- **Audio Position in This Work:** This is audio 57 of 71 for *Eudemian Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Eudemo — BOOK  VII, Capítulo BOOK  VII (sem CHAPTER) (Cena 17/31)"
...
**Starts at:** "of trust. 18 For in general, of the three kinds of friendship, it is in useful friendship that most recriminations occur (for goodness is not given to recrimination, and"
**Ends at:** "For most men pursue what is fine only when they have a good margin in hand, and so Avith the finer sort of friendship too."
