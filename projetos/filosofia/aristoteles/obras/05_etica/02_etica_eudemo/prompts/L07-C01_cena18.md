═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_26_l07_c01_cena18_etica_eudemo

 (Final filename on disk: aristoteles_26_l07_c01_cena18_etica_eudemo.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK  VII, BOOK  VII (sem CHAPTER) (sub-cena 18 of 31).
- **Audio Position in This Work:** This is audio 58 of 71 for *Eudemian Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Eudemo — BOOK  VII, Capítulo BOOK  VII (sem CHAPTER) (Cena 18/31)"
...
**Starts at:** "26 Hence it is clear how these cases must be decided."
**Ends at:** "and then, what is the amount given for each ?"
