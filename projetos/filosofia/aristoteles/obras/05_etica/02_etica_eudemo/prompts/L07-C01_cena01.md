═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_26_l07_c01_cena01_etica_eudemo

 (Final filename on disk: aristoteles_26_l07_c01_cena01_etica_eudemo.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK  VII, BOOK  VII (sem CHAPTER) (sub-cena 1 of 31).
- **Audio Position in This Work:** This is audio 41 of 71 for *Eudemian Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Eudemo — BOOK  VII, Capítulo BOOK  VII (sem CHAPTER) (Cena 1/31)"
...
**Starts at:** "1 I. Friendship— its nature and qualities, what con- pbiendshu stitutes a friend, and whether the term friendship its nature has one or several meanings, and if several, ho"
**Ends at:** "Some persons think that it is not possible for bad men to be friends,' but only for the good."
