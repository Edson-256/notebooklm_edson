═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_26_l07_c01_cena06_etica_eudemo

 (Final filename on disk: aristoteles_26_l07_c01_cena06_etica_eudemo.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK  VII, BOOK  VII (sem CHAPTER) (sub-cena 6 of 31).
- **Audio Position in This Work:** This is audio 46 of 71 for *Eudemian Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Eudemo — BOOK  VII, Capítulo BOOK  VII (sem CHAPTER) (Cena 6/31)"
...
**Starts at:** "35 pleasant ; and friendship itself is a state from which such choice arises. For its function is an activity, but this not external but within the lover himself ; whereas"
**Ends at:** "occur between many men, because it is difficult to test many — one would have to go and live with each of them."
