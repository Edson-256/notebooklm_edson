═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_26_l02_c01_cena12_etica_eudemo

 (Final filename on disk: aristoteles_26_l02_c01_cena12_etica_eudemo.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK  II, BOOK  II (sem CHAPTER) (sub-cena 12 of 18).
- **Audio Position in This Work:** This is audio 21 of 71 for *Eudemian Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Eudemo — BOOK  II, Capítulo BOOK  II (sem CHAPTER) (Cena 12/18)"
...
**Starts at:** "11 voluntarily ; nor yet are they acting of necessity, for by necessity we mean an external principle that either checks or moves a man in opposition to his impulse — as"
**Ends at:** "ough not indeed under compulsion absolutely, because he does not definitely choose the actual thing that he does but the object for which he does it ; since even in the"
