═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_26_l02_c01_cena15_etica_eudemo

 (Final filename on disk: aristoteles_26_l02_c01_cena15_etica_eudemo.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK  II, BOOK  II (sem CHAPTER) (sub-cena 15 of 18).
- **Audio Position in This Work:** This is audio 24 of 71 for *Eudemian Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Eudemo — BOOK  II, Capítulo BOOK  II (sem CHAPTER) (Cena 15/18)"
...
**Starts at:** "8 sake of something else."
**Ends at:** "If, then, nobody chooses without first preparing, and deliberating as to the comparative merits of the alternatives, and a man deliberates as to those among the means to the End capable of existing or"
