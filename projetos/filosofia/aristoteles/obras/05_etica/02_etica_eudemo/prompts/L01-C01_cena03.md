═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_26_l01_c01_cena03_etica_eudemo

 (Final filename on disk: aristoteles_26_l01_c01_cena03_etica_eudemo.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK  I, BOOK  I (sem CHAPTER) (sub-cena 3 of 9).
- **Audio Position in This Work:** This is audio 3 of 71 for *Eudemian Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Eudemo — BOOK  I, Capítulo BOOK  I (sem CHAPTER) (Cena 3/9)"
...
**Starts at:** "6 conduct ; but if it consists in oneself and one's own actions having a particular quality, the good would be more common and more divine — more common because it would"
