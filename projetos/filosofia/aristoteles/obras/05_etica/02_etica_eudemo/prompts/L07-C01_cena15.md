═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_26_l07_c01_cena15_etica_eudemo

 (Final filename on disk: aristoteles_26_l07_c01_cena15_etica_eudemo.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK  VII, BOOK  VII (sem CHAPTER) (sub-cena 15 of 31).
- **Audio Position in This Work:** This is audio 55 of 71 for *Eudemian Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Eudemo — BOOK  VII, Capítulo BOOK  VII (sem CHAPTER) (Cena 15/31)"
...
**Starts at:** "1 X. Specified sorts of friendship are therefore the Friendships friendship of relatives, that of comrades, that of ij^^e cialmr\" partners and what is termed civic friendshi"
**Ends at:** "Hence in the household are first found the origins and springs of friendship, of political organization and of justice."
