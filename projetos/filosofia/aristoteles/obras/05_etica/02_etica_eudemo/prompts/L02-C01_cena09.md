═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_26_l02_c01_cena09_etica_eudemo

 (Final filename on disk: aristoteles_26_l02_c01_cena09_etica_eudemo.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK  II, BOOK  II (sem CHAPTER) (sub-cena 9 of 18).
- **Audio Position in This Work:** This is audio 18 of 71 for *Eudemian Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Eudemo — BOOK  II, Capítulo BOOK  II (sem CHAPTER) (Cena 9/18)"
...
**Starts at:** "10 cause of depends on himself."
