═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_26_l01_c01_cena01_etica_eudemo

 (Final filename on disk: aristoteles_26_l01_c01_cena01_etica_eudemo.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK  I, BOOK  I (sem CHAPTER) (sub-cena 1 of 9).
- **Audio Position in This Work:** This is audio 1 of 71 for *Eudemian Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Eudemo — BOOK  I, Capítulo BOOK  I (sem CHAPTER) (Cena 1/9)"
...
**Starts at:** "1 I. The man \" who at Delos se^ forth in the precinct Books i."
**Ends at:** "that it consists in some one of them."
