═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_26_l02_c01_cena13_etica_eudemo

 (Final filename on disk: aristoteles_26_l02_c01_cena13_etica_eudemo.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK  II, BOOK  II (sem CHAPTER) (sub-cena 13 of 18).
- **Audio Position in This Work:** This is audio 22 of 71 for *Eudemian Ethics*.
...
1. **Título Principal:** "Guia de Estudos: Ética a Eudemo — BOOK  II, Capítulo BOOK  II (sem CHAPTER) (Cena 13/18)"
...
**Starts at:** "20 objects of action there is a certain difference."
**Ends at:** "Therefore the opposite is voluntary."
