═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l02_c17_cena04_magna_moralia

 (Final filename on disk: aristoteles_27_l02_c17_cena04_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, CHAPTER 17 (sub-cena 4 of 28).
- **Audio Position in This Work:** This is audio 45 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK II, Capítulo CHAPTER 17 (Cena 4/28)"
...
**Starts at:** "5 First, then, we ought to speak about the soul in which 1185” it resides, not to say what the soul is (for to speak about that is another matter), but to divide it in outline. Now the soul is, as"
**Ends at:** "9 the illiberal call the liberal prodigals, and the rash and; headlong call the brave cowards, while cowards call the brave headlong and mad."
