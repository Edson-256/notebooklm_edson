═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l08_c08_cena05_magna_moralia

 (Final filename on disk: aristoteles_27_l08_c08_cena05_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VIII, CHAPTER 8 (sub-cena 5 of 36).
- **Audio Position in This Work:** This is audio 92 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK VIII, Capítulo CHAPTER 8 (Cena 5/36)"
...
**Starts at:** "Further, let the work of the soul be to produce living, this! consisting in employment and being awake—for slumber is a sort of inactivity and rest. Therefore, since 25 the work must be one and the"
**Ends at:** "2 Retaining καί, 8."
