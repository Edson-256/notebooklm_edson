═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l08_c08_cena11_magna_moralia

 (Final filename on disk: aristoteles_27_l08_c08_cena11_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VIII, CHAPTER 8 (sub-cena 11 of 36).
- **Audio Position in This Work:** This is audio 98 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK VIII, Capítulo CHAPTER 8 (Cena 11/36)"
...
**Starts at:** "Let us next speak about choice, first raising various diffi- 10."
**Ends at:** "1227% meanwhile, it is clear that deliberate choice is not simply wish or simply opinion, but opinion and desire together when following as a conclusion from deliberation."
