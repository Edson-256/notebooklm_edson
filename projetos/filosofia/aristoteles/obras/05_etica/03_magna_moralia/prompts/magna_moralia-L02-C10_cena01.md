═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l02_c10_cena01_magna_moralia

 (Final filename on disk: aristoteles_27_l02_c10_cena01_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, CHAPTER 10 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 38 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK II, Capítulo CHAPTER 10 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Magna Moralia*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, CHAPTER 10, bounded by:

**Starts at:** "δὲ 1-3. What is acting in accordance with Right Reason?"
**Ends at:** "That depends on whether one puts one’s knowledge into practice."
