═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l02_c17_cena07_magna_moralia

 (Final filename on disk: aristoteles_27_l02_c17_cena07_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, CHAPTER 17 (sub-cena 7 of 28).
- **Audio Position in This Work:** This is audio 48 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK II, Capítulo CHAPTER 17 (Cena 7/28)"
...
**Starts at:** "the means; for instance, no one purposes to be in health, το but we purpose what leads to health, 6. g. walking, running ; but we wish for the ends. For we wish to be in health. So that it is evide"
**Ends at:** "Yes, but now also we assert this just the same, 1190° that the activity is better than the state."
