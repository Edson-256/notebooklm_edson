═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l08_c08_cena08_magna_moralia

 (Final filename on disk: aristoteles_27_l08_c08_cena08_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VIII, CHAPTER 8 (sub-cena 8 of 36).
- **Audio Position in This Work:** This is audio 95 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK VIII, Capítulo CHAPTER 8 (Cena 8/36)"
...
**Starts at:** "6 Letus, then, take another starting-point for the succeeding 1; inquiry. Every substance is by nature a sort of principle ; | therefore each can produce many similar to itself, as man ἢ man, anim"
**Ends at:** "This should perhaps be transferred to ® 36 or »12 (Spengel)."
