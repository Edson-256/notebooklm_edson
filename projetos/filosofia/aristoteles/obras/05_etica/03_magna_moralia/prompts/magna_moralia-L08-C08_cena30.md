═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l08_c08_cena30_magna_moralia

 (Final filename on disk: aristoteles_27_l08_c08_cena30_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VIII, CHAPTER 8 (sub-cena 30 of 36).
- **Audio Position in This Work:** This is audio 117 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK VIII, Capítulo CHAPTER 8 (Cena 30/36)"
...
**Starts at:** "successful in matters controlled by fortune, some also?"
**Ends at:** "18 ἄσονται (Sylburg)."
