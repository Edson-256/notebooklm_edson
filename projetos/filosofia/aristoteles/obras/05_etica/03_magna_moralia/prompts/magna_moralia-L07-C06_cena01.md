═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l07_c06_cena01_magna_moralia

 (Final filename on disk: aristoteles_27_l07_c06_cena01_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VII, CHAPTER 6 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 75 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK VII, Capítulo CHAPTER 6 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Magna Moralia*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VII, CHAPTER 6, bounded by:

**Starts at:** "Is a man a friend to himself?"
**Ends at:** "The relation to oneself is, like that of kinship, indissoluble."
