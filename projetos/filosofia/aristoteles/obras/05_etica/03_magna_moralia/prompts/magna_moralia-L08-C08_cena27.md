═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l08_c08_cena27_magna_moralia

 (Final filename on disk: aristoteles_27_l08_c08_cena27_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VIII, CHAPTER 8 (sub-cena 27 of 36).
- **Audio Position in This Work:** This is audio 114 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK VIII, Capítulo CHAPTER 8 (Cena 27/36)"
...
**Starts at:** "must consider whether we ought to render useful services and help to him, or to one who makes a return and has power. This is the same problem as whether we ought rather to benefit a friend or a vi"
**Ends at:** "πο ΜΝ ψῷ eae a Δ BOOK VII."
