═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_28_l01_c01_cena01_on_virtues_and_vices

 (Final filename on disk: aristoteles_28_l01_c01_cena01_on_virtues_and_vices.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I (inferido), Part 1 (inferido) (sub-cena 1 of 5).
- **Audio Position in This Work:** This is audio 2 of 125 for *On Virtues and Vices*.
...
1. **Título Principal:** "Guia de Estudos: Sobre as Virtudes e os Vícios (atribuído) — BOOK I (inferido), Capítulo Part 1 (inferido) (Cena 1/5)"
...
**Starts at:** "ON VIRTUES AND VICES INTRODUCTION Contents This essay is of interest as an example of the way in which Aristotle's reduction to scientific form of the ethical system adum"
**Ends at:** "άνδ/3εια δε 3 ON VIRTUES AND VICES 1 I."
