═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l02_c17_cena21_magna_moralia

 (Final filename on disk: aristoteles_27_l02_c17_cena21_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, CHAPTER 17 (sub-cena 21 of 28).
- **Audio Position in This Work:** This is audio 62 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK II, Capítulo CHAPTER 17 (Cena 21/28)"
...
**Starts at:** "This difficulty it is easy to answer and resolve from what has been said by us before’ about virtue. For we assert 10 that then, and only then, is there virtue, when reason being in a good conditio"
**Ends at:** "virtue that they use the expression ‘ noble and good’; for instance, 25 they say that the just man is noble and good, the brave man, the temperate, and generally in the case of the virtues."
