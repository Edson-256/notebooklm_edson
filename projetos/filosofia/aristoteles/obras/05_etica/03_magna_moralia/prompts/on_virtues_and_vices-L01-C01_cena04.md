═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_28_l01_c01_cena04_on_virtues_and_vices

 (Final filename on disk: aristoteles_28_l01_c01_cena04_on_virtues_and_vices.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I (inferido), Part 1 (inferido) (sub-cena 4 of 5).
- **Audio Position in This Work:** This is audio 5 of 125 for *On Virtues and Vices*.
...
1. **Título Principal:** "Guia de Estudos: Sobre as Virtudes e os Vícios (atribuído) — BOOK I (inferido), Capítulo Part 1 (inferido) (Cena 4/5)"
...
**Starts at:** "4 word. Ill-temper is accompanied by excitability of character, instability, bitter speech, and liability to take offence at trifles and to feel these feelings quickly and on"
**Ends at:** "Meanness is accompanied by pettiness, sulkiness, self-abasement, lack of proportion, ignoble- ness, misanthropy."
