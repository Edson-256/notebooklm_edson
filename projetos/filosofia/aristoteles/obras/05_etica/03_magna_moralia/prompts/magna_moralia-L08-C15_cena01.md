═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l08_c15_cena01_magna_moralia

 (Final filename on disk: aristoteles_27_l08_c15_cena01_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VIII, CHAPTER 15 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 125 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK VIII, Capítulo CHAPTER 15 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Magna Moralia*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VIII, CHAPTER 15, bounded by:

**Starts at:** "§§ 1, 2. We must now speak of that perfect virtue which results from a combination of the particular virtues. 1248 8-16. 3-5. There is more than a difference of name between ‘ good’ and ‘noble and"
**Ends at:** "The same measure applies to the activity of the irrational part of the soul."
