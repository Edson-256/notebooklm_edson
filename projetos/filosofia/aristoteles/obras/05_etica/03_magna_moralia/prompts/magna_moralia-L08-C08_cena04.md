═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l08_c08_cena04_magna_moralia

 (Final filename on disk: aristoteles_27_l08_c08_cena04_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VIII, CHAPTER 8 (sub-cena 4 of 36).
- **Audio Position in This Work:** This is audio 91 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK VIII, Capítulo CHAPTER 8 (Cena 4/36)"
...
**Starts at:** "But we should show the nature of the good fer se in the opposite way to that now used. For now from what is not agreed to possess the good they demonstrate the things admitted to be good, e.g. from"
**Ends at:** "If, then, the art of cobbling and the good cobbler have an excellence, their work is a good shoe: and similarly with everything else."
