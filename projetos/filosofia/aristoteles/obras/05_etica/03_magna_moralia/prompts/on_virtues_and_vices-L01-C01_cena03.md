═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_28_l01_c01_cena03_on_virtues_and_vices

 (Final filename on disk: aristoteles_28_l01_c01_cena03_on_virtues_and_vices.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I (inferido), Part 1 (inferido) (sub-cena 3 of 5).
- **Audio Position in This Work:** This is audio 4 of 125 for *On Virtues and Vices*.
...
1. **Título Principal:** "Guia de Estudos: Sobre as Virtudes e os Vícios (atribuído) — BOOK I (inferido), Capítulo Part 1 (inferido) (Cena 3/5)"
...
**Starts at:** "To courage it belongs to be undismayed by fears of death and confident in alarms and brave in face of dangers, and to prefer a fine death to base security, and to be a"
**Ends at:** "3 Of ill-temper there are three kinds, irascibility, bitterness, sullenness."
