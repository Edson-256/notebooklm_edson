═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l07_c10_cena01_magna_moralia

 (Final filename on disk: aristoteles_27_l07_c10_cena01_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VII, CHAPTER I0 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 79 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK VII, Capítulo CHAPTER I0 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Magna Moralia*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VII, CHAPTER I0, bounded by:

**Starts at:** "§§ 1, 2. There are friendships of— 3) 4. 18. 19, 20. 21-23. 24-29 30-32. 33-35 kinsmen, comrades, fellow-citizens. That of kinsmen may be based on proportional or numerical equalit"
**Ends at:** "Such cases must be settled by proportion."
