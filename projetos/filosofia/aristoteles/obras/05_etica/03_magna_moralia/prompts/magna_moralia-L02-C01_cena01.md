═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l02_c01_cena01_magna_moralia

 (Final filename on disk: aristoteles_27_l02_c01_cena01_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, CHAPTER I (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 29 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK II, Capítulo CHAPTER I (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Magna Moralia*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, CHAPTER I, bounded by:

**Starts at:** "§ 1. What has been laid down in general must now be applied in detail. 12287 23-26. 2-4. Courage is in the mean between rashness and cowardice. 1228 26-5 3, 5. Contrast between the brave man and t"
**Ends at:** "eat oe alll δὲ 12-14."
