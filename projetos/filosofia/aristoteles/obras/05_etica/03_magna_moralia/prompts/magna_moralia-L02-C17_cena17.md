═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l02_c17_cena17_magna_moralia

 (Final filename on disk: aristoteles_27_l02_c17_cena17_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, CHAPTER 17 (sub-cena 17 of 28).
- **Audio Position in This Work:** This is audio 58 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK II, Capítulo CHAPTER 17 (Cena 17/28)"
...
**Starts at:** "The above, then, are the points which present a difficulty ; aor\" but it is necessary to solve these difficulties. First, then, that which is connected with knowledge. For it appeared ὃ to be an ab"
**Ends at:** "these more than he ought is called incontinent in the complete sense."
