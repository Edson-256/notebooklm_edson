═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l02_c17_cena23_magna_moralia

 (Final filename on disk: aristoteles_27_l02_c17_cena23_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, CHAPTER 17 (sub-cena 23 of 28).
- **Audio Position in This Work:** This is audio 64 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK II, Capítulo CHAPTER 17 (Cena 23/28)"
...
**Starts at:** "Here, then, we see the source of the difficulty as to whether the good man is a friend to the bad man or not. 5 For what is good for oneself is in a way attached to the good, and so is that which i"
**Ends at:** "Among the unequal then there arises friendship based on utility."
