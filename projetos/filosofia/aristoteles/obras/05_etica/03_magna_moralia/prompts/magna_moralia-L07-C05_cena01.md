═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l07_c05_cena01_magna_moralia

 (Final filename on disk: aristoteles_27_l07_c05_cena01_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VII, CHAPTER 5 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 74 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK VII, Capítulo CHAPTER 5 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Magna Moralia*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VII, CHAPTER 5, bounded by:

**Starts at:** "§ 1. We now come back to the wider sense of friendship 4s con- sisting in likeness or in opposition. 1239? 6-10. 2-4. The like is reducible to the pleasant and the good. 1239” . 10-22. 5. The frie"
**Ends at:** "In persons it becomes a friendship based on unlikeness."
