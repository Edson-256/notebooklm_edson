═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l02_c17_cena11_magna_moralia

 (Final filename on disk: aristoteles_27_l02_c17_cena11_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, CHAPTER 17 (sub-cena 11 of 28).
- **Audio Position in This Work:** This is audio 52 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK II, Capítulo CHAPTER 17 (Cena 11/28)"
...
**Starts at:** "Since, then, justice consists in just and equal dealing and in a mean, we must notice that the just is said to be just as between certain persons, and the equal is a relation between certain person"
**Ends at:** "For the just is what is determined by law, but a piece of just conduct is the doing of just deeds."
