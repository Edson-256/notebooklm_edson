═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l02_c02_cena01_magna_moralia

 (Final filename on disk: aristoteles_27_l02_c02_cena01_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, CHAPTER 2 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 30 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK II, Capítulo CHAPTER 2 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Magna Moralia*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, CHAPTER 2, bounded by:

**Starts at:** "δὲ 1-3. 13. 14. . The sphere of temperance. . It is supposed to be the two senses of taste and touch, but . And only indirectly from smell. CONTENTS Courage consists in following reason, a"
**Ends at:** "A fuller treatment of this subject will be given when we come to speak of self-restraint."
