═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l08_c08_cena14_magna_moralia

 (Final filename on disk: aristoteles_27_l08_c08_cena14_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VIII, CHAPTER 8 (sub-cena 14 of 36).
- **Audio Position in This Work:** This is audio 101 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK VIII, Capítulo CHAPTER 8 (Cena 14/36)"
...
**Starts at:** "5 as to be patient as reason requires towards heat and cold and similar not dangerous pains, but weak and timid about death, not for any other feeling, but just because it means destruction, while"
**Ends at:** "8 This seems to refer to words which must have been lost at 1221 20."
