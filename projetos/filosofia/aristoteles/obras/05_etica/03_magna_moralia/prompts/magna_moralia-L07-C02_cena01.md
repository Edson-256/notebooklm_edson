═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l07_c02_cena01_magna_moralia

 (Final filename on disk: aristoteles_27_l07_c02_cena01_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VII, CHAPTER II (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 71 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK VII, Capítulo CHAPTER II (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Magna Moralia*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VII, CHAPTER II, bounded by:

**Starts at:** "δὲ 1-4. Casuistical questions about friendship."
**Ends at:** "The characteristics of friendship apply to different kinds, but none of them is confined to a single kind, 1244 20-36."
