═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l02_c17_cena16_magna_moralia

 (Final filename on disk: aristoteles_27_l02_c17_cena16_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════

Act as a Senior Humanities Tutor specializing in the formative reading of Aristotle. Your goal is to write a detailed, highly pedagogical study guide (Guia de Estudos) to accompany and support the listener of the deep-dive audio overview of a specific passage from Aristotle's *Magna Moralia*.

**Context & Anchoring:**
- **Work:** Magna Moralia (Magna Moralia (Grande Ética, atribuída)), translated by Archive.org/Stock.
- **Passage Identifier:** BOOK II, CHAPTER 17 (sub-cena 16 of 28).
- **Audio Position in This Work:** This is audio 57 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK II, Capítulo CHAPTER 17 (Cena 16/28)"
...
The sources uploaded to NotebookLM contain the full text of *Magna Moralia*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, CHAPTER 17, bounded by:

**Starts at:** "to be able to make a right use of these and the like goods when they are there. If therefore the good man on there coming to him high honour or high office shall not make a right use of these, it s"
**Ends at:** "A difficulty might also be raised as to whether lack of self-control and the incontinent man display themselves in and about everything, for instance, property and honour and anger and glory (for peop"
