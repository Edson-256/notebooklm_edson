═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l01_c21_cena01_magna_moralia

 (Final filename on disk: aristoteles_27_l01_c21_cena01_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, CHAPTER 21 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 25 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK I, Capítulo CHAPTER 21 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Magna Moralia*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, CHAPTER 21, bounded by:

**Starts at:** "§ 1. Between what vices Temperance is a mean."
**Ends at:** "The end must be right for right’s sake."
