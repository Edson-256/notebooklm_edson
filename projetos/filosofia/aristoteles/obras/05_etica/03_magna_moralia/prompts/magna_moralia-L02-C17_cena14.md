═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l02_c17_cena14_magna_moralia

 (Final filename on disk: aristoteles_27_l02_c17_cena14_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, CHAPTER 17 (sub-cena 14 of 28).
- **Audio Position in This Work:** This is audio 55 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK II, Capítulo CHAPTER 17 (Cena 14/28)"
...
**Starts at:** "το a virtue, it is reasonable that the better should be a virtue, so that it is evident that philosophy is a virtue. What is intelligence, and with what is it concerned? The sphere of intelligence"
**Ends at:** "Considerateness* and the considerate man have to do 2 35 with the same things as equity, with points of justice that have been omitted by the lawgiver owing to the inexact- ness of his definitions."
