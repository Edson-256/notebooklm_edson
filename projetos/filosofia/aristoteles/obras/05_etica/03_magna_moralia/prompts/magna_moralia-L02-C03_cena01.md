═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l02_c03_cena01_magna_moralia

 (Final filename on disk: aristoteles_27_l02_c03_cena01_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, CHAPTER 3 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 31 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK II, Capítulo CHAPTER 3 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Magna Moralia*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, CHAPTER 3, bounded by:

**Starts at:** "§§ 1,2. About the gentle person and the characters in excess and defect. 1231} 5-15. 3,4. Proof that there is a mean in this matter. 1231} 15-26."
**Ends at:** "Proof that there is a mean in this matter."
