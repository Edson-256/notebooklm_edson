═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_28_l01_c01_cena05_on_virtues_and_vices

 (Final filename on disk: aristoteles_28_l01_c01_cena05_on_virtues_and_vices.m4a)
═══════════════════════════════════════════════════════════════════════════════

Act as a Senior Humanities Tutor specializing in the formative reading of Aristotle. Your goal is to write a detailed, highly pedagogical study guide (Guia de Estudos) to accompany and support the listener of the deep-dive audio overview of a specific passage from Aristotle's *On Virtues and Vices*.

**Context & Anchoring:**
- **Work:** On Virtues and Vices (Sobre as Virtudes e os Vícios (atribuído)), translated by Rackham.
- **Passage Identifier:** BOOK I (inferido), Part 1 (inferido) (sub-cena 5 of 5).
- **Audio Position in This Work:** This is audio 6 of 125 for *On Virtues and Vices*.
...
1. **Título Principal:** "Guia de Estudos: Sobre as Virtudes e os Vícios (atribuído) — BOOK I (inferido), Capítulo Part 1 (inferido) (Cena 5/5)"
...
The sources uploaded to NotebookLM contain the full text of *On Virtues and Vices*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I (inferido), Part 1 (inferido), bounded by:

**Starts at:** "13 It belongs to small-mindedness to be unable to bear either honour or dishonour, either good fortune or bad, but to be filled with conceit when honoured and puffed up b"
**Ends at:** "4 To badness belong the opposite qualities, and it has the opposite concomitants : all the qualities and con- comitants of badness are among the things that are blamed."
