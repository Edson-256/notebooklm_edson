═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l02_c17_cena18_magna_moralia

 (Final filename on disk: aristoteles_27_l02_c17_cena18_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, CHAPTER 17 (sub-cena 18 of 28).
- **Audio Position in This Work:** This is audio 59 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK II, Capítulo CHAPTER 17 (Cena 18/28)"
...
**Starts at:** "Among the so-called ‘incontinences’ with respect to other things that which is concerned with anger is the most blameworthy. But which is more blameworthy, this or incontinence with regard to pleas"
**Ends at:** "The intemperate, then, is in himself the kind of man who is bad by nature, owing to which, and as a result of which, the reason in him is bad."
