═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l07_c04_cena01_magna_moralia

 (Final filename on disk: aristoteles_27_l07_c04_cena01_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VII, CHAPTER 4 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 73 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK VII, Capítulo CHAPTER 4 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Magna Moralia*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VII, CHAPTER 4, bounded by:

**Starts at:** "§§ 1,2. It is only in equal friendships that we call the parties ‘friends’."
**Ends at:** "But the essence of friendship lies in loving rather than in being loved."
