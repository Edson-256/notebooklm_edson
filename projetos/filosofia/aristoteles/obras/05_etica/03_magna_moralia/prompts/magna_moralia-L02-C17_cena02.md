═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l02_c17_cena02_magna_moralia

 (Final filename on disk: aristoteles_27_l02_c17_cena02_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, CHAPTER 17 (sub-cena 2 of 28).
- **Audio Position in This Work:** This is audio 43 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK II, Capítulo CHAPTER 17 (Cena 2/28)"
...
**Starts at:** "10 gories—in that of substance, quality, quantity, time, relation, [instrument], and generally in all. But what is good at a given time is known in medicine by the doctor, in naviga- tion by the pi"
**Ends at:** "the Stoic division of goods into δι᾿ αὑτὰ aipera and ποιητικά given in Stob."
