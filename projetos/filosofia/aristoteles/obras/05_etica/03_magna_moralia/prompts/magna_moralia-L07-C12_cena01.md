═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l07_c12_cena01_magna_moralia

 (Final filename on disk: aristoteles_27_l07_c12_cena01_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VII, CHAPTER 12 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 80 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK VII, Capítulo CHAPTER 12 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Magna Moralia*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VII, CHAPTER 12, bounded by:

**Starts at:** "§ 1. How is self-sufficingness compatible with the need for friend- ship? 1244>1-7. 2, 3. God needs no friend. .. The happier a man is, the less need has he of friends. 1244? 7-15. 4. This seems"
**Ends at:** "But here there is room for difference of opinion, as about misfortunes."
