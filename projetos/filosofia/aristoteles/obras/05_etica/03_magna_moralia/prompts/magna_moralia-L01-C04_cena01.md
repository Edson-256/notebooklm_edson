═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l01_c04_cena01_magna_moralia

 (Final filename on disk: aristoteles_27_l01_c04_cena01_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, CHAPTER 4 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 9 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK I, Capítulo CHAPTER 4 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Magna Moralia*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, CHAPTER 4, bounded by:

**Starts at:** "§ 1. Does Happiness depend merely on the character of the soul or rather on that of its acts? 1215%20-25. EO a ey CONTENTS δ 2. The three lives of men, 1215 26- 1. 3. The life of the philosoph"
**Ends at:** "Anaxagoras on the happy man."
