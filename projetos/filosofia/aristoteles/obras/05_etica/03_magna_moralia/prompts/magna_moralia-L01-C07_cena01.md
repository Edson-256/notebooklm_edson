═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l01_c07_cena01_magna_moralia

 (Final filename on disk: aristoteles_27_l01_c07_cena01_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, CHAPTER 7 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 12 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK I, Capítulo CHAPTER 7 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Magna Moralia*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, CHAPTER 7, bounded by:

**Starts at:** "§ 1. Now let us begin to apply the method that has been indicated."
**Ends at:** "Happiness is the best of things attainable by man’s action."
