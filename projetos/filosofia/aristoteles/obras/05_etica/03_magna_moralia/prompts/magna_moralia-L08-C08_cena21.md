═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l08_c08_cena21_magna_moralia

 (Final filename on disk: aristoteles_27_l08_c08_cena21_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VIII, CHAPTER 8 (sub-cena 21 of 36).
- **Audio Position in This Work:** This is audio 108 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK VIII, Capítulo CHAPTER 8 (Cena 21/36)"
...
The sources uploaded to NotebookLM contain the full text of *Magna Moralia*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VIII, CHAPTER 8, bounded by:

**Starts at:** "ships seem friendships to some, but are doubted to be such by others. For friendship seems something stable, and this alone is stable. For a formed decision is stable, and where we do not act quick"
**Ends at:** "as the virtue of a god is superior to that of a man (for this is another kind of friendship)—and in general 20 that of ruler to subject ; just as justice in this case is diffe- rent, for here it is a "
