═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l02_c13_cena01_magna_moralia

 (Final filename on disk: aristoteles_27_l02_c13_cena01_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, CHAPTER 13 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 40 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK II, Capítulo CHAPTER 13 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Magna Moralia*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, CHAPTER 13, bounded by:

**Starts at:** "The good man’s love of self will be displayed in the choice of the noble for himself. 12122 28-5 8."
**Ends at:** "The good man’s love of self will be displayed in the choice of the noble for himself."
