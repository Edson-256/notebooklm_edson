═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_27_l08_c08_cena26_magna_moralia

 (Final filename on disk: aristoteles_27_l08_c08_cena26_magna_moralia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VIII, CHAPTER 8 (sub-cena 26 of 36).
- **Audio Position in This Work:** This is audio 113 of 125 for *Magna Moralia*.
...
1. **Título Principal:** "Guia de Estudos: Magna Moralia (Grande Ética, atribuída) — BOOK VIII, Capítulo CHAPTER 8 (Cena 26/36)"
...
**Starts at:** "their relations are not merely legal but those of comrades) ; still the legal form of useful friendship is free from recri- mination. The legal association is dissolved by a money- payment (for it"
**Ends at:** "Here, too, there may be a dispute at the start, if one party pretends they have come together for use, and the other denies this and alleges that they have met from some other kind of friendship."
