═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_07_l03_c02_cena01_fisica

 (Final filename on disk: aristoteles_07_l03_c02_cena01_fisica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 20 of 75 for *Physics*.
...
1. **Título Principal:** "Guia de Estudos: Física — BOOK III, Capítulo Part 2 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Physics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, Part 2, bounded by:

**Starts at:** "The soundness of this definition is evident both when we consider the accounts of motion that the others have given, and also from the difficulty of defining it otherwise. One could not easily put m"
**Ends at:** "the full-formed man begets man from what is potentially man."
