═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_07_l06_c07_cena01_fisica

 (Final filename on disk: aristoteles_07_l06_c07_cena01_fisica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 53 of 75 for *Physics*.
...
1. **Título Principal:** "Guia de Estudos: Física — BOOK VI, Capítulo Part 7 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Physics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VI, Part 7, bounded by:

**Starts at:** "Now since the motion of everything that is in motion occupies a period of time, and a greater magnitude is traversed in a longer time, it is impossible that a thing should undergo a finite motion in a"
**Ends at:** "If either of the two is infinite, the other must be so likewise: for all locomotion is in space."
