═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_07_l08_c08_cena02_fisica

 (Final filename on disk: aristoteles_07_l08_c08_cena02_fisica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VIII, Part 8 (sub-cena 2 of 3).
- **Audio Position in This Work:** This is audio 72 of 75 for *Physics*.
...
1. **Título Principal:** "Guia de Estudos: Física — BOOK VIII, Capítulo Part 8 (Cena 2/3)"
...
**Starts at:** "The same method should also be adopted in replying to those who ask, in the terms of Zeno's argument, whether we admit that before any distance can be traversed half the distance must be traversed, th"
**Ends at:** "Therefore the motion is not a single motion, since motion that is interrupted by stationariness is not single."
