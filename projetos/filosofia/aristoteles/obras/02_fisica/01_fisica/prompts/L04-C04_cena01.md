═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_07_l04_c04_cena01_fisica

 (Final filename on disk: aristoteles_07_l04_c04_cena01_fisica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 30 of 75 for *Physics*.
...
1. **Título Principal:** "Guia de Estudos: Física — BOOK IV, Capítulo Part 4 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Physics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IV, Part 4, bounded by:

**Starts at:** "What then after all is place?"
**Ends at:** "Further, place is coincident with the thing, for boundaries are coincident with the bounded."
