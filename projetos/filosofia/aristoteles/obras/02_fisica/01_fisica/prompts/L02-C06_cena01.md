═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_07_l02_c06_cena01_fisica

 (Final filename on disk: aristoteles_07_l02_c06_cena01_fisica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 15 of 75 for *Physics*.
...
1. **Título Principal:** "Guia de Estudos: Física — BOOK II, Capítulo Part 6 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Physics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 6, bounded by:

**Starts at:** "They differ in that 'spontaneity' is the wider term."
**Ends at:** "Hence, however true it may be that the heavens are due to spontaneity, it will still be true that intelligence and nature will be prior causes of this All and of many things in it besides."
