═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_07_l07_c01_cena01_fisica

 (Final filename on disk: aristoteles_07_l07_c01_cena01_fisica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 57 of 75 for *Physics*.
...
1. **Título Principal:** "Guia de Estudos: Física — BOOK VII, Capítulo Part 1 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Physics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VII, Part 1, bounded by:

**Starts at:** "Everything that is in motion must be moved by something."
**Ends at:** "Therefore the series must come to an end, and there must be a first movent and a first moved: for the fact that this impossibility results only from the assumption of a particular case is immaterial, "
