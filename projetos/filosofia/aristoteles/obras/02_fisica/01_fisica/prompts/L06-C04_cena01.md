═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_07_l06_c04_cena01_fisica

 (Final filename on disk: aristoteles_07_l06_c04_cena01_fisica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 50 of 75 for *Physics*.
...
1. **Título Principal:** "Guia de Estudos: Física — BOOK VI, Capítulo Part 4 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Physics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VI, Part 4, bounded by:

**Starts at:** "Further, everything that changes must be divisible."
**Ends at:** "That divisibility does so we have already shown: that infinity does so will be made clear in what follows?"
