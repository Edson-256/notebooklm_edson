═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_07_l05_c04_cena01_fisica

 (Final filename on disk: aristoteles_07_l05_c04_cena01_fisica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 44 of 75 for *Physics*.
...
1. **Título Principal:** "Guia de Estudos: Física — BOOK V, Capítulo Part 4 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Physics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK V, Part 4, bounded by:

**Starts at:** "There are many senses in which motion is said to be 'one': for we use the term 'one' in many senses. Motion is one generically according to the different categories to which it may be assigned: thus"
**Ends at:** "If a motion is to be regular its parts ought to fit one another."
