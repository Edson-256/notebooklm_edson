═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_07_l04_c05_cena01_fisica

 (Final filename on disk: aristoteles_07_l04_c05_cena01_fisica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 31 of 75 for *Physics*.
...
1. **Título Principal:** "Guia de Estudos: Física — BOOK IV, Capítulo Part 5 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Physics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IV, Part 5, bounded by:

**Starts at:** "If then a body has another body outside it and containing it, it is in place, and if not, not. That is why, even if there were to be water which had not a container, the parts of it, on the one hand,"
**Ends at:** "This concludes my account of place-both of its existence and of its nature."
