═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_07_l02_c09_cena01_fisica

 (Final filename on disk: aristoteles_07_l02_c09_cena01_fisica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 18 of 75 for *Physics*.
...
1. **Título Principal:** "Guia de Estudos: Física — BOOK II, Capítulo Part 9 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Physics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 9, bounded by:

**Starts at:** "As regards what is 'of necessity', we must ask whether the necessity is 'hypothetical', or 'simple' as well. The current view places what is of necessity in the process of production, just as if one w"
**Ends at:** "For in the definition too there are some parts that are, as it were, its matter."
