═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_10_l04_c09_cena01_meteorologia

 (Final filename on disk: aristoteles_10_l04_c09_cena01_meteorologia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IV, Part 9 (sub-cena 1 of 2).
- **Audio Position in This Work:** This is audio 40 of 44 for *Meteorology*.
...
1. **Título Principal:** "Guia de Estudos: Meteorologia — BOOK IV, Capítulo Part 9 (Cena 1/2)"
...
The sources uploaded to NotebookLM contain the full text of *Meteorology*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IV, Part 9, bounded by:

**Starts at:** "Those bodies admit of softening which are not (like ice) made up of water, but in which earth predominates. All their moisture must not have left them (as in the case of natron and salt), nor must the"
**Ends at:** "For, a body being divided into many parts fin so far as its unity is made up of many lengths it is apt to be split, in so far as it is made up of many breadths it is apt to be cut."
