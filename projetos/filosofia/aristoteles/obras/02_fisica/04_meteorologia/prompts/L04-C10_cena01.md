═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_10_l04_c10_cena01_meteorologia

 (Final filename on disk: aristoteles_10_l04_c10_cena01_meteorologia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 42 of 44 for *Meteorology*.
...
1. **Título Principal:** "Guia de Estudos: Meteorologia — BOOK IV, Capítulo Part 10 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Meteorology*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IV, Part 10, bounded by:

**Starts at:** "Homogeneous bodies differ to touch-by these affections and differences, as we have said. They also differ in respect of their smell, taste, and colour. By homogeneous bodies I mean, for instance, 'm"
**Ends at:** "Semen solidifies by refrigeration, its moisture leaving it together with its heat."
