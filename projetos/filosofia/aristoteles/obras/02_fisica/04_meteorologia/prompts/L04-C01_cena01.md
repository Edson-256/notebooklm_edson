═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_10_l04_c01_cena01_meteorologia

 (Final filename on disk: aristoteles_10_l04_c01_cena01_meteorologia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 32 of 44 for *Meteorology*.
...
1. **Título Principal:** "Guia de Estudos: Meteorologia — BOOK IV, Capítulo Part 1 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Meteorology*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IV, Part 1, bounded by:

**Starts at:** "We have explained that the qualities that constitute the elements are four, and that their combinations determine the number of the elements to be four. Two of the qualities, the hot and the cold, a"
**Ends at:** "So much for the nature of becoming and of destruction."
