═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_10_l04_c06_cena01_meteorologia

 (Final filename on disk: aristoteles_10_l04_c06_cena01_meteorologia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 37 of 44 for *Meteorology*.
...
1. **Título Principal:** "Guia de Estudos: Meteorologia — BOOK IV, Capítulo Part 6 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Meteorology*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IV, Part 6, bounded by:

**Starts at:** "Liquefaction is, first, condensation into water; second, the melting of a solidified body. The first, condensation, is due to the cooling of vapour: what melting is will appear from the account of sol"
**Ends at:** "For the opposite of the dry-hot is the cold-moist and what the one solidified the other will dissolve, and so opposites will have opposite effects."
