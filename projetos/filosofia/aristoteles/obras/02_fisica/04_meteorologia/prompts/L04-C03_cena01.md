═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_10_l04_c03_cena01_meteorologia

 (Final filename on disk: aristoteles_10_l04_c03_cena01_meteorologia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 34 of 44 for *Meteorology*.
...
1. **Título Principal:** "Guia de Estudos: Meteorologia — BOOK IV, Capítulo Part 3 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Meteorology*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IV, Part 3, bounded by:

**Starts at:** "Ripening is a sort of concoction; for we call it ripening when there is a concoction of the nutriment in fruit. And since concoction is a sort of perfecting, the process of ripening is perfect when th"
**Ends at:** "We have now explained concoction and inconcoction, ripening and rawness, boiling and broiling, and their opposites."
