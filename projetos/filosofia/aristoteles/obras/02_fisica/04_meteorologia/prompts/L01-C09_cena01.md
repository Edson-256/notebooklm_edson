═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_10_l01_c09_cena01_meteorologia

 (Final filename on disk: aristoteles_10_l01_c09_cena01_meteorologia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 9 of 44 for *Meteorology*.
...
1. **Título Principal:** "Guia de Estudos: Meteorologia — BOOK I, Capítulo Part 9 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Meteorology*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 9, bounded by:

**Starts at:** "Let us go on to treat of the region which follows next in order after this and which immediately surrounds the earth. It is the region common to water and air, and the processes attending the formatio"
**Ends at:** "When the water falls in small drops it is called a drizzle; when the drops are larger it is rain."
