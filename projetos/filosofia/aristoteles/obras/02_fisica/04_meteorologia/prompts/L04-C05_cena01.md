═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_10_l04_c05_cena01_meteorologia

 (Final filename on disk: aristoteles_10_l04_c05_cena01_meteorologia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 36 of 44 for *Meteorology*.
...
1. **Título Principal:** "Guia de Estudos: Meteorologia — BOOK IV, Capítulo Part 5 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Meteorology*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IV, Part 5, bounded by:

**Starts at:** "A body determined by its own boundary must be either hard or soft; for it either yields or does not. It must also be concrete: or it could not be so determined. So since everything that is determine"
**Ends at:** "By external heat I mean as where things are boiled: by internal where the heat breathes out and takes away and uses up its moisture."
