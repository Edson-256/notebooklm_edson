═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_10_l01_c07_cena01_meteorologia

 (Final filename on disk: aristoteles_10_l01_c07_cena01_meteorologia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 7 of 44 for *Meteorology*.
...
1. **Título Principal:** "Guia de Estudos: Meteorologia — BOOK I, Capítulo Part 7 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Meteorology*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 7, bounded by:

**Starts at:** "We consider a satisfactory explanation of phenomena inaccessible to observation to have been given when our account of them is free from impossibilities. The observations before us suggest the followi"
**Ends at:** "But the chief reason is that most of this stuff collects in the region of the milky way."
