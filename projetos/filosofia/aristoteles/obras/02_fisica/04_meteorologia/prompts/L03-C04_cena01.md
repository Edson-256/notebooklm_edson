═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_10_l03_c04_cena01_meteorologia

 (Final filename on disk: aristoteles_10_l03_c04_cena01_meteorologia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 29 of 44 for *Meteorology*.
...
1. **Título Principal:** "Guia de Estudos: Meteorologia — BOOK III, Capítulo Part 4 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Meteorology*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, Part 4, bounded by:

**Starts at:** "We have already stated that the rainbow is a reflection: we have now to explain what sort of reflection it is, to describe its various concomitants, and to assign their causes. Sight is reflected fr"
**Ends at:** "Three rainbows or more are not found because even the second is fainter, so that the third reflection can have no strength whatever and cannot reach the sun at all."
