═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_10_l03_c02_cena01_meteorologia

 (Final filename on disk: aristoteles_10_l03_c02_cena01_meteorologia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 27 of 44 for *Meteorology*.
...
1. **Título Principal:** "Guia de Estudos: Meteorologia — BOOK III, Capítulo Part 2 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Meteorology*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, Part 2, bounded by:

**Starts at:** "Let us now explain the nature and cause of halo, rainbow, mock suns, and rods, since the same account applies to them all. We must first describe the phenomena and the circumstances in which each of"
**Ends at:** "However, we must accept the account we have given of these things in the theory of sensation, and take some things for granted while we explain others."
