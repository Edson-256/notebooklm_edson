═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_10_l04_c09_cena02_meteorologia

 (Final filename on disk: aristoteles_10_l04_c09_cena02_meteorologia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IV, Part 9 (sub-cena 2 of 2).
- **Audio Position in This Work:** This is audio 41 of 44 for *Meteorology*.
...
1. **Título Principal:** "Guia de Estudos: Meteorologia — BOOK IV, Capítulo Part 9 (Cena 2/2)"
...
**Starts at:** "A thing is viscous when, being moist or soft, it is tractile."
**Ends at:** ") So those bodies that give off fumes, like oil and pitch, belong rather to the moist, but those that burn to the dry."
