═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_10_l04_c04_cena01_meteorologia

 (Final filename on disk: aristoteles_10_l04_c04_cena01_meteorologia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 35 of 44 for *Meteorology*.
...
1. **Título Principal:** "Guia de Estudos: Meteorologia — BOOK IV, Capítulo Part 4 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Meteorology*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IV, Part 4, bounded by:

**Starts at:** "We must now describe the forms taken by the passive qualities the moist and the dry. The elements of bodies, that is, the passive ones, are the moist and the dry; the bodies themselves are compounded"
**Ends at:** "So we call that which exceeds it hard and that which falls short of it soft."
