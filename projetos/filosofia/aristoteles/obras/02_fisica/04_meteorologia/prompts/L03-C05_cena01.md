═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_10_l03_c05_cena01_meteorologia

 (Final filename on disk: aristoteles_10_l03_c05_cena01_meteorologia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 30 of 44 for *Meteorology*.
...
1. **Título Principal:** "Guia de Estudos: Meteorologia — BOOK III, Capítulo Part 5 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Meteorology*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, Part 5, bounded by:

**Starts at:** "The rainbow can never be a circle nor a segment of a circle greater than a semicircle. The consideration of the diagram will prove this and the other properties of the rainbow. (See diagram.) Let A"
**Ends at:** "But in the days near the winter solstice the visible arcs are small, and the contrary is necessarily the case: for the sun is on the meridian before the point H has risen far."
