═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_10_l01_c04_cena01_meteorologia

 (Final filename on disk: aristoteles_10_l01_c04_cena01_meteorologia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 4 of 44 for *Meteorology*.
...
1. **Título Principal:** "Guia de Estudos: Meteorologia — BOOK I, Capítulo Part 4 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Meteorology*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 4, bounded by:

**Starts at:** "Having determined these principles let us explain the cause of the appearance in the sky of burning flames and of shooting-stars, and of 'torches', and 'goats', as some people call them. All these phe"
**Ends at:** "This is shown by their apparent speed, which is equal to that of things thrown by us; for it is because they are close to us, that these latter seem far to exceed in speed the stars, the sun, and the "
