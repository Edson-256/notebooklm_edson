═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_10_l01_c14_cena01_meteorologia

 (Final filename on disk: aristoteles_10_l01_c14_cena01_meteorologia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, Part 14 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 14 of 44 for *Meteorology*.
...
1. **Título Principal:** "Guia de Estudos: Meteorologia — BOOK I, Capítulo Part 14 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Meteorology*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 14, bounded by:

**Starts at:** "The same parts of the earth are not always moist or dry, but they change according as rivers come into existence and dry up. And so the relation of land to sea changes too and a place does not always"
**Ends at:** "So we have explained that the same parts of the earth are not always land or sea and why that is so: and also why some rivers are perennial and others not."
