═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_10_l01_c13_cena01_meteorologia

 (Final filename on disk: aristoteles_10_l01_c13_cena01_meteorologia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 13 of 44 for *Meteorology*.
...
1. **Título Principal:** "Guia de Estudos: Meteorologia — BOOK I, Capítulo Part 13 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Meteorology*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 13, bounded by:

**Starts at:** "Let us explain the nature of winds, and all windy vapours, also of rivers and of the sea. But here, too, we must first discuss the difficulties involved: for, as in other matters, so in this no theory"
**Ends at:** "And in Liguria a river equal in size to the Rhodanus is swallowed up and appears again elsewhere: the Rhodanus being a navigable river."
