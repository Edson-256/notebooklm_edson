═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_10_l02_c06_cena01_meteorologia

 (Final filename on disk: aristoteles_10_l02_c06_cena01_meteorologia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 21 of 44 for *Meteorology*.
...
1. **Título Principal:** "Guia de Estudos: Meteorologia — BOOK II, Capítulo Part 6 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Meteorology*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 6, bounded by:

**Starts at:** "Let us now explain the position of the winds, their oppositions, which can blow simultaneously with which, and which cannot, their names and number, and any other of their affections that have not bee"
**Ends at:** "So much for the winds, their origin and nature and the properties common to them all or peculiar to each."
