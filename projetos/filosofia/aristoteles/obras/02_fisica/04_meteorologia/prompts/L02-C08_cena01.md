═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_10_l02_c08_cena01_meteorologia

 (Final filename on disk: aristoteles_10_l02_c08_cena01_meteorologia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, Part 8 (sub-cena 1 of 2).
- **Audio Position in This Work:** This is audio 23 of 44 for *Meteorology*.
...
1. **Título Principal:** "Guia de Estudos: Meteorologia — BOOK II, Capítulo Part 8 (Cena 1/2)"
...
The sources uploaded to NotebookLM contain the full text of *Meteorology*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 8, bounded by:

**Starts at:** "We have already shown that wet and dry must both give rise to an evaporation: earthquakes are a necessary consequence of this fact. The earth is essentially dry, but rain fills it with moisture. Then"
**Ends at:** ") Well, when this evaporation disappears into the earth the vaporous exhalation concentrates and causes cold in any place in which this disappearance occurs."
