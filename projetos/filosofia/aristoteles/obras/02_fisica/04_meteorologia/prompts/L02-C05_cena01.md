═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_10_l02_c05_cena01_meteorologia

 (Final filename on disk: aristoteles_10_l02_c05_cena01_meteorologia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 20 of 44 for *Meteorology*.
...
1. **Título Principal:** "Guia de Estudos: Meteorologia — BOOK II, Capítulo Part 5 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Meteorology*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 5, bounded by:

**Starts at:** "The sun both checks the formation of winds and stimulates it."
**Ends at:** "The origin of these winds and their relation to one another has now been explained."
