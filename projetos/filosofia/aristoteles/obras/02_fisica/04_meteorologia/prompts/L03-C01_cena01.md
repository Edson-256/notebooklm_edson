═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_10_l03_c01_cena01_meteorologia

 (Final filename on disk: aristoteles_10_l03_c01_cena01_meteorologia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 26 of 44 for *Meteorology*.
...
1. **Título Principal:** "Guia de Estudos: Meteorologia — BOOK III, Capítulo Part 1 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Meteorology*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, Part 1, bounded by:

**Starts at:** "Let us explain the remaining operations of this secretion in the same way as we have treated the rest. When this exhalation is secreted in small and scattered quantities and frequently, and is transit"
**Ends at:** "We have now explained thunder and lightning and hurricane, and further firewinds, whirlwinds, and thunderbolts, and shown that they are all of them forms of the same thing and wherein they all differ."
