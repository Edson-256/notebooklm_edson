═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_10_l02_c01_cena01_meteorologia

 (Final filename on disk: aristoteles_10_l02_c01_cena01_meteorologia.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 15 of 44 for *Meteorology*.
...
1. **Título Principal:** "Guia de Estudos: Meteorologia — BOOK II, Capítulo Part 1 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Meteorology*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 1, bounded by:

**Starts at:** "Let us explain the nature of the sea and the reason why such a large mass of water is salt and the way in which it originally came to be. The old writers who invented theogonies say that the sea has"
**Ends at:** "So much to prove that there cannot be sources of the sea and to explain its observed flow."
