═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_08_l01_c11_cena01_sobre_o_ceu

 (Final filename on disk: aristoteles_08_l01_c11_cena01_sobre_o_ceu.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 11 of 42 for *On the Heavens*.
...
1. **Título Principal:** "Guia de Estudos: Sobre o Céu — BOOK I, Capítulo Part 11 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Heavens*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 11, bounded by:

**Starts at:** "We must first distinguish the senses in which we use the words 'ungenerated' and 'generated', 'destructible' and 'indestructible'. These have many meanings, and though it may make no difference to the"
**Ends at:** "Superior sight is sight of the smaller body, but superior speed is that of the greater body."
