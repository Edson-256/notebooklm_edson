═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_08_l03_c04_cena01_sobre_o_ceu

 (Final filename on disk: aristoteles_08_l03_c04_cena01_sobre_o_ceu.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK III, Part 4 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 32 of 42 for *On the Heavens*.
...
1. **Título Principal:** "Guia de Estudos: Sobre o Céu — BOOK III, Capítulo Part 4 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Heavens*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, Part 4, bounded by:

**Starts at:** "The next question to consider is whether the elements are finite or infinite in number, and, if finite, what their number is. Let us first show reason or denying that their number is infinite, as some"
**Ends at:** "Again, if every element has its proper movement, and a simple body has a simple movement, and the number of simple movements is not infinite, because the simple motions are only two and the number of "
