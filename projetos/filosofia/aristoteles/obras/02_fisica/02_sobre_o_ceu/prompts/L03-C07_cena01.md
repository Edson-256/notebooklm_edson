═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_08_l03_c07_cena01_sobre_o_ceu

 (Final filename on disk: aristoteles_08_l03_c07_cena01_sobre_o_ceu.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 35 of 42 for *On the Heavens*.
...
1. **Título Principal:** "Guia de Estudos: Sobre o Céu — BOOK III, Capítulo Part 7 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Heavens*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, Part 7, bounded by:

**Starts at:** "We must, therefore, turn to the question, what is the manner of their generation from one another? Is it as Empedocles and Democritus say, or as those who resolve bodies into planes say, or is there y"
**Ends at:** "Either, then, a part of fire is not fire, so that there is a body prior to the element-for every body is either an element or composed of elements-or not every body is divisible."
