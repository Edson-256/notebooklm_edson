═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_08_l03_c02_cena01_sobre_o_ceu

 (Final filename on disk: aristoteles_08_l03_c02_cena01_sobre_o_ceu.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 30 of 42 for *On the Heavens*.
...
1. **Título Principal:** "Guia de Estudos: Sobre o Céu — BOOK III, Capítulo Part 2 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Heavens*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, Part 2, bounded by:

**Starts at:** "The necessity that each of the simple bodies should have a natural movement may be shown as follows. They manifestly move, and if they have no proper movement they must move by constraint: and the con"
**Ends at:** "That which is potentially a certain kind of body may, it is true, become such in actuality, But if the potential body was not already in actuality some other kind of body, the existence of an extra-co"
