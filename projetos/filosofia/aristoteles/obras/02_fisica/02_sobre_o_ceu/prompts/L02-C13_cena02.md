═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_08_l02_c13_cena02_sobre_o_ceu

 (Final filename on disk: aristoteles_08_l02_c13_cena02_sobre_o_ceu.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, Part 13 (sub-cena 2 of 2).
- **Audio Position in This Work:** This is audio 27 of 42 for *On the Heavens*.
...
1. **Título Principal:** "Guia de Estudos: Sobre o Céu — BOOK II, Capítulo Part 13 (Cena 2/2)"
...
**Starts at:** "Now, first, if the shape of the earth is not flat, its flatness cannot be the cause of its immobility. But in their own account it is rather the size of the earth than its flatness that causes it to r"
**Ends at:** "We have now outlined the views held as to the shape, position, and rest or movement of the earth."
