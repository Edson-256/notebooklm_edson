═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_08_l04_c01_cena01_sobre_o_ceu

 (Final filename on disk: aristoteles_08_l04_c01_cena01_sobre_o_ceu.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 37 of 42 for *On the Heavens*.
...
1. **Título Principal:** "Guia de Estudos: Sobre o Céu — BOOK IV, Capítulo Part 1 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Heavens*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IV, Part 1, bounded by:

**Starts at:** "We have now to consider the terms 'heavy' and 'light'."
**Ends at:** "By lighter or relatively light we mean that one, of two bodies endowed with weight and equal in bulk, which is exceeded by the other in the speed of its natural downward movement."
