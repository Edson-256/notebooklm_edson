═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_08_l01_c04_cena01_sobre_o_ceu

 (Final filename on disk: aristoteles_08_l01_c04_cena01_sobre_o_ceu.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 4 of 42 for *On the Heavens*.
...
1. **Título Principal:** "Guia de Estudos: Sobre o Céu — BOOK I, Capítulo Part 4 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Heavens*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 4, bounded by:

**Starts at:** "That there is no other form of motion opposed as contrary to the circular may be proved in various ways. In the first place, there is an obvious tendency to oppose the straight line to the circular. F"
**Ends at:** "But God and nature create nothing that has not its use."
