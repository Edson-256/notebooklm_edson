═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_08_l03_c06_cena01_sobre_o_ceu

 (Final filename on disk: aristoteles_08_l03_c06_cena01_sobre_o_ceu.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 34 of 42 for *On the Heavens*.
...
1. **Título Principal:** "Guia de Estudos: Sobre o Céu — BOOK III, Capítulo Part 6 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Heavens*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, Part 6, bounded by:

**Starts at:** "First we must inquire whether the elements are eternal or subject to generation and destruction; for when this question has been answered their number and character will be manifest. In the first plac"
**Ends at:** "The elements therefore cannot be generated from something incorporeal nor from a body which is not an element, and the only remaining alternative is that they are generated from one another."
