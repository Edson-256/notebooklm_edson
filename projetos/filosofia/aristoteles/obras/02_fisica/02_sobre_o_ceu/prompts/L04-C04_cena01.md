═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_08_l04_c04_cena01_sobre_o_ceu

 (Final filename on disk: aristoteles_08_l04_c04_cena01_sobre_o_ceu.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 40 of 42 for *On the Heavens*.
...
1. **Título Principal:** "Guia de Estudos: Sobre o Céu — BOOK IV, Capítulo Part 4 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Heavens*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IV, Part 4, bounded by:

**Starts at:** "We have now to speak of the distinctive properties of these bodies and of the various phenomena connected with them. In accordance with general conviction we may distinguish the absolutely heavy, as t"
**Ends at:** "It is the same matter, but its being is different, as that which is receptive of disease is the same as that which is receptive of health, though in being different from it, and therefore diseasedness"
