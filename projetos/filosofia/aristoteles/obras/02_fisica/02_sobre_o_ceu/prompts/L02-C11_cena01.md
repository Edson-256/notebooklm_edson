═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_08_l02_c11_cena01_sobre_o_ceu

 (Final filename on disk: aristoteles_08_l02_c11_cena01_sobre_o_ceu.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 24 of 42 for *On the Heavens*.
...
1. **Título Principal:** "Guia de Estudos: Sobre o Céu — BOOK II, Capítulo Part 11 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Heavens*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 11, bounded by:

**Starts at:** "With regard to the shape of each star, the most reasonable view is that they are spherical. It has been shown that it is not in their nature to move themselves, and, since nature is no wanton or rando"
**Ends at:** "One, then, of the heavenly bodies being spherical, clearly the rest will be spherical also."
