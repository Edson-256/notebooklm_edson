═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_08_l02_c14_cena01_sobre_o_ceu

 (Final filename on disk: aristoteles_08_l02_c14_cena01_sobre_o_ceu.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 28 of 42 for *On the Heavens*.
...
1. **Título Principal:** "Guia de Estudos: Sobre o Céu — BOOK II, Capítulo Part 14 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Heavens*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 14, bounded by:

**Starts at:** "Let us first decide the question whether the earth moves or is at rest. For, as we said, there are some who make it one of the stars, and others who, setting it at the centre, suppose it to be 'rolled"
**Ends at:** "This indicates not only that the earth's mass is spherical in shape, but also that as compared with the stars it is not of great size."
