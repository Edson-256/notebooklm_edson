═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_08_l04_c06_cena01_sobre_o_ceu

 (Final filename on disk: aristoteles_08_l04_c06_cena01_sobre_o_ceu.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 42 of 42 for *On the Heavens*.
...
1. **Título Principal:** "Guia de Estudos: Sobre o Céu — BOOK IV, Capítulo Part 6 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Heavens*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IV, Part 6, bounded by:

**Starts at:** "The shape of bodies will not account for their moving upward or downward in general, though it will account for their moving faster or slower. The reasons for this are not difficult to see. For the pr"
**Ends at:** "We have now finished our examination of the heavy and the light and of the phenomena connected with them."
