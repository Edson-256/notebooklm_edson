═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_08_l01_c12_cena02_sobre_o_ceu

 (Final filename on disk: aristoteles_08_l01_c12_cena02_sobre_o_ceu.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, Part 12 (sub-cena 2 of 2).
- **Audio Position in This Work:** This is audio 13 of 42 for *On the Heavens*.
...
1. **Título Principal:** "Guia de Estudos: Sobre o Céu — BOOK I, Capítulo Part 12 (Cena 2/2)"
...
The sources uploaded to NotebookLM contain the full text of *On the Heavens*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 12, bounded by:

**Starts at:** "If, however, 'indestructible' and 'ungenerated' are not coincident, there is no necessity that either the ungenerated or the indestructible should be eternal. But they must be coincident, for the foll"
**Ends at:** "Now alteration is due to contraries, and the things which compose the natural body are the very same that destroy it."
