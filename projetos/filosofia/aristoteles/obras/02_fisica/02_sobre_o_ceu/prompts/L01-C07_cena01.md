═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_08_l01_c07_cena01_sobre_o_ceu

 (Final filename on disk: aristoteles_08_l01_c07_cena01_sobre_o_ceu.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 7 of 42 for *On the Heavens*.
...
1. **Título Principal:** "Guia de Estudos: Sobre o Céu — BOOK I, Capítulo Part 7 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Heavens*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 7, bounded by:

**Starts at:** "Every body must necessarily be either finite or infinite, and if infinite, either of similar or of dissimilar parts. If its parts are dissimilar, they must represent either a finite or an infinite num"
**Ends at:** "From these arguments then it is clear that the body of the universe is not infinite."
