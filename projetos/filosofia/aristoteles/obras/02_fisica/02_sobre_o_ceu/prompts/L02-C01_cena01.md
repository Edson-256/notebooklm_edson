═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_08_l02_c01_cena01_sobre_o_ceu

 (Final filename on disk: aristoteles_08_l02_c01_cena01_sobre_o_ceu.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 14 of 42 for *On the Heavens*.
...
1. **Título Principal:** "Guia de Estudos: Sobre o Céu — BOOK II, Capítulo Part 1 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Heavens*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 1, bounded by:

**Starts at:** "That the heaven as a whole neither came into being nor admits of destruction, as some assert, but is one and eternal, with no end or beginning of its total duration, containing and embracing in itself"
**Ends at:** "But of this enough for the present."
