═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_08_l03_c01_cena01_sobre_o_ceu

 (Final filename on disk: aristoteles_08_l03_c01_cena01_sobre_o_ceu.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 29 of 42 for *On the Heavens*.
...
1. **Título Principal:** "Guia de Estudos: Sobre o Céu — BOOK III, Capítulo Part 1 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Heavens*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, Part 1, bounded by:

**Starts at:** "We have already discussed the first heaven and its parts, the moving stars within it, the matter of which these are composed and their bodily constitution, and we have also shown that they are ungener"
**Ends at:** "For natural bodies are manifestly endowed with weight and lightness, but an assemblage of units can neither be composed to form a body nor possess weight."
