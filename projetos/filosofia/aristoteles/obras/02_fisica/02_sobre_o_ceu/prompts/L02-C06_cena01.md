═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_08_l02_c06_cena01_sobre_o_ceu

 (Final filename on disk: aristoteles_08_l02_c06_cena01_sobre_o_ceu.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 19 of 42 for *On the Heavens*.
...
1. **Título Principal:** "Guia de Estudos: Sobre o Céu — BOOK II, Capítulo Part 6 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Heavens*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 6, bounded by:

**Starts at:** "We have next to show that the movement of the heaven is regular and not irregular. This applies only to the first heaven and the first movement; for the lower spheres exhibit a composition of several"
**Ends at:** "That there is one heaven, then, only, and that it is ungenerated and eternal, and further that its movement is regular, has now been sufficiently explained."
