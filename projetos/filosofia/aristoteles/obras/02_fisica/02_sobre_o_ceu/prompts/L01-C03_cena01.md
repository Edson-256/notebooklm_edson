═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_08_l01_c03_cena01_sobre_o_ceu

 (Final filename on disk: aristoteles_08_l01_c03_cena01_sobre_o_ceu.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 3 of 42 for *On the Heavens*.
...
1. **Título Principal:** "Guia de Estudos: Sobre o Céu — BOOK I, Capítulo Part 3 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Heavens*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 3, bounded by:

**Starts at:** "In consequence of what has been said, in part by way of assumption and in part by way of proof, it is clear that not every body either possesses lightness or heaviness. As a preliminary we must explai"
**Ends at:** "The motion of a simple body must itself be simple, and we assert that there are only these two simple motions, the circular and the straight, the latter being subdivided into motion away from and moti"
