═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_09_l02_c09_cena01_geracao_corrupcao

 (Final filename on disk: aristoteles_09_l02_c09_cena01_geracao_corrupcao.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 24 of 26 for *On Generation and Corruption*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração e a Corrupção — BOOK II, Capítulo Part 9 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Generation and Corruption*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 9, bounded by:

**Starts at:** "Since some things are such as to come-to-be and pass-away, and since coming-to-be in fact occurs in the region about the centre, we must explain the number and the nature of the 'originative sources'"
**Ends at:** "that Fire is inferior to the tools or instruments in the manner in which it sets things moving."
