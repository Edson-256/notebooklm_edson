═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_09_l01_c04_cena01_geracao_corrupcao

 (Final filename on disk: aristoteles_09_l01_c04_cena01_geracao_corrupcao.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 6 of 26 for *On Generation and Corruption*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração e a Corrupção — BOOK I, Capítulo Part 4 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Generation and Corruption*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 4, bounded by:

**Starts at:** "Next we must state what the difference is between coming-to-be and 'alteration'-for we maintain that these changes are distinct from one another. Since, then, we must distinguish (a) the substratum,"
**Ends at:** "what are the precise conditions of its occurrence and (ii) what 'alteration' is: but we have still to treat of growth."
