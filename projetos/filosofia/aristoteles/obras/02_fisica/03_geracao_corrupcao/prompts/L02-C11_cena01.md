═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_09_l02_c11_cena01_geracao_corrupcao

 (Final filename on disk: aristoteles_09_l02_c11_cena01_geracao_corrupcao.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, Part 11 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 26 of 26 for *On Generation and Corruption*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração e a Corrupção — BOOK II, Capítulo Part 11 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Generation and Corruption*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 11, bounded by:

**Starts at:** "Wherever there is continuity in any process (coming-to-be or 'alteration' or any kind of change whatever) we observe consecutiveness', i.e. this coming-to-be after that without any interval. Hence we"
**Ends at:** "That why, when Water comes-to-be from Air and Air from Water, the Air is the same 'specifically', not 'numerically': and if these too recur numerically the same, at any rate this does not happen with "
