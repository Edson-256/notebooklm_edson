═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_09_l01_c05_cena01_geracao_corrupcao

 (Final filename on disk: aristoteles_09_l01_c05_cena01_geracao_corrupcao.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, Part 5 (sub-cena 1 of 3).
- **Audio Position in This Work:** This is audio 7 of 26 for *On Generation and Corruption*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração e a Corrupção — BOOK I, Capítulo Part 5 (Cena 1/3)"
...
**Starts at:** "We must explain (i) wherein growth differs from coming-to-be and from 'alteration', and ii) what is the process of growing and the sprocess of diminishing in each and all of the things that grow and d"
**Ends at:** "If, on the other hand (b) it grows by the accession of a body, there will be two bodies-that which grows and that which increases it-in the same place: and this too is impossible."
