═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_09_l02_c10_cena01_geracao_corrupcao

 (Final filename on disk: aristoteles_09_l02_c10_cena01_geracao_corrupcao.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 25 of 26 for *On Generation and Corruption*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração e a Corrupção — BOOK II, Capítulo Part 10 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Generation and Corruption*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 10, bounded by:

**Starts at:** "As to our own theory-we have given a general account of the causes in an earlier work,' we have now explained and distinguished the 'matter' and the 'form'. Further, since the change which is motion h"
**Ends at:** "the body which is being moved in a circle; and its movement makes time continuous."
