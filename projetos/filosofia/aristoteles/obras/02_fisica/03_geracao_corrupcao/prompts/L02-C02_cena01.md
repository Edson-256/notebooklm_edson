═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_09_l02_c02_cena01_geracao_corrupcao

 (Final filename on disk: aristoteles_09_l02_c02_cena01_geracao_corrupcao.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 17 of 26 for *On Generation and Corruption*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração e a Corrupção — BOOK II, Capítulo Part 2 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Generation and Corruption*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 2, bounded by:

**Starts at:** "Since, then, we are looking for 'originative sources' of perceptible body; and since 'perceptible' is equivalent to 'tangible', and 'tangible' is that of which the perception is touch; it is clear tha"
**Ends at:** "Hence these must be four."
