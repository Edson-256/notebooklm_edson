═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_09_l01_c08_cena02_geracao_corrupcao

 (Final filename on disk: aristoteles_09_l01_c08_cena02_geracao_corrupcao.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, Part 8 (sub-cena 2 of 2).
- **Audio Position in This Work:** This is audio 13 of 26 for *On Generation and Corruption*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração e a Corrupção — BOOK I, Capítulo Part 8 (Cena 2/2)"
...
**Starts at:** "Now we have discussed 'indivisible planes' in the preceding treatise.' But with regard to the assumption of 'indivisible solids', although we must not now enter upon a detailed study of its consequenc"
**Ends at:** "But since bodies are divisible through and through, the postulate of pores is ridiculous: for, qua divisible, a body can fall into separate parts."
