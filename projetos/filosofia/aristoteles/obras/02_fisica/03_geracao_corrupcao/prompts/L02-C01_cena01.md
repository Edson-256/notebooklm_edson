═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_09_l02_c01_cena01_geracao_corrupcao

 (Final filename on disk: aristoteles_09_l02_c01_cena01_geracao_corrupcao.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 16 of 26 for *On Generation and Corruption*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração e a Corrupção — BOOK II, Capítulo Part 1 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Generation and Corruption*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 1, bounded by:

**Starts at:** "We have explained under what conditions 'combination', 'contact', and 'action-passion' are attributable to the things which undergo natural change. Further, we have discussed 'unqualified' coming-to-b"
**Ends at:** "For all the other thinkers assume and use them without explaining why they are these or why they are just so many."
