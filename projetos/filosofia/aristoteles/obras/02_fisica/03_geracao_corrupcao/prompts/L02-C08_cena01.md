═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_09_l02_c08_cena01_geracao_corrupcao

 (Final filename on disk: aristoteles_09_l02_c08_cena01_geracao_corrupcao.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 23 of 26 for *On Generation and Corruption*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração e a Corrupção — BOOK II, Capítulo Part 8 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Generation and Corruption*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 8, bounded by:

**Starts at:** "All the compound bodies-all of which exist in the region belonging to the central body-are composed of all the 'simple' bodies. For they all contain Earth because every 'simple' body is to be found sp"
**Ends at:** "Thus we have explained that all the compound bodies are composed of all the 'simple' bodies."
