═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_09_l01_c05_cena02_geracao_corrupcao

 (Final filename on disk: aristoteles_09_l01_c05_cena02_geracao_corrupcao.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, Part 5 (sub-cena 2 of 3).
- **Audio Position in This Work:** This is audio 8 of 26 for *On Generation and Corruption*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração e a Corrupção — BOOK I, Capítulo Part 5 (Cena 2/3)"
...
**Starts at:** "But neither is it open to us to say that growth or diminution occurs in the way in which e.g. air is generated from water. For, although the volume has then become greater, the change will not be grow"
**Ends at:** "But when the logs themselves are set on fire, that is 'coming-to-be'."
