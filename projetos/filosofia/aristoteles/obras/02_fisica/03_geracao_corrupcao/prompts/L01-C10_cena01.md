═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_09_l01_c10_cena01_geracao_corrupcao

 (Final filename on disk: aristoteles_09_l01_c10_cena01_geracao_corrupcao.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 15 of 26 for *On Generation and Corruption*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração e a Corrupção — BOOK I, Capítulo Part 10 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Generation and Corruption*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 10, bounded by:

**Starts at:** "But we have still to explain 'combination', for that was the third of the subjects we originally proposed to discuss. Our explanation will proceed on the same method as before. We must inquire: What i"
**Ends at:** "On the contrary: anything is 'combinable' which, being readily adaptable in shape, is such as to suffer action and to act; and it is 'combinable with' another thing similarly characterized (for the 'c"
