═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_09_l01_c03_cena02_geracao_corrupcao

 (Final filename on disk: aristoteles_09_l01_c03_cena02_geracao_corrupcao.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, Part 3 (sub-cena 2 of 2).
- **Audio Position in This Work:** This is audio 5 of 26 for *On Generation and Corruption*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração e a Corrupção — BOOK I, Capítulo Part 3 (Cena 2/2)"
...
**Starts at:** "(i) Now we often divide terms into those which signify a 'this somewhat' and those which do not. And (the first form of) the distinction, which we are investigating, results from a similar division of"
**Ends at:** "So much, then, on these topics."
