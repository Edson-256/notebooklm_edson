═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_09_l01_c02_cena02_geracao_corrupcao

 (Final filename on disk: aristoteles_09_l01_c02_cena02_geracao_corrupcao.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, Part 2 (sub-cena 2 of 2).
- **Audio Position in This Work:** This is audio 3 of 26 for *On Generation and Corruption*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração e a Corrupção — BOOK I, Capítulo Part 2 (Cena 2/2)"
...
**Starts at:** "But suppose that, as the body is being divided, a minute section-a piece of sawdust, as it were-is extracted, and that in this sense-a body 'comes away' from the magnitude, evading the division. Even"
**Ends at:** "that coming-to-be cannot be 'association', at least not the kind of 'association' some philosophers assert it to be."
