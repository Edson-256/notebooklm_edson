═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_09_l02_c04_cena01_geracao_corrupcao

 (Final filename on disk: aristoteles_09_l02_c04_cena01_geracao_corrupcao.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 19 of 26 for *On Generation and Corruption*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração e a Corrupção — BOOK II, Capítulo Part 4 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Generation and Corruption*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 4, bounded by:

**Starts at:** "It has been established before' that the coming-to-be of the 'simple' bodies is reciprocal. At the same time, it is manifest, even on the evidence of perception, that they do come-to-be: for otherwise"
**Ends at:** "Let us nevertheless supplement our theory by the following speculations concerning them."
