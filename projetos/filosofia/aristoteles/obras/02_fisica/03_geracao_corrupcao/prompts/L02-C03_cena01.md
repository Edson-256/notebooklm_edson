═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_09_l02_c03_cena01_geracao_corrupcao

 (Final filename on disk: aristoteles_09_l02_c03_cena01_geracao_corrupcao.m4a)
═══════════════════════════════════════════════════════════════════════════════

Act as a Senior Humanities Tutor specializing in the formative reading of Aristotle. Your goal is to write a detailed, highly pedagogical study guide (Guia de Estudos) to accompany and support the listener of the deep-dive audio overview of a specific passage from Aristotle's *On Generation and Corruption*.

**Context & Anchoring:**
- **Work:** On Generation and Corruption (Sobre a Geração e a Corrupção), translated by Joachim.
- **Passage Identifier:** BOOK II, Part 3 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 18 of 26 for *On Generation and Corruption*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração e a Corrupção — BOOK II, Capítulo Part 3 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Generation and Corruption*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 3, bounded by:

**Starts at:** "The elementary qualities are four, and any four terms can be combined in six couples. Contraries, however, refuse to be coupled: for it is impossible for the same thing to be hot and cold, or moist an"
**Ends at:** "Nevertheless, since they are four, each of them is characterized par excellence a single quality: Earth by dry rather than by cold, Water by cold rather than by moist, Air by moist rather than by hot,"
