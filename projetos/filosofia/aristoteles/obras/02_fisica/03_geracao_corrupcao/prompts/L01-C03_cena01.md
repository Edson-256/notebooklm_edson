═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_09_l01_c03_cena01_geracao_corrupcao

 (Final filename on disk: aristoteles_09_l01_c03_cena01_geracao_corrupcao.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, Part 3 (sub-cena 1 of 2).
- **Audio Position in This Work:** This is audio 4 of 26 for *On Generation and Corruption*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração e a Corrupção — BOOK I, Capítulo Part 3 (Cena 1/2)"
...
The sources uploaded to NotebookLM contain the full text of *On Generation and Corruption*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 3, bounded by:

**Starts at:** "Now that we have established the preceding distinctions, we must first consider whether there is anything which comes-to-be and passes-away in the unqualified sense: or whether nothing comes-to-be in"
**Ends at:** "And (ii) so-and-so 'comes-to-be-something', but does not 'come-to-be' without qualification; for we say that the student 'comes-to-be-learned', not 'comes-to-be' without qualification."
