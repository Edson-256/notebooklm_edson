═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_33_l01_c05_cena01_poetica

 (Final filename on disk: aristoteles_33_l01_c05_cena01_poetica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 1, Part V (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 5 of 26 for *Poetics*.
...
1. **Título Principal:** "Guia de Estudos: Poética — SECTION 1, Capítulo Part V (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Poetics*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 1, Part V, bounded by:

**Starts at:** "Comedy is, as we have said, an imitation of characters of a lower type- not, however, in the full sense of the word bad, the ludicrous being merely a subdivision of the ugly. It consists in some defec"
**Ends at:** "All the elements of an Epic poem are found in Tragedy, but the elements of a Tragedy are not all found in the Epic poem."
