═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_33_l01_c03_cena01_poetica

 (Final filename on disk: aristoteles_33_l01_c03_cena01_poetica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 1, Part III (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 3 of 26 for *Poetics*.
...
1. **Título Principal:** "Guia de Estudos: Poética — SECTION 1, Capítulo Part III (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Poetics*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 1, Part III, bounded by:

**Starts at:** "There is still a third difference- the manner in which each of these objects may be imitated. For the medium being the same, and the objects the same, the poet may imitate by narration- in which case"
**Ends at:** "This may suffice as to the number and nature of the various modes of imitation."
