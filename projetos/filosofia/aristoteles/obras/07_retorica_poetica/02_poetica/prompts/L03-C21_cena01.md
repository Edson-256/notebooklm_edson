═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_33_l03_c21_cena01_poetica

 (Final filename on disk: aristoteles_33_l03_c21_cena01_poetica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 3, Part XXI (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 21 of 26 for *Poetics*.
...
1. **Título Principal:** "Guia de Estudos: Poética — SECTION 3, Capítulo Part XXI (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Poetics*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 3, Part XXI, bounded by:

**Starts at:** "Words are of two kinds, simple and double."
**Ends at:** "Neuter nouns end in these two latter vowels; also in N and S."
