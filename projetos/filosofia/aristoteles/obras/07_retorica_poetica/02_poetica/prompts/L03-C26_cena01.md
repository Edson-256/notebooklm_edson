═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_33_l03_c26_cena01_poetica

 (Final filename on disk: aristoteles_33_l03_c26_cena01_poetica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 3, Part XXVI (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 26 of 26 for *Poetics*.
...
1. **Título Principal:** "Guia de Estudos: Poética — SECTION 3, Capítulo Part XXVI (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Poetics*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 3, Part XXVI, bounded by:

**Starts at:** "The question may be raised whether the Epic or Tragic mode of imitation is the higher. If the more refined art is the higher, and the more refined in every case is that which appeals to the better sor"
**Ends at:** "ulfills its specific function better as an art- for each art ought to produce, not any chance pleasure, but the pleasure proper to it, as already stated- it plainly follows that tragedy is the higher "
