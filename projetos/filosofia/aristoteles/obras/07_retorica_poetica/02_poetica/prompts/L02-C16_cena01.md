═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_33_l02_c16_cena01_poetica

 (Final filename on disk: aristoteles_33_l02_c16_cena01_poetica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 2, Part XVI (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 16 of 26 for *Poetics*.
...
1. **Título Principal:** "Guia de Estudos: Poética — SECTION 2, Capítulo Part XVI (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Poetics*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 2, Part XVI, bounded by:

**Starts at:** "What Recognition is has been already explained."
**Ends at:** "Next come the recognitions by process of reasoning."
