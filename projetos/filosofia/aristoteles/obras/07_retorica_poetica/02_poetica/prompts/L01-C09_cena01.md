═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_33_l01_c09_cena01_poetica

 (Final filename on disk: aristoteles_33_l01_c09_cena01_poetica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 1, Part IX (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 9 of 26 for *Poetics*.
...
1. **Título Principal:** "Guia de Estudos: Poética — SECTION 1, Capítulo Part IX (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Poetics*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 1, Part IX, bounded by:

**Starts at:** "It is, moreover, evident from what has been said, that it is not the function of the poet to relate what has happened, but what may happen- what is possible according to the law of probability or nece"
**Ends at:** "Plots, therefore, constructed on these principles are necessarily the best."
