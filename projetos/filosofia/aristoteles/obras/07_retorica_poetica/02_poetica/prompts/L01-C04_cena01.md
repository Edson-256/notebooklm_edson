═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_33_l01_c04_cena01_poetica

 (Final filename on disk: aristoteles_33_l01_c04_cena01_poetica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 1, Part IV (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 4 of 26 for *Poetics*.
...
1. **Título Principal:** "Guia de Estudos: Poética — SECTION 1, Capítulo Part IV (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Poetics*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 1, Part IV, bounded by:

**Starts at:** "Poetry in general seems to have sprung from two causes, each of them lying deep in our nature. First, the instinct of imitation is implanted in man from childhood, one difference between him and other"
**Ends at:** "The additions to the number of 'episodes' or acts, and the other accessories of which tradition tells, must be taken as already described; for to discuss them in detail would, doubtless, be a large un"
