═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_33_l02_c15_cena01_poetica

 (Final filename on disk: aristoteles_33_l02_c15_cena01_poetica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 2, Part XV (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 15 of 26 for *Poetics*.
...
1. **Título Principal:** "Guia de Estudos: Poética — SECTION 2, Capítulo Part XV (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Poetics*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 2, Part XV, bounded by:

**Starts at:** "In respect of Character there are four things to be aimed at."
**Ends at:** "But of this enough has been said in our published treatises."
