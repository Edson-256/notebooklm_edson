═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_33_l02_c19_cena01_poetica

 (Final filename on disk: aristoteles_33_l02_c19_cena01_poetica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 2, Part XIX (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 19 of 26 for *Poetics*.
...
1. **Título Principal:** "Guia de Estudos: Poética — SECTION 2, Capítulo Part XIX (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Poetics*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 2, Part XIX, bounded by:

**Starts at:** "It remains to speak of Diction and Thought, the other parts of Tragedy having been already discussed. concerning Thought, we may assume what is said in the Rhetoric, to which inquiry the subject more"
**Ends at:** "We may, therefore, pass this over as an inquiry that belongs to another art, not to poetry."
