═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_33_l03_c24_cena01_poetica

 (Final filename on disk: aristoteles_33_l03_c24_cena01_poetica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 3, Part XXIV (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 24 of 26 for *Poetics*.
...
1. **Título Principal:** "Guia de Estudos: Poética — SECTION 3, Capítulo Part XXIV (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Poetics*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 3, Part XXIV, bounded by:

**Starts at:** "Again, Epic poetry must have as many kinds as Tragedy: it must be simple, or complex, or 'ethical,'or 'pathetic.' The parts also, with the exception of song and spectacle, are the same; for it require"
**Ends at:** "The diction should be elaborated in the pauses of the action, where there is no expression of character or thought."
