═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_33_l02_c20_cena01_poetica

 (Final filename on disk: aristoteles_33_l02_c20_cena01_poetica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 2, Part XX (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 20 of 26 for *Poetics*.
...
1. **Título Principal:** "Guia de Estudos: Poética — SECTION 2, Capítulo Part XX (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Poetics*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 2, Part XX, bounded by:

**Starts at:** "Language in general includes the following parts: Letter, Syllable, Connecting Word, Noun, Verb, Inflection or Case, Sentence or Phrase. A Letter is an indivisible sound, yet not every such sound, bu"
**Ends at:** "Thus the Iliad is one by the linking together of parts, the definition of man by the unity of the thing signified."
