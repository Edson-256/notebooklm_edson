═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_33_l02_c12_cena01_poetica

 (Final filename on disk: aristoteles_33_l02_c12_cena01_poetica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 2, Part XII (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 12 of 26 for *Poetics*.
...
1. **Título Principal:** "Guia de Estudos: Poética — SECTION 2, Capítulo Part XII (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Poetics*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 2, Part XII, bounded by:

**Starts at:** "The parts of Tragedy which must be treated as elements of the whole have been already mentioned. We now come to the quantitative parts- the separate parts into which Tragedy is divided- namely, Prolog"
**Ends at:** "The quantitative parts- the separate parts into which it is divided- are here enumerated."
