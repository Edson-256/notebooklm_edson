═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_33_l01_c01_cena01_poetica

 (Final filename on disk: aristoteles_33_l01_c01_cena01_poetica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 1, Part I (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 1 of 26 for *Poetics*.
...
1. **Título Principal:** "Guia de Estudos: Poética — SECTION 1, Capítulo Part I (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Poetics*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 1, Part I, bounded by:

**Starts at:** "I propose to treat of Poetry in itself and of its various kinds, noting the essential quality of each, to inquire into the structure of the plot as requisite to a good poem; into the number and nature"
**Ends at:** "Such are Dithyrambic and Nomic poetry, and also Tragedy and Comedy; but between them originally the difference is, that in the first two cases these means are all employed in combination, in the latte"
