═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_33_l03_c22_cena01_poetica

 (Final filename on disk: aristoteles_33_l03_c22_cena01_poetica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 3, Part XXII (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 22 of 26 for *Poetics*.
...
1. **Título Principal:** "Guia de Estudos: Poética — SECTION 3, Capítulo Part XXII (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Poetics*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 3, Part XXII, bounded by:

**Starts at:** "The perfection of style is to be clear without being mean."
**Ends at:** "Concerning Tragedy and imitation by means of action this may suffice."
