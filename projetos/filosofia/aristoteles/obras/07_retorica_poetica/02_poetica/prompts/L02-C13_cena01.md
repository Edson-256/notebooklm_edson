═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_33_l02_c13_cena01_poetica

 (Final filename on disk: aristoteles_33_l02_c13_cena01_poetica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 2, Part XIII (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 13 of 26 for *Poetics*.
...
1. **Título Principal:** "Guia de Estudos: Poética — SECTION 2, Capítulo Part XIII (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Poetics*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 2, Part XIII, bounded by:

**Starts at:** "As the sequel to what has already been said, we must proceed to consider what the poet should aim at, and what he should avoid, in constructing his plots; and by what means the specific effect of Trag"
**Ends at:** "It is proper rather to Comedy, where those who, in the piece, are the deadliest enemies- like Orestes and Aegisthus- quit the stage as friends at the close, and no one slays or is slain."
