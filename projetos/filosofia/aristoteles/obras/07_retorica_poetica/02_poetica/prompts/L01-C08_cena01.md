═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_33_l01_c08_cena01_poetica

 (Final filename on disk: aristoteles_33_l01_c08_cena01_poetica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 1, Part VIII (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 8 of 26 for *Poetics*.
...
1. **Título Principal:** "Guia de Estudos: Poética — SECTION 1, Capítulo Part VIII (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Poetics*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 1, Part VIII, bounded by:

**Starts at:** "Unity of plot does not, as some persons think, consist in the unity of the hero. For infinitely various are the incidents in one man's life which cannot be reduced to unity; and so, too, there are man"
**Ends at:** "For a thing whose presence or absence makes no visible difference, is not an organic part of the whole."
