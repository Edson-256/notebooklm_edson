═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_32_l03_c05_cena01_retorica

 (Final filename on disk: aristoteles_32_l03_c05_cena01_retorica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 54 of 68 for *Rhetoric*.
...
1. **Título Principal:** "Guia de Estudos: Retórica — BOOK III, Capítulo Part 5 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Rhetoric*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, Part 5, bounded by:

**Starts at:** "Such, then, are the ingredients of which speech is composed."
**Ends at:** "Thus either 'sound' or 'colour' will fail to work out properly with some verbs: 'perceive' will apply to both, 'see' will not."
