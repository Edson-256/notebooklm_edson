═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_32_l01_c10_cena01_retorica

 (Final filename on disk: aristoteles_32_l01_c10_cena01_retorica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 15 of 68 for *Rhetoric*.
...
1. **Título Principal:** "Guia de Estudos: Retórica — BOOK I, Capítulo Part 10 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Rhetoric*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 10, bounded by:

**Starts at:** "We have next to treat of Accusation and Defence, and to enumerate and describe the ingredients of the syllogisms used therein. There are three things we must ascertain first, the nature and number of"
**Ends at:** "Our various definitions must be regarded as adequate, even if they are not exact, provided they are clear."
