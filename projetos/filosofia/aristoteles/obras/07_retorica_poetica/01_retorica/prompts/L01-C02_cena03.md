═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_32_l01_c02_cena03_retorica

 (Final filename on disk: aristoteles_32_l01_c02_cena03_retorica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, Part 2 (sub-cena 3 of 3).
- **Audio Position in This Work:** This is audio 4 of 68 for *Rhetoric*.
...
1. **Título Principal:** "Guia de Estudos: Retórica — BOOK I, Capítulo Part 2 (Cena 3/3)"
...
**Starts at:** "There is an important distinction between two sorts of enthymemes that has been wholly overlooked by almost everybody-one that also subsists between the syllogisms treated of in dialectic. One sort of"
**Ends at:** "Having distinguished these we may deal with them one by one, and try to discover the elements of which each is composed, and the propositions each must employ."
