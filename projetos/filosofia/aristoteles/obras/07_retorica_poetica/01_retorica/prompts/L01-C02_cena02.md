═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_32_l01_c02_cena02_retorica

 (Final filename on disk: aristoteles_32_l01_c02_cena02_retorica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, Part 2 (sub-cena 2 of 3).
- **Audio Position in This Work:** This is audio 3 of 68 for *Rhetoric*.
...
1. **Título Principal:** "Guia de Estudos: Retórica — BOOK I, Capítulo Part 2 (Cena 2/3)"
...
**Starts at:** "The enthymeme and the example must, then, deal with what is in the main contingent, the example being an induction, and the enthymeme a syllogism, about such matters. The enthymeme must consist of few"
**Ends at:** "We have now described the sources of those means of persuasion which are popularly supposed to be demonstrative."
