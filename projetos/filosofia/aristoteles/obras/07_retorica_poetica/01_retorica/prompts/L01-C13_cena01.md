═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_32_l01_c13_cena01_retorica

 (Final filename on disk: aristoteles_32_l01_c13_cena01_retorica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 18 of 68 for *Rhetoric*.
...
1. **Título Principal:** "Guia de Estudos: Retórica — BOOK I, Capítulo Part 13 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Rhetoric*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 13, bounded by:

**Starts at:** "It will now be well to make a complete classification of just and unjust actions. We may begin by observing that they have been defined relatively to two kinds of law, and also relatively to two class"
**Ends at:** "The above may be taken as a sufficient account of the nature of equity."
