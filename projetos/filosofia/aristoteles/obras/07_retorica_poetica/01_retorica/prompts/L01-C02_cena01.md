═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_32_l01_c02_cena01_retorica

 (Final filename on disk: aristoteles_32_l01_c02_cena01_retorica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, Part 2 (sub-cena 1 of 3).
- **Audio Position in This Work:** This is audio 2 of 68 for *Rhetoric*.
...
1. **Título Principal:** "Guia de Estudos: Retórica — BOOK I, Capítulo Part 2 (Cena 1/3)"
...
The sources uploaded to NotebookLM contain the full text of *Rhetoric*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 2, bounded by:

**Starts at:** "Rhetoric may be defined as the faculty of observing in any given case the available means of persuasion. This is not a function of any other art. Every other art can instruct or persuade about its own"
**Ends at:** "Reasonings of the former kind will necessarily be hard to follow owing to their length, for we assume an audience of untrained thinkers; those of the latter kind will fail to win assent, because they "
