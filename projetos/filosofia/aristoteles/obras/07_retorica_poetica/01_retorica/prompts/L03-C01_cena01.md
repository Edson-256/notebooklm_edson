═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_32_l03_c01_cena01_retorica

 (Final filename on disk: aristoteles_32_l03_c01_cena01_retorica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 50 of 68 for *Rhetoric*.
...
1. **Título Principal:** "Guia de Estudos: Retórica — BOOK III, Capítulo Part 1 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Rhetoric*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, Part 1, bounded by:

**Starts at:** "In making a speech one must study three points: first, the means of producing persuasion; second, the style, or language, to be used; third, the proper arrangement of the various parts of the speech."
**Ends at:** "The other--the poetical--part of it has been discussed in the treatise on the Art of Poetry."
