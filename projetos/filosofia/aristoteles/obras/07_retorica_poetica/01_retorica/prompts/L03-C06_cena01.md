═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_32_l03_c06_cena01_retorica

 (Final filename on disk: aristoteles_32_l03_c06_cena01_retorica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 55 of 68 for *Rhetoric*.
...
1. **Título Principal:** "Guia de Estudos: Retórica — BOOK III, Capítulo Part 6 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Rhetoric*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, Part 6, bounded by:

**Starts at:** "The following suggestions will help to give your language impressiveness."
**Ends at:** "This device is popular in proportional metaphors, as when the trumpet's note is called 'a lyreless melody'."
