═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_32_l03_c11_cena01_retorica

 (Final filename on disk: aristoteles_32_l03_c11_cena01_retorica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 60 of 68 for *Rhetoric*.
...
1. **Título Principal:** "Guia de Estudos: Retórica — BOOK III, Capítulo Part 11 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Rhetoric*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, Part 11, bounded by:

**Starts at:** "It has already been mentioned that liveliness is got by using the proportional type of metaphor and being making (ie. making your hearers see things). We have still to explain what we mean by their 's"
**Ends at:** ") Consequently it does not suit an elderly speaker."
