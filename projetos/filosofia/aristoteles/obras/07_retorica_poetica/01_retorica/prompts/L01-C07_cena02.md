═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_32_l01_c07_cena02_retorica

 (Final filename on disk: aristoteles_32_l01_c07_cena02_retorica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, Part 7 (sub-cena 2 of 3).
- **Audio Position in This Work:** This is audio 10 of 68 for *Rhetoric*.
...
1. **Título Principal:** "Guia de Estudos: Retórica — BOOK I, Capítulo Part 7 (Cena 2/3)"
...
**Starts at:** "More generally: the hard thing is better than the easy, because it is rarer: and reversely, the easy thing is better than the hard, for it is as we wish it to be. That is the greater good whose contra"
**Ends at:** "Hence the words of Homer: \"I have learnt from none but mysell."
