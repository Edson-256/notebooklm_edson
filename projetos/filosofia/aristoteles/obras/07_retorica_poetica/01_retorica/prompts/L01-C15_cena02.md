═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_32_l01_c15_cena02_retorica

 (Final filename on disk: aristoteles_32_l01_c15_cena02_retorica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, Part 15 (sub-cena 2 of 2).
- **Audio Position in This Work:** This is audio 21 of 68 for *Rhetoric*.
...
1. **Título Principal:** "Guia de Estudos: Retórica — BOOK I, Capítulo Part 15 (Cena 2/2)"
...
**Starts at:** "Concerning contracts argument can be so far employed as to increase or diminish their importance and their credibility; we shall try to increase both if they tell in our favour, and to diminish both i"
**Ends at:** "' And there are other arguments which may be used to magnify the importance of the oath."
