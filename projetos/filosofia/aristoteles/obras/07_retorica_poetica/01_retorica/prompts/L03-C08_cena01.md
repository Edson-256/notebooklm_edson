═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_32_l03_c08_cena01_retorica

 (Final filename on disk: aristoteles_32_l03_c08_cena01_retorica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 57 of 68 for *Rhetoric*.
...
1. **Título Principal:** "Guia de Estudos: Retórica — BOOK III, Capítulo Part 8 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Rhetoric*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, Part 8, bounded by:

**Starts at:** "The form of a prose composition should be neither metrical nor destitute of rhythm. The metrical form destroys the hearer's trust by its artificial appearance, and at the same time it diverts his atte"
**Ends at:** "We have now seen that our language must be rhythmical and not destitute of rhythm, and what rhythms, in what particular shape, make it so."
