═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_32_l01_c07_cena01_retorica

 (Final filename on disk: aristoteles_32_l01_c07_cena01_retorica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, Part 7 (sub-cena 1 of 3).
- **Audio Position in This Work:** This is audio 9 of 68 for *Rhetoric*.
...
1. **Título Principal:** "Guia de Estudos: Retórica — BOOK I, Capítulo Part 7 (Cena 1/3)"
...
**Starts at:** "Since, however, it often happens that people agree that two things are both useful but do not agree about which is the more so, the next step will be to treat of relative goodness and relative utility"
**Ends at:** "For what is often useful surpasses what is seldom useful, whence the saying: \"The best of things is water."
