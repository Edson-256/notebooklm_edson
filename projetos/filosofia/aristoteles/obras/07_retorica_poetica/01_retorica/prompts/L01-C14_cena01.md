═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_32_l01_c14_cena01_retorica

 (Final filename on disk: aristoteles_32_l01_c14_cena01_retorica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 19 of 68 for *Rhetoric*.
...
1. **Título Principal:** "Guia de Estudos: Retórica — BOOK I, Capítulo Part 14 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Rhetoric*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 14, bounded by:

**Starts at:** "The worse of two acts of wrong done to others is that which is prompted by the worse disposition. Hence the most trifling acts may be the worst ones; as when Callistratus charged Melanopus with having"
**Ends at:** "-So much, then, for the comparative badness of criminal actions."
