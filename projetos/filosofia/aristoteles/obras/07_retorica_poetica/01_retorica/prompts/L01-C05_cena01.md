═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_32_l01_c05_cena01_retorica

 (Final filename on disk: aristoteles_32_l01_c05_cena01_retorica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 7 of 68 for *Rhetoric*.
...
1. **Título Principal:** "Guia de Estudos: Retórica — BOOK I, Capítulo Part 5 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Rhetoric*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 5, bounded by:

**Starts at:** "It may be said that every individual man and all men in common aim at a certain end which determines what they choose and what they avoid. This end, to sum it up briefly, is happiness and its constitu"
**Ends at:** "As to virtue, it is most closely connected with the subject of Eulogy, and therefore we will wait to define it until we come to discuss that subject."
