═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_32_l01_c06_cena01_retorica

 (Final filename on disk: aristoteles_32_l01_c06_cena01_retorica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 8 of 68 for *Rhetoric*.
...
1. **Título Principal:** "Guia de Estudos: Retórica — BOOK I, Capítulo Part 6 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Rhetoric*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 6, bounded by:

**Starts at:** "It is now plain what our aims, future or actual, should be in urging, and what in depreciating, a proposal; the latter being the opposite of the former. Now the political or deliberative orator's aim"
**Ends at:** "These, then, are the sources from which we must derive our means of persuasion about Good and Utility."
