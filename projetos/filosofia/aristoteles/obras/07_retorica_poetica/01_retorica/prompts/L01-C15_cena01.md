═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_32_l01_c15_cena01_retorica

 (Final filename on disk: aristoteles_32_l01_c15_cena01_retorica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, Part 15 (sub-cena 1 of 2).
- **Audio Position in This Work:** This is audio 20 of 68 for *Rhetoric*.
...
1. **Título Principal:** "Guia de Estudos: Retórica — BOOK I, Capítulo Part 15 (Cena 1/2)"
...
The sources uploaded to NotebookLM contain the full text of *Rhetoric*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 15, bounded by:

**Starts at:** "There are also the so-called 'non-technical' means of persuasion; and we must now take a cursory view of these, since they are specially characteristic of forensic oratory. They are five in number: la"
**Ends at:** "Other arguments about a witness-that he is a friend or an enemy or neutral, or has a good, bad, or indifferent reputation, and any other such distinctions-we must construct upon the same general lines"
