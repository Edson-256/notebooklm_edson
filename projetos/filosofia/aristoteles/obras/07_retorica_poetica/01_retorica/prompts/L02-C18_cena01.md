═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_32_l02_c18_cena01_retorica

 (Final filename on disk: aristoteles_32_l02_c18_cena01_retorica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 39 of 68 for *Rhetoric*.
...
1. **Título Principal:** "Guia de Estudos: Retórica — BOOK II, Capítulo Part 18 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Rhetoric*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 18, bounded by:

**Starts at:** "The use of persuasive speech is to lead to decisions."
**Ends at:** "Of the above-mentioned general lines of argument, that concerned with Amplification is-as has been already said-most appropriate to ceremonial speeches; that concerned with the Past, to forensic speec"
