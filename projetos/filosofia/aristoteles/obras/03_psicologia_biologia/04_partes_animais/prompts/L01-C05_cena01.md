═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_20_l01_c05_cena01_partes_animais

 (Final filename on disk: aristoteles_20_l01_c05_cena01_partes_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, Part 5 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 8 of 62 for *On the Parts of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre as Partes dos Animais — BOOK I, Capítulo Part 5 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Parts of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 5, bounded by:

**Starts at:** "Of things constituted by nature some are ungenerated, imperishable, and eternal, while others are subject to generation and decay. The former are excellent beyond compare and divine, but less accessib"
**Ends at:** "Let us now try to set forth the causes of all vital phenomena, whether universal or particular, and in so doing let us follow that order of exposition which conforms, as we have indicated, to the orde"
