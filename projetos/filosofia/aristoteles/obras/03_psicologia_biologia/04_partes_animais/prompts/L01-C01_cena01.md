═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_20_l01_c01_cena01_partes_animais

 (Final filename on disk: aristoteles_20_l01_c01_cena01_partes_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, Part 1 (sub-cena 1 of 4).
- **Audio Position in This Work:** This is audio 1 of 62 for *On the Parts of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre as Partes dos Animais — BOOK I, Capítulo Part 1 (Cena 1/4)"
...
**Starts at:** "Every systematic science, the humblest and the noblest alike, seems to admit of two distinct kinds of proficiency; one of which may be properly called scientific knowledge of the subject, while the ot"
**Ends at:** "There too it was stated in what cases absolute and hypothetical necessity exist; in what cases also the proposition expressing hypothetical necessity is simply convertible, and what cause it is that d"
