═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_20_l03_c02_cena01_partes_animais

 (Final filename on disk: aristoteles_20_l03_c02_cena01_partes_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 27 of 62 for *On the Parts of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre as Partes dos Animais — BOOK III, Capítulo Part 2 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Parts of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, Part 2, bounded by:

**Starts at:** "We have now to treat of horns; for these also, when present, are appendages of the head. They exist in none but viviparous animals; though in some ovipara certain parts are metaphorically spoken of as"
**Ends at:** "So much, then, of the parts which appertain to the head."
