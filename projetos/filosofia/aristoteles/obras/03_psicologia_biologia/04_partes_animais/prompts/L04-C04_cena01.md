═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_20_l04_c04_cena01_partes_animais

 (Final filename on disk: aristoteles_20_l04_c04_cena01_partes_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IV, Part 4 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 45 of 62 for *On the Parts of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre as Partes dos Animais — BOOK IV, Capítulo Part 4 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Parts of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IV, Part 4, bounded by:

**Starts at:** "The so-called mesentery is also a membrane; and extends continuously from the long stretch of intestine to the great vessel and the aorta. In it are numerous and close-packed vessels, which run from t"
**Ends at:** "But, inasmuch as we shall have to deal specially with generation hereafter, it will be more convenient to defer the consideration of these parts to that occasion."
