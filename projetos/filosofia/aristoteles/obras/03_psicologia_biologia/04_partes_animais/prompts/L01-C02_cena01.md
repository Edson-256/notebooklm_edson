═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_20_l01_c02_cena01_partes_animais

 (Final filename on disk: aristoteles_20_l01_c02_cena01_partes_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, Part 2 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 5 of 62 for *On the Parts of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre as Partes dos Animais — BOOK I, Capítulo Part 2 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Parts of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 2, bounded by:

**Starts at:** "Some writers propose to reach the definitions of the ultimate forms of animal life by bipartite division. But this method is often difficult, and often impracticable. Sometimes the final differentia"
**Ends at:** "The group of the Many-footed, for instance, would, under this method, have to be dismembered, and some of its kinds distributed among land animals, others among water animals."
