═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_20_l04_c05_cena01_partes_animais

 (Final filename on disk: aristoteles_20_l04_c05_cena01_partes_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IV, Part 5 (sub-cena 1 of 4).
- **Audio Position in This Work:** This is audio 46 of 62 for *On the Parts of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre as Partes dos Animais — BOOK IV, Capítulo Part 5 (Cena 1/4)"
...
**Starts at:** "Very different from the animals we have as yet considered are the Cephalopoda and the Crustacea. For these have absolutely no viscera whatsoever; as is indeed the case with all bloodless animals, in w"
**Ends at:** "From the stomach a uniform gut runs in a direct line to the excremental vent."
