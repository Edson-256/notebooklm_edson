═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_20_l04_c14_cena01_partes_animais

 (Final filename on disk: aristoteles_20_l04_c14_cena01_partes_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 62 of 62 for *On the Parts of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre as Partes dos Animais — BOOK IV, Capítulo Part 14 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Parts of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IV, Part 14, bounded by:

**Starts at:** "Much the same may be said also of the Libyan ostrich."
**Ends at:** "We must now pass on, and in due sequence must next deal with the question of their generation."
