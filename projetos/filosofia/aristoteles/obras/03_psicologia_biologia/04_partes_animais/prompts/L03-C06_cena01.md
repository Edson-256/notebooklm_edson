═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_20_l03_c06_cena01_partes_animais

 (Final filename on disk: aristoteles_20_l03_c06_cena01_partes_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK III, Part 6 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 32 of 62 for *On the Parts of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre as Partes dos Animais — BOOK III, Capítulo Part 6 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Parts of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, Part 6, bounded by:

**Starts at:** "The lung, then, is an organ found in all the animals of a certain class, because they live on land. For there must of necessity be some means or other of tempering the heat of the body; and in sanguin"
**Ends at:** "Yet the possession of a lung is a part of their essence, just as much as the presence of certain characters constitutes the essence of a bird."
