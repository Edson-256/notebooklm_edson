═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_20_l02_c09_cena01_partes_animais

 (Final filename on disk: aristoteles_20_l02_c09_cena01_partes_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, Part 9 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 17 of 62 for *On the Parts of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre as Partes dos Animais — BOOK II, Capítulo Part 9 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Parts of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 9, bounded by:

**Starts at:** "There is a resemblance between the osseous and the vascular systems; for each has a central part in which it begins, and each forms a continuous whole. For no bone in the body exists as a separate thi"
**Ends at:** "For the treatise on Generation will afford a more suitable place for their examination, seeing that the former of the two is the very foundation of the thing generated, while the latter is its nourish"
