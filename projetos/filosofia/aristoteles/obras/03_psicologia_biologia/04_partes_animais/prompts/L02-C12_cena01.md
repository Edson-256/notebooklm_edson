═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_20_l02_c12_cena01_partes_animais

 (Final filename on disk: aristoteles_20_l02_c12_cena01_partes_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 20 of 62 for *On the Parts of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre as Partes dos Animais — BOOK II, Capítulo Part 12 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Parts of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 12, bounded by:

**Starts at:** "In birds, on the other hand, there are no ears, but only the auditory passages. This is because their skin is hard and because they have feathers instead of hairs, so that they have not got the proper"
**Ends at:** "The explanation of this is that the seal, though a quadruped, is a quadruped of stunted formation."
