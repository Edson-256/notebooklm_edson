═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_20_l03_c03_cena01_partes_animais

 (Final filename on disk: aristoteles_20_l03_c03_cena01_partes_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 28 of 62 for *On the Parts of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre as Partes dos Animais — BOOK III, Capítulo Part 3 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Parts of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, Part 3, bounded by:

**Starts at:** "Below the head lies the neck, in such animals as have one."
**Ends at:** "And it is a universal law that, as regards above and below, front and back, right and left, the nobler and more honourable part invariably is placed uppermost, in front, and on the right, rather than "
