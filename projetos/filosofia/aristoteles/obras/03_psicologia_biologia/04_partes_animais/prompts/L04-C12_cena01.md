═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_20_l04_c12_cena01_partes_animais

 (Final filename on disk: aristoteles_20_l04_c12_cena01_partes_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IV, Part 12 (sub-cena 1 of 2).
- **Audio Position in This Work:** This is audio 59 of 62 for *On the Parts of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre as Partes dos Animais — BOOK IV, Capítulo Part 12 (Cena 1/2)"
...
The sources uploaded to NotebookLM contain the full text of *On the Parts of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IV, Part 12, bounded by:

**Starts at:** "The differences of birds compared one with another are differences of magnitude, and of the greater or smaller development of parts. Thus some have long legs, others short legs; some have a broad tong"
**Ends at:** "For the character of their claws is ill-suited for either action."
