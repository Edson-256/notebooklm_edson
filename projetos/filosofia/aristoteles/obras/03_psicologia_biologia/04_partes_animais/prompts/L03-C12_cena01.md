═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_20_l03_c12_cena01_partes_animais

 (Final filename on disk: aristoteles_20_l03_c12_cena01_partes_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 38 of 62 for *On the Parts of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre as Partes dos Animais — BOOK III, Capítulo Part 12 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Parts of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, Part 12, bounded by:

**Starts at:** "Some animals have all the viscera that have been enumerated; others have only some of them. In what kind of animals this latter is the case, and what is the explanation, has already been stated. Moreo"
**Ends at:** "Such, for example, is its shape in the horse, the mule, and the ass."
