═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_20_l01_c01_cena02_partes_animais

 (Final filename on disk: aristoteles_20_l01_c01_cena02_partes_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, Part 1 (sub-cena 2 of 4).
- **Audio Position in This Work:** This is audio 2 of 62 for *On the Parts of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre as Partes dos Animais — BOOK I, Capítulo Part 1 (Cena 2/4)"
...
**Starts at:** "Another matter which must not be passed over without consideration is, whether the proper subject of our exposition is that with which the ancient writers concerned themselves, namely, what is the pro"
**Ends at:** "It is plain, then, that the teaching of the old physiologists is inadequate, and that the true method is to state what the definitive characters are that distinguish the animal as a whole; to explain "
