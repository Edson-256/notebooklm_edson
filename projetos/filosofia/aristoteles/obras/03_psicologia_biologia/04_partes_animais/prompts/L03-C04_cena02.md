═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_20_l03_c04_cena02_partes_animais

 (Final filename on disk: aristoteles_20_l03_c04_cena02_partes_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK III, Part 4 (sub-cena 2 of 2).
- **Audio Position in This Work:** This is audio 30 of 62 for *On the Parts of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre as Partes dos Animais — BOOK III, Capítulo Part 4 (Cena 2/2)"
...
**Starts at:** "The apex of the heart is pointed and more solid than the rest of the organ. It lies against the breast, and entirely in the anterior part of the body, in order to prevent that region from getting chil"
**Ends at:** "Thus much of the heart, its nature, and the end and cause of its existence in such animals as have it."
