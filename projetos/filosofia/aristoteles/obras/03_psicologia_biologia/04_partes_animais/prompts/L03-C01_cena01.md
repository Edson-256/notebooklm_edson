═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_20_l03_c01_cena01_partes_animais

 (Final filename on disk: aristoteles_20_l03_c01_cena01_partes_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 26 of 62 for *On the Parts of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre as Partes dos Animais — BOOK III, Capítulo Part 1 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Parts of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, Part 1, bounded by:

**Starts at:** "We have next to consider the teeth, and with these the mouth, that is the cavity which they enclose and form. The teeth have one invariable office, namely the reduction of food; but besides this gener"
**Ends at:** "For as man is the only animal that stands erect, he is also the only one that looks directly in front (proso) and the only one whose voice is emitted in that direction."
