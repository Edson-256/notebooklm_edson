═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_20_l03_c11_cena01_partes_animais

 (Final filename on disk: aristoteles_20_l03_c11_cena01_partes_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 37 of 62 for *On the Parts of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre as Partes dos Animais — BOOK III, Capítulo Part 11 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Parts of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, Part 11, bounded by:

**Starts at:** "The viscera are enclosed each in a membrane."
**Ends at:** "For these are the parts which require most protection, seeing that they are the main governing powers of life, and that it is to governing powers that guard is due."
