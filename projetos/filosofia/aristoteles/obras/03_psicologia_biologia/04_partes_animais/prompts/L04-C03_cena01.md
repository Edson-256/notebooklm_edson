═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_20_l04_c03_cena01_partes_animais

 (Final filename on disk: aristoteles_20_l04_c03_cena01_partes_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 44 of 62 for *On the Parts of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre as Partes dos Animais — BOOK IV, Capítulo Part 3 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Parts of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IV, Part 3, bounded by:

**Starts at:** "So much then of the gall-bladder, and of the reasons why some animals have one, while others have not. We have still to speak of the mesentery and the omentum; for these are associated with the parts"
**Ends at:** "Thus much as concerns the omentum."
