═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_20_l04_c01_cena01_partes_animais

 (Final filename on disk: aristoteles_20_l04_c01_cena01_partes_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IV, Part 1 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 42 of 62 for *On the Parts of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre as Partes dos Animais — BOOK IV, Capítulo Part 1 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Parts of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IV, Part 1, bounded by:

**Starts at:** "The account which has now been given of the viscera, the stomach, and the other several parts holds equally good not only for the oviparous quadrupeds, but also for such apodous animals as the Serpent"
**Ends at:** "The relative positions, moreover, of the windpipe and the oesophagus are precisely similar in them all; and the reason is the same as has already been given."
