═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_20_l01_c04_cena01_partes_animais

 (Final filename on disk: aristoteles_20_l01_c04_cena01_partes_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 7 of 62 for *On the Parts of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre as Partes dos Animais — BOOK I, Capítulo Part 4 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Parts of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 4, bounded by:

**Starts at:** "It deserves inquiry why a single name denoting a higher group was not invented by mankind, as an appellation to comprehend the two groups of Water animals and Winged animals. For even these have certa"
**Ends at:** "Having laid this foundation, let us pass on to our next topic."
