═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_20_l01_c01_cena04_partes_animais

 (Final filename on disk: aristoteles_20_l01_c01_cena04_partes_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, Part 1 (sub-cena 4 of 4).
- **Audio Position in This Work:** This is audio 4 of 62 for *On the Parts of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre as Partes dos Animais — BOOK I, Capítulo Part 1 (Cena 4/4)"
...
**Starts at:** "The reason why our predecessors failed in hitting upon this method of treatment was, that they were not in possession of the notion of essence, nor of any definition of substance. The first who came n"
**Ends at:** "In the foregoing we have an example of the method which we must adopt, and also an example of the kind of phenomena, the causes of which we have to investigate."
