═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_20_l04_c10_cena03_partes_animais

 (Final filename on disk: aristoteles_20_l04_c10_cena03_partes_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IV, Part 10 (sub-cena 3 of 4).
- **Audio Position in This Work:** This is audio 56 of 62 for *On the Parts of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre as Partes dos Animais — BOOK IV, Capítulo Part 10 (Cena 3/4)"
...
**Starts at:** "In the elephant also there are but two mammae, which are placed under the axillae of the fore limbs. The mammae are not more than two, because this animal has only a single young one at a birth; and t"
**Ends at:** "No quadruped with a solid hoof is retromingent."
