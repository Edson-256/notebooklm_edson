═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_20_l04_c08_cena01_partes_animais

 (Final filename on disk: aristoteles_20_l04_c08_cena01_partes_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IV, Part 8 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 52 of 62 for *On the Parts of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre as Partes dos Animais — BOOK IV, Capítulo Part 8 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Parts of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IV, Part 8, bounded by:

**Starts at:** "All the Crustacea can crawl as well as swim, and accordingly they are provided with numerous feet. There are four main genera, viz. the Carabi, as they are called, the Astaci, the Carides, and the Car"
**Ends at:** "For a detailed account of the several parts of these animals, of their position and their differences, those parts being also included which distinguish the sexes, reference must be made to the treati"
