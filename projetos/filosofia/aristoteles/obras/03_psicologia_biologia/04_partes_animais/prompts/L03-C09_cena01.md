═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_20_l03_c09_cena01_partes_animais

 (Final filename on disk: aristoteles_20_l03_c09_cena01_partes_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 35 of 62 for *On the Parts of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre as Partes dos Animais — BOOK III, Capítulo Part 9 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Parts of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, Part 9, bounded by:

**Starts at:** "What has been said of the bladder is equally true of the kidneys."
**Ends at:** "For the disease forthwith reaches the heart, passing thither by the aorta and the great vessel, the ducts which connect these with the kidneys being of unbroken continuity."
