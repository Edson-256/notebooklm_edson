═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_20_l04_c02_cena01_partes_animais

 (Final filename on disk: aristoteles_20_l04_c02_cena01_partes_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 43 of 62 for *On the Parts of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre as Partes dos Animais — BOOK IV, Capítulo Part 2 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Parts of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IV, Part 2, bounded by:

**Starts at:** "Almost all sanguineous animals have a gall-bladder."
**Ends at:** "For to suppose that it has one character in this part, another in that, would be as great an absurdity as to suppose mucus or the dejections of the stomach to vary in character according to locality a"
