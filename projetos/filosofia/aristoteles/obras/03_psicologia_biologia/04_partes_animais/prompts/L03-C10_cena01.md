═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_20_l03_c10_cena01_partes_animais

 (Final filename on disk: aristoteles_20_l03_c10_cena01_partes_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 36 of 62 for *On the Parts of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre as Partes dos Animais — BOOK III, Capítulo Part 10 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Parts of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, Part 10, bounded by:

**Starts at:** "We have now dealt with the heart and the lung, as also with the liver, spleen, and kidneys. The latter are separated from the former by the midriff or, as some call it, the Phrenes. This divides off t"
**Ends at:** "Thus they are of a bloody character, and in substance resemble each other while they differ from other parts."
