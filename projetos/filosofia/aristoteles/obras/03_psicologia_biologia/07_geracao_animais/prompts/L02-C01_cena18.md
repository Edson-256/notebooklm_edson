═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l02_c01_cena18_geracao_animais

 (Final filename on disk: aristoteles_23_l02_c01_cena18_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, BOOK II (sem CHAPTER) (sub-cena 18 of 54).
- **Audio Position in This Work:** This is audio 47 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK II, Capítulo BOOK II (sem CHAPTER) (Cena 18/54)"
...
**Starts at:** "If there is any class.of animal which is female and has no separate male, it is possible that this generates offspring from itself...This has not so far been reliably observed, it is true, but some"
**Ends at:** "upper part, as this is smaller to begin with."
