═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l04_c01_cena07_geracao_animais

 (Final filename on disk: aristoteles_23_l04_c01_cena07_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IV, BOOK IV (sem CHAPTER) (sub-cena 7 of 25).
- **Audio Position in This Work:** This is audio 90 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK IV, Capítulo BOOK IV (sem CHAPTER) (Cena 7/25)"
...
**Starts at:** "Also, the fact that the menstrual discharge in the natural course tends to take place when the moon is waning ° is due to the same cause. That time of month is colder and more fluid on account of t"
**Ends at:** ": A Scone # This is an instance of a necessity required by the Final Cause ; see 731 b 25—732 a 3."
