═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l02_c01_cena09_geracao_animais

 (Final filename on disk: aristoteles_23_l02_c01_cena09_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, BOOK II (sem CHAPTER) (sub-cena 9 of 54).
- **Audio Position in This Work:** This is audio 38 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK II, Capítulo BOOK II (sem CHAPTER) (Cena 9/54)"
...
**Starts at:** "We have now given the reason which solves the puzzle that was stated. And this also shows, inci- dentally, why semen does not freeze : it is because air is impervious to frost. “The next puzzle t"
**Ends at:** ", the semen) from some outside source, for it alone is not affected by thé two considerations which preclude the entry from outside of the other parts of Soul, whose activity © GENERATION OF ANIMALS, "
