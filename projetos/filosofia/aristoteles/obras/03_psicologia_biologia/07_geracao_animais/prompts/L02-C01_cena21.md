═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l02_c01_cena21_geracao_animais

 (Final filename on disk: aristoteles_23_l02_c01_cena21_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, BOOK II (sem CHAPTER) (sub-cena 21 of 54).
- **Audio Position in This Work:** This is audio 50 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK II, Capítulo BOOK II (sem CHAPTER) (Cena 21/54)"
...
**Starts at:** "GENERATION OF ANIMALS, II."
**Ends at:** "Heat and cooling (which is deprivation of heat) are both employed by Nature."
