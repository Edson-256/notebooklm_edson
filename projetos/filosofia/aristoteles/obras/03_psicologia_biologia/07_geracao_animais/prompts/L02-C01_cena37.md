═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l02_c01_cena37_geracao_animais

 (Final filename on disk: aristoteles_23_l02_c01_cena37_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, BOOK II (sem CHAPTER) (sub-cena 37 of 54).
- **Audio Position in This Work:** This is audio 66 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK II, Capítulo BOOK II (sem CHAPTER) (Cena 37/54)"
...
**Starts at:** "eggs quicker when the days are sunny, for then the climate takes a share in the work, concoction being a form of heat: the earth helps‘in concocting them with its heat, and the sitting bird does ex"
**Ends at:** "‘s ‘ — GENERATION OF ANIMALS, III."
