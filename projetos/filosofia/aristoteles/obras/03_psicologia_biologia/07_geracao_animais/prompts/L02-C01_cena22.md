═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l02_c01_cena22_geracao_animais

 (Final filename on disk: aristoteles_23_l02_c01_cena22_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, BOOK II (sem CHAPTER) (sub-cena 22 of 54).
- **Audio Position in This Work:** This is audio 51 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK II, Capítulo BOOK II (sem CHAPTER) (Cena 22/54)"
...
**Starts at:** ": din necessity, of making one thing into this and another thing into that ; but in ‘the case of the forming of the embryo it is for a purpose that their power of heating and cooling is exerted and"
**Ends at:** "® These are no doubt the optic nerves."
