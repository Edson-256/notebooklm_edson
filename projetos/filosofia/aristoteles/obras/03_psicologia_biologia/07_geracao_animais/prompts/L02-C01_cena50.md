═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l02_c01_cena50_geracao_animais

 (Final filename on disk: aristoteles_23_l02_c01_cena50_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, BOOK II (sem CHAPTER) (sub-cena 50 of 54).
- **Audio Position in This Work:** This is audio 79 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK II, Capítulo BOOK II (sem CHAPTER) (Cena 50/54)"
...
**Starts at:** "TPOPtHov irrov dé owparddes Kal puxpov eoTw."
**Ends at:** "N 353 ARISTOTLE «© |” 761 b > , A ‘ ’ Ares 44 THY apyyv."
