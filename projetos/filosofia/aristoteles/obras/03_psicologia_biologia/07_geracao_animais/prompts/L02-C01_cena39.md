═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l02_c01_cena39_geracao_animais

 (Final filename on disk: aristoteles_23_l02_c01_cena39_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, BOOK II (sem CHAPTER) (sub-cena 39 of 54).
- **Audio Position in This Work:** This is audio 68 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK II, Capítulo BOOK II (sem CHAPTER) (Cena 39/54)"
...
**Starts at:** "The process of generation out of the egg is the same Develop- both forthe fishing-frogs, which are perfected exter- Wept ™° nally, and, for, those Selachia. which are perfected - internally ; and a"
**Ends at:** "und der Technik, 10 (1927), 166-184."
