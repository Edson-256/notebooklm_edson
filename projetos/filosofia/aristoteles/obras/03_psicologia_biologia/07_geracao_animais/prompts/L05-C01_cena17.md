═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l05_c01_cena17_geracao_animais

 (Final filename on disk: aristoteles_23_l05_c01_cena17_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK V, BOOK V (sem CHAPTER) (sub-cena 17 of 32).
- **Audio Position in This Work:** This is audio 125 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK V, Capítulo BOOK V (sem CHAPTER) (Cena 17/32)"
...
**Starts at:** "Now Democritus has treated of these matters, but his treatment is not correct, because he assigns a cause to apply generally although he has not under- taken an exhaustive invéstigation of the fact"
**Ends at:** "The front part, however, quickly reaches its completion owing to its thinness, and no residue finds a place in it ; instead of that, the nourishment is consumed to supply that part’s own growth."
