═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l02_c01_cena38_geracao_animais

 (Final filename on disk: aristoteles_23_l02_c01_cena38_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, BOOK II (sem CHAPTER) (sub-cena 38 of 54).
- **Audio Position in This Work:** This is audio 67 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK II, Capítulo BOOK II (sem CHAPTER) (Cena 38/54)"
...
**Starts at:** "this blood-vessel, one to the membrane which sur- rounds the yolk, the other to the chorion-like mem- brane which surrounds the animal,on all sides ;_ this one goes round inside the membrane-of the"
**Ends at:** "is hard and stout, so as to keep it safe in the outside world ; the others’ eggs are liquid and soft in nature, because they are inside the mother and get their shelter from her body."
