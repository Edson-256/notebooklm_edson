═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l02_c01_cena08_geracao_animais

 (Final filename on disk: aristoteles_23_l02_c01_cena08_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, BOOK II (sem CHAPTER) (sub-cena 8 of 54).
- **Audio Position in This Work:** This is audio 37 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK II, Capítulo BOOK II (sem CHAPTER) (Cena 8/54)"
...
**Starts at:** "ji it by the heat and becomes pneuma."
**Ends at:** "which consists of the tiniest particles, so small that each individual bubble cannot be detected by the eye."
