═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l01_c01_cena11_geracao_animais

 (Final filename on disk: aristoteles_23_l01_c01_cena11_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, BOOK I (sem CHAPTER) (sub-cena 11 of 29).
- **Audio Position in This Work:** This is audio 11 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK I, Capítulo BOOK I (sem CHAPTER) (Cena 11/29)"
...
**Starts at:** "the essence. cor- responding to the name, is the same.” For ‘Spavepor, see note on 726 b 24. A useful mnemonic is: ovra@vupov is same GENERATION OF ANIMALS, I. xv.—xvr. _ Sometimes too Cephalopo"
**Ends at:** "There are really four lines of argument which may be used to prove that the semen is drawn from each of the parts of the body."
