═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l01_c01_cena01_geracao_animais

 (Final filename on disk: aristoteles_23_l01_c01_cena01_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, BOOK I (sem CHAPTER) (sub-cena 1 of 29).
- **Audio Position in This Work:** This is audio 1 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK I, Capítulo BOOK I (sem CHAPTER) (Cena 1/29)"
...
**Starts at:** "_ Wrrx one exception we have now® spoken about I all the parts ® that are present in animals, both gener- [produe- _ ally concerning them, and also taking them group by group and dealing separately"
**Ends at:** "Nature, however, avoids what is infinite, because the infinite lacks completion and finality, whereas this is what Nature always seeks."
