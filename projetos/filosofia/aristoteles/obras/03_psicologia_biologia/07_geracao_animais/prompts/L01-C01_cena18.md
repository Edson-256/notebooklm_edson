═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l01_c01_cena18_geracao_animais

 (Final filename on disk: aristoteles_23_l01_c01_cena18_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, BOOK I (sem CHAPTER) (sub-cena 18 of 29).
- **Audio Position in This Work:** This is audio 18 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK I, Capítulo BOOK I (sem CHAPTER) (Cena 18/29)"
...
**Starts at:** "@ And therefore would have to be reckoned as one of the uniform parts. > Viz., the non-uniform parts, for the construction of which the uniform parts act as the “ material.” ie | ¢ This may mean t"
**Ends at:** "—_— 2 i ey RS GENERATION OF ANIMALS, I."
