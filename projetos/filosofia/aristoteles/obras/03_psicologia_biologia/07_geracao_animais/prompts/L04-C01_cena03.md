═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l04_c01_cena03_geracao_animais

 (Final filename on disk: aristoteles_23_l04_c01_cena03_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IV, BOOK IV (sem CHAPTER) (sub-cena 3 of 25).
- **Audio Position in This Work:** This is audio 86 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK IV, Capítulo BOOK IV (sem CHAPTER) (Cena 3/25)"
...
**Starts at:** "*® i.e., as well as the sexual parts; ¢.g., if the offspring has sexual parts resembling those of its father—i.e., male ones— then it ought to resemble its father in all its other parts too. * Thi"
**Ends at:** "76 ETE LLEVOV Oeppdrepor, ToLodrov 5€ TO ouveotds, YOVYLESTEpOV dé 7d ovveotos padov."
