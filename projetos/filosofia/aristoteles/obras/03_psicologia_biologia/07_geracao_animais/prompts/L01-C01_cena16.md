═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l01_c01_cena16_geracao_animais

 (Final filename on disk: aristoteles_23_l01_c01_cena16_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, BOOK I (sem CHAPTER) (sub-cena 16 of 29).
- **Audio Position in This Work:** This is audio 16 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK I, Capítulo BOOK I (sem CHAPTER) (Cena 16/29)"
...
**Starts at:** "The weightiest proof of all, however, we have sufficiently established by our observations of Insects. Perhaps not in all Insects, but certainly in most, during copulation the female extends a part"
**Ends at:** "’ davia, €x & davias (Sika."
