═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l02_c01_cena07_geracao_animais

 (Final filename on disk: aristoteles_23_l02_c01_cena07_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, BOOK II (sem CHAPTER) (sub-cena 7 of 54).
- **Audio Position in This Work:** This is audio 36 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK II, Capítulo BOOK II (sem CHAPTER) (Cena 7/54)"
...
**Starts at:** "of generating another creature like itself, since this _ is a function which belongs to every animal and plant _ that is perfect in its nature). The reason why this _ must of necessity be so is tha"
**Ends at:** "The first practically successful — - 160 GENERATION OF ANIMALS, II."
