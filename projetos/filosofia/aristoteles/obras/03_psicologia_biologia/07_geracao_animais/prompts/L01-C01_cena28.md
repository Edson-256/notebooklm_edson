═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l01_c01_cena28_geracao_animais

 (Final filename on disk: aristoteles_23_l01_c01_cena28_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, BOOK I (sem CHAPTER) (sub-cena 28 of 29).
- **Audio Position in This Work:** This is audio 28 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK I, Capítulo BOOK I (sem CHAPTER) (Cena 28/29)"
...
**Starts at:** "Those which emit no semen, males into which the female inserts one of its parts, may be compared to a craftsman who has his material brought to him. Males of this sort are so weak that Nature is un"
**Ends at:** ", to reproduce itself, because TO Operrixin eh TO Alor bit re GENERATION OF ANIMALS, L."
