═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l01_c01_cena22_geracao_animais

 (Final filename on disk: aristoteles_23_l01_c01_cena22_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, BOOK I (sem CHAPTER) (sub-cena 22 of 29).
- **Audio Position in This Work:** This is audio 22 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK I, Capítulo BOOK I (sem CHAPTER) (Cena 22/29)"
...
The sources uploaded to NotebookLM contain the full text of *On the Generation of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, BOOK I (sem CHAPTER), bounded by:

**Starts at:** "of heat is weaker ; and (4) the female answers to this description, as we have said already. From which we conclude that the bloodlike secretion which occurs in the female must of necessity be a re"
**Ends at:** "The former produce only just so much liquid as remains in fertile individuals ® after the * evacuation is over, and there is no surplus residue to be dischargéd externally ; in the latter, the mouth o"
