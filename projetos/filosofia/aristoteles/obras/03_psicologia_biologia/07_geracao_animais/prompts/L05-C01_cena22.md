═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l05_c01_cena22_geracao_animais

 (Final filename on disk: aristoteles_23_l05_c01_cena22_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK V, BOOK V (sem CHAPTER) (sub-cena 22 of 32).
- **Audio Position in This Work:** This is audio 130 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK V, Capítulo BOOK V (sem CHAPTER) (Cena 22/32)"
...
**Starts at:** "animals. Although rain entails cloud, and cloud rain, in a continuous cycle, your father’s yéveors does not _ hecessarily entail yours, though yours entails his. But fundamentally the situation is"
**Ends at:** "For further references to the action of the heart and the pneuma, see below, §§ 31, 32."
