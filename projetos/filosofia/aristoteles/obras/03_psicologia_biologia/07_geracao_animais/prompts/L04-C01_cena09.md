═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l04_c01_cena09_geracao_animais

 (Final filename on disk: aristoteles_23_l04_c01_cena09_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IV, BOOK IV (sem CHAPTER) (sub-cena 9 of 25).
- **Audio Position in This Work:** This is audio 92 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK IV, Capítulo BOOK IV (sem CHAPTER) (Cena 9/25)"
...
**Starts at:** "a Aristotle now introduces the distinction between ¢&icra- ofa Kai peraBdAdrew (“departing from type and changing over ”’) and Avecda (™ relapsing ”): as will be seen, the result of the former proc"
**Ends at:** "The reason for which is \"that all particular individuals are accompanied * by this characteristic : since “ human being ”’ is general, whereas Socrates who is the father, and the mother whoever she ma"
