═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l04_c01_cena19_geracao_animais

 (Final filename on disk: aristoteles_23_l04_c01_cena19_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IV, BOOK IV (sem CHAPTER) (sub-cena 19 of 25).
- **Audio Position in This Work:** This is audio 102 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK IV, Capítulo BOOK IV (sem CHAPTER) (Cena 19/25)"
...
**Starts at:** "Some of those animals in which superfetation occurs are able to bring to completion the nourishing of their fetations even when there is a long interval between the copulations ; these are animals"
**Ends at:** "On account of this, then, it not only produces sometimes one off- spring, and two, but also and for the most part it produces numerous offspring, and it brings’ their nourishing to completion because "
