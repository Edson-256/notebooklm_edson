═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l05_c01_cena24_geracao_animais

 (Final filename on disk: aristoteles_23_l05_c01_cena24_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK V, BOOK V (sem CHAPTER) (sub-cena 24 of 32).
- **Audio Position in This Work:** This is audio 132 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK V, Capítulo BOOK V (sem CHAPTER) (Cena 24/32)"
...
**Starts at:** "will a motive agent which possesses the actuality make an X out of any chance material. Heat is present in the seminal residue, possessing the right movement and actuality (évépyeca) to suit each o"
**Ends at:** "That is to oat it can supply itself with everything that in the normal way would have to be supplied by “form ”’ in the parent creature which is already X in actuality, or (in the case of artefacta) b"
