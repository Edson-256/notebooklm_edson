═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l01_c01_cena04_geracao_animais

 (Final filename on disk: aristoteles_23_l01_c01_cena04_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, BOOK I (sem CHAPTER) (sub-cena 4 of 29).
- **Audio Position in This Work:** This is audio 4 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK I, Capítulo BOOK I (sem CHAPTER) (Cena 4/29)"
...
**Starts at:** "the Vivipara, however, have their testicles in front,* though some of them have them inside by the end of the abdomen—e.g., the dolphin—and have no pass- es, but a sexual duct® which leads from the"
**Ends at:** "GENERATION OF ANIMALS, I."
