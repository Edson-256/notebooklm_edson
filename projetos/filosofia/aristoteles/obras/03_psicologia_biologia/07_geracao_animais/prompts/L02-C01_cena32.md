═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l02_c01_cena32_geracao_animais

 (Final filename on disk: aristoteles_23_l02_c01_cena32_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, BOOK II (sem CHAPTER) (sub-cena 32 of 54).
- **Audio Position in This Work:** This is audio 61 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK II, Capítulo BOOK II (sem CHAPTER) (Cena 32/54)"
...
**Starts at:** "fluid and more bulky, whereas those of the high- bred birds are leaner and more solid,” this being the kind of body in which a thoroughbred and high- spirited temper tends rather to make its appear"
**Ends at:** "4 7,¢,, to mark that it belongs to a class which exhibits the rn GENERATION OF ANIMALS, It."
