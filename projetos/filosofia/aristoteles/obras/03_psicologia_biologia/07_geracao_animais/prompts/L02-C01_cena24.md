═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l02_c01_cena24_geracao_animais

 (Final filename on disk: aristoteles_23_l02_c01_cena24_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, BOOK II (sem CHAPTER) (sub-cena 24 of 54).
- **Audio Position in This Work:** This is audio 53 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK II, Capítulo BOOK II (sem CHAPTER) (Cena 24/54)"
...
**Starts at:** "* The functions of “‘ nutritive Soul” (see above, 735 a 17, and De anima 415 a 25) are to generate, and to make use of nourishment; it is the same Svvayus of the Soul which generates and which nour"
**Ends at:** "J GENERATION OF ANIMALS, II."
