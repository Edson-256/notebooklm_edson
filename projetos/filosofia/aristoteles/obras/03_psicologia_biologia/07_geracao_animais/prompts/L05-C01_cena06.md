═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l05_c01_cena06_geracao_animais

 (Final filename on disk: aristoteles_23_l05_c01_cena06_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK V, BOOK V (sem CHAPTER) (sub-cena 6 of 32).
- **Audio Position in This Work:** This is audio 114 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK V, Capítulo BOOK V (sem CHAPTER) (Cena 6/32)"
...
**Starts at:** "objects perceived, (b) to hear and smell from a dis- tance. As for (a). the ability to distinguish the differences. well, the cause of this is the sense-organ, just as it is in the case of sight, 7"
**Ends at:** "et te ee on oO — aa GENERATION OF ANIMALS, V."
