═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l01_c01_cena27_geracao_animais

 (Final filename on disk: aristoteles_23_l01_c01_cena27_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, BOOK I (sem CHAPTER) (sub-cena 27 of 29).
- **Audio Position in This Work:** This is audio 27 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK I, Capítulo BOOK I (sem CHAPTER) (Cena 27/29)"
...
**Starts at:** "we said happened with those insects where the female inserts a part into the male). Here is the evidence. Supposing a hen bird is in process of pro- ducing wind-eggs, and then that she is trodden b"
**Ends at:** "Males, then; that emit semen _ contribute to generation in the manner described."
