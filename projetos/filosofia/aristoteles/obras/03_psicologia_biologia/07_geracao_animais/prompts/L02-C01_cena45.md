═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l02_c01_cena45_geracao_animais

 (Final filename on disk: aristoteles_23_l02_c01_cena45_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, BOOK II (sem CHAPTER) (sub-cena 45 of 54).
- **Audio Position in This Work:** This is audio 74 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK II, Capítulo BOOK II (sem CHAPTER) (Cena 45/54)"
...
**Starts at:** "I said earlier that some Insects are formed by Gi.) Repro- means of copulation, others spontaneously ; further, ener that they produce a larva, and I stated the cause of their so doing. In a way, i"
**Ends at:** "4 olov ot Peck (sieut Z): of re vulg."
