═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l02_c01_cena11_geracao_animais

 (Final filename on disk: aristoteles_23_l02_c01_cena11_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, BOOK II (sem CHAPTER) (sub-cena 11 of 54).
- **Audio Position in This Work:** This is audio 40 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK II, Capítulo BOOK II (sem CHAPTER) (Cena 11/54)"
...
**Starts at:** "4 ohana by the portion of soul-principle and acts as its vehicle. Partly this soul-principle is separable _ from physical matter—this applies to those animals where some. divine element. is include"
**Ends at:** "_ For the present, however, we must begin first of Generation _all with the animals that come first."
