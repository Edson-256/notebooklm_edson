═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l04_c01_cena01_geracao_animais

 (Final filename on disk: aristoteles_23_l04_c01_cena01_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IV, BOOK IV (sem CHAPTER) (sub-cena 1 of 25).
- **Audio Position in This Work:** This is audio 84 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK IV, Capítulo BOOK IV (sem CHAPTER) (Cena 1/25)"
...
**Starts at:** "_ Tue formation of animals, both in general and as con- - cerns all of them separately, has now been dealt with. Since, however, in the most perfect * of them the male and the female are separate"
**Ends at:** "Aristotle seems to assume all through this discussion that according to Empedocles the fi mental difference between male and female was one of heat ae GENERATION OF ANIMALS, IV."
