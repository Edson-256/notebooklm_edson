═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l01_c01_cena21_geracao_animais

 (Final filename on disk: aristoteles_23_l01_c01_cena21_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, BOOK I (sem CHAPTER) (sub-cena 21 of 29).
- **Audio Position in This Work:** This is audio 21 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK I, Capítulo BOOK I (sem CHAPTER) (Cena 21/29)"
...
**Starts at:** "bloodless animals _ the .analogous."
**Ends at:** "GENERATION OF ANIMALS, IL."
