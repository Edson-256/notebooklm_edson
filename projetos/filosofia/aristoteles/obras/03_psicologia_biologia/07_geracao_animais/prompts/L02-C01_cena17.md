═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l02_c01_cena17_geracao_animais

 (Final filename on disk: aristoteles_23_l02_c01_cena17_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, BOOK II (sem CHAPTER) (sub-cena 17 of 54).
- **Audio Position in This Work:** This is audio 46 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK II, Capítulo BOOK II (sem CHAPTER) (Cena 17/54)"
...
**Starts at:** "‘Ey pev ovv Tos purots ov KEXUpLOT aL 70 OAAv Tob appevos: ev d€ Tots L@ous ev ols REX PLOT AL, mpoodeita TO OHA Tod appevos,*| KaiTo. Tis amo-= * séclusi. | peilov .. . éoriv Secl. A.-W., qui et"
**Ends at:** "The facts bear this out: wind-eggs become fertile if the male treads the female within a certain period."
