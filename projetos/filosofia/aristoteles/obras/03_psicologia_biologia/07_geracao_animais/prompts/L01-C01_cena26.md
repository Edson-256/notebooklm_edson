═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l01_c01_cena26_geracao_animais

 (Final filename on disk: aristoteles_23_l01_c01_cena26_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, BOOK I (sem CHAPTER) (sub-cena 26 of 29).
- **Audio Position in This Work:** This is audio 26 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK I, Capítulo BOOK I (sem CHAPTER) (Cena 26/29)"
...
**Starts at:** "These then are the lines upon, which that subject it should be treated. “And what we have said indicates gencrstion. piso Se i time how wwe are to answer the : ch we next have to considex, viz., ho"
**Ends at:** "evil > GENERATION OF ANIMALS, I."
