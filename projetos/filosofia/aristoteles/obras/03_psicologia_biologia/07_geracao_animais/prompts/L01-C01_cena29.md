═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l01_c01_cena29_geracao_animais

 (Final filename on disk: aristoteles_23_l01_c01_cena29_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, BOOK I (sem CHAPTER) (sub-cena 29 of 29).
- **Audio Position in This Work:** This is audio 29 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK I, Capítulo BOOK I (sem CHAPTER) (Cena 29/29)"
...
**Starts at:** "_ differ from the creatures which are merely alive ; since, however, if it be an animal, its attributes must of necessity include that of being alive, when the time comes for it to accomplish the f"
**Ends at:** "767 a 36—768 b 36); and (6) the “ final” cause, the better purpose or ‘“‘end” for motive ”’ the sake of which male and female individuals are produced, : @ See Introd."
