═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l05_c01_cena20_geracao_animais

 (Final filename on disk: aristoteles_23_l05_c01_cena20_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK V, BOOK V (sem CHAPTER) (sub-cena 20 of 32).
- **Audio Position in This Work:** This is audio 128 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK V, Capítulo BOOK V (sem CHAPTER) (Cena 20/32)"
...
**Starts at:** "¢ Tt is not necessary here to give details of the system of spheres as worked out by Aristotle, based on the mathematical theories of Eudoxus and Callippus. APPENDIX A (5) In the “ region about"
**Ends at:** "” Continuous yeveots a second-best to eternal being."
