═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l05_c01_cena18_geracao_animais

 (Final filename on disk: aristoteles_23_l05_c01_cena18_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK V, BOOK V (sem CHAPTER) (sub-cena 18 of 32).
- **Audio Position in This Work:** This is audio 126 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK V, Capítulo BOOK V (sem CHAPTER) (Cena 18/32)"
...
**Starts at:** "Democritus, however, omitted to mention the Final Cause,* and so all the things which Nature employs he refers to necessity. It is of course true that they are determined by necessity, but at the"
**Ends at:** "No such account, however, is there now ; and it seems reasonable to suppose that it has been ousted and supplanted by the passage which now stands there."
