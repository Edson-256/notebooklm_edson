═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l02_c01_cena34_geracao_animais

 (Final filename on disk: aristoteles_23_l02_c01_cena34_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, BOOK II (sem CHAPTER) (sub-cena 34 of 54).
- **Audio Position in This Work:** This is audio 63 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK II, Capítulo BOOK II (sem CHAPTER) (Cena 34/54)"
...
**Starts at:** "the fish tribe is very prolific; therefore it is impossible for a large number of eggs to reach perfection within the animal; hence they are laid externally. Their discharge is quickly effected, fo"
**Ends at:** "Therefore it separates off (and arranges itself) all round (on the outside), while the yellow earthy part separates off within."
