═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l02_c01_cena14_geracao_animais

 (Final filename on disk: aristoteles_23_l02_c01_cena14_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, BOOK II (sem CHAPTER) (sub-cena 14 of 54).
- **Audio Position in This Work:** This is audio 43 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK II, Capítulo BOOK II (sem CHAPTER) (Cena 14/54)"
...
**Starts at:** "wage ; before that time none of them can do so _ without great violence exerted contrary to nature. _ >» We have now given the reason for the secretion of _ the generative residues in animals. _ «"
**Ends at:** "739 b 140 a or ARISTOTLE) FT?"
