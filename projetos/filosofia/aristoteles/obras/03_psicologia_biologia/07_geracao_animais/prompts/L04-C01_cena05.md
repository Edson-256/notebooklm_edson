═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l04_c01_cena05_geracao_animais

 (Final filename on disk: aristoteles_23_l04_c01_cena05_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IV, BOOK IV (sem CHAPTER) (sub-cena 5 of 25).
- **Audio Position in This Work:** This is audio 88 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK IV, Capítulo BOOK IV (sem CHAPTER) (Cena 5/25)"
...
**Starts at:** "to secrete the residue in a pure condition ; and as in the there is an instrument for every ability or faculty, for °™\"\"” the one which yields its product in a more finished condition and for the o"
**Ends at:** "_ concoction of the ultimate nourishment (in blooded animals this is known as blood, in the bloodless ones it is the counterpart of blood) ;."
