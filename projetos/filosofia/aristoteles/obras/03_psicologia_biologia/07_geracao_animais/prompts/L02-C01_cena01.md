═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l02_c01_cena01_geracao_animais

 (Final filename on disk: aristoteles_23_l02_c01_cena01_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, BOOK II (sem CHAPTER) (sub-cena 1 of 54).
- **Audio Position in This Work:** This is audio 30 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK II, Capítulo BOOK II (sem CHAPTER) (Cena 1/54)"
...
**Starts at:** "IT nave already said that the male and the female are “principles ”’ of generation, and I have also said what is their dynamis * and the logos ° of their essence. © As for the reason why one comes"
**Ends at:** "The male, however, comes - together with the female and mingles with it for the _ business of generation, because this is something that concerns both of them."
