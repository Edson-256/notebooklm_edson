═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l05_c01_cena16_geracao_animais

 (Final filename on disk: aristoteles_23_l05_c01_cena16_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK V, BOOK V (sem CHAPTER) (sub-cena 16 of 32).
- **Audio Position in This Work:** This is audio 124 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK V, Capítulo BOOK V (sem CHAPTER) (Cena 16/32)"
...
**Starts at:** "* Cf. 776 b 17, 781 a 27 ff."
**Ends at:** "We must take it to be appropriate to examine the cause of these things in a treatise on™ Generation."
