═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l05_c01_cena08_geracao_animais

 (Final filename on disk: aristoteles_23_l05_c01_cena08_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK V, BOOK V (sem CHAPTER) (sub-cena 8 of 32).
- **Audio Position in This Work:** This is audio 116 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK V, Capítulo BOOK V (sem CHAPTER) (Cena 8/32)"
...
**Starts at:** "tributory cause is the difference of the fluid present in it: in some this is greasy, in others watery. In general, of course, the fundamental nature of the skin is earthy in substance : being on t"
**Ends at:** "monet Platt, 518 * GENERATION OF ANIMALS, V."
