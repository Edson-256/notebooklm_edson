═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l02_c01_cena54_geracao_animais

 (Final filename on disk: aristoteles_23_l02_c01_cena54_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, BOOK II (sem CHAPTER) (sub-cena 54 of 54).
- **Audio Position in This Work:** This is audio 83 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK II, Capítulo BOOK II (sem CHAPTER) (Cena 54/54)"
...
**Starts at:** "TRATE THE MEMBRANES OF THE CHICK EMBRYO The dotted lines represent mesoblast. The diagram shows the state of development after about ten days. The embryo itself is in the central part of the diagr"
**Ends at:** "We know to-day that sex is determined genetically from the moment of fertilization, since some animals have two kinds of sperm and others have two kinds of egg."
