═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l01_c01_cena15_geracao_animais

 (Final filename on disk: aristoteles_23_l01_c01_cena15_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, BOOK I (sem CHAPTER) (sub-cena 15 of 29).
- **Audio Position in This Work:** This is audio 15 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK I, Capítulo BOOK I (sem CHAPTER) (Cena 15/29)"
...
**Starts at:** "‘unless the substance that is added changes?"
**Ends at:** "* Further, transplanted cuttings bear seed—derived, of course, from themselves; which is proof positive that the fruit they bore before they were trans- planted was derived from that identical amount "
