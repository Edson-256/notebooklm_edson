═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l05_c01_cena19_geracao_animais

 (Final filename on disk: aristoteles_23_l05_c01_cena19_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK V, BOOK V (sem CHAPTER) (sub-cena 19 of 32).
- **Audio Position in This Work:** This is audio 127 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK V, Capítulo BOOK V (sem CHAPTER) (Cena 19/32)"
...
**Starts at:** "To understand the background of the passage, the reader may find it useful to refer to the account of Aristotle’s theory of hearing in App. B §§ 29 ff., which I have compiled from various passages"
**Ends at:** ", l’ amor che move il sole e Il’ altre stelle."
