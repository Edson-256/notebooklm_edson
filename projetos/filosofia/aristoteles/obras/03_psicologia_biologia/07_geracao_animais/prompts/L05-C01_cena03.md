═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l05_c01_cena03_geracao_animais

 (Final filename on disk: aristoteles_23_l05_c01_cena03_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK V, BOOK V (sem CHAPTER) (sub-cena 3 of 32).
- **Audio Position in This Work:** This is audio 111 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK V, Capítulo BOOK V (sem CHAPTER) (Cena 3/32)"
...
**Starts at:** "The eyes of all infants are bluish immediately after Colour of birth ; later on they change over to the colour which \"* is going to be their natural colour for life. In the other animals this does"
**Ends at:** "SyAot \ \ \ > / a ” ¢ / \ 15 6€ Kal Ta appwoTHpata Ths owews ExaTépas."
