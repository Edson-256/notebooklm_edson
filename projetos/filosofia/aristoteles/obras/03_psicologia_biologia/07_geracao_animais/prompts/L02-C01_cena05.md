═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l02_c01_cena05_geracao_animais

 (Final filename on disk: aristoteles_23_l02_c01_cena05_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, BOOK II (sem CHAPTER) (sub-cena 5 of 54).
- **Audio Position in This Work:** This is audio 34 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK II, Capítulo BOOK II (sem CHAPTER) (Cena 5/54)"
...
**Starts at:** "whole, existing in the semen from the outset."
**Ends at:** "‘(ARISTOTEE)) 44 Svat) 734 b poe."
