═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l05_c01_cena13_geracao_animais

 (Final filename on disk: aristoteles_23_l05_c01_cena13_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK V, BOOK V (sem CHAPTER) (sub-cena 13 of 32).
- **Audio Position in This Work:** This is audio 121 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK V, Capítulo BOOK V (sem CHAPTER) (Cena 13/32)"
...
**Starts at:** "animals) ; others are many-coloured, yet at the same time whole-coloured (by which I mean that the whole body is of the same colour, e.g., an ox is white all over, or dark all over); others still a"
**Ends at:** "With regard to the voice: some animals have a VII Voice."
