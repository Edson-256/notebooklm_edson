═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l01_c01_cena19_geracao_animais

 (Final filename on disk: aristoteles_23_l01_c01_cena19_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, BOOK I (sem CHAPTER) (sub-cena 19 of 29).
- **Audio Position in This Work:** This is audio 19 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK I, Capítulo BOOK I (sem CHAPTER) (Cena 19/29)"
...
**Starts at:** "ets destroyed and departs from its proper nature.* fee is a piece of evidence to show that semen is not a colliquescence but a residue: the large animals produce but few young, while the small one"
**Ends at:** "719 GENERATION OF ANIMALS, I."
