═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l01_c01_cena12_geracao_animais

 (Final filename on disk: aristoteles_23_l01_c01_cena12_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, BOOK I (sem CHAPTER) (sub-cena 12 of 29).
- **Audio Position in This Work:** This is audio 12 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK I, Capítulo BOOK I (sem CHAPTER) (Cena 12/29)"
...
**Starts at:** "seope than one which affects a single part of a few parts only, The sécond argument is that mutilated parents produce mutilated offspring, and it is alleged that because the parent is deficient in"
**Ends at:** "Yet it is more in keeping that it should be drawn from the uniform parts, because they are prior to the non-uniform, and the non-imiform are constructed out of them ;."
