═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l04_c01_cena11_geracao_animais

 (Final filename on disk: aristoteles_23_l04_c01_cena11_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IV, BOOK IV (sem CHAPTER) (sub-cena 11 of 25).
- **Audio Position in This Work:** This is audio 94 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK IV, Capítulo BOOK IV (sem CHAPTER) (Cena 11/25)"
...
**Starts at:** "769 b Or ARISTOTLE”: TPA AZAD Kepdcete moAAods xupods eis ev dy pons “Kare” evreb0ev AapBavor, [xat|' Sdvair” ay AapBdve ‘py igov Gael ag éxdotov, adW’ ore fev TOU “Towde mAgov OTe S€ TOD TOL"
**Ends at:** ", spectaverit irrepsisse; con eras 717 b 29."
