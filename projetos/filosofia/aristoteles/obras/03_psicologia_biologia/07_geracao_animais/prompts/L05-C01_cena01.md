═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l05_c01_cena01_geracao_animais

 (Final filename on disk: aristoteles_23_l05_c01_cena01_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK V, BOOK V (sem CHAPTER) (sub-cena 1 of 32).
- **Audio Position in This Work:** This is audio 109 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK V, Capítulo BOOK V (sem CHAPTER) (Cena 1/32)"
...
**Starts at:** "We must now study the “conditions” in respect I of which the parts of animals differ. I mean such conditions of the parts as the following: blue and = dark colour of the eyes, high and deep @ pi"
