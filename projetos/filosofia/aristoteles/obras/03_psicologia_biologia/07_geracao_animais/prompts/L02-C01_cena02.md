═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l02_c01_cena02_geracao_animais

 (Final filename on disk: aristoteles_23_l02_c01_cena02_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, BOOK II (sem CHAPTER) (sub-cena 2 of 54).
- **Audio Position in This Work:** This is audio 31 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK II, Capítulo BOOK II (sem CHAPTER) (Cena 2/54)"
...
**Starts at:** "_ a share of the male and of the female, and that is why _ even plants have life. The class of animals, however, _ is) (what it is) in virtue of its power of sense-per- _ ception.’ In practically a"
**Ends at:** ", the division into 76 melov and 70 vevatixéy at Sophist 220 a)."
