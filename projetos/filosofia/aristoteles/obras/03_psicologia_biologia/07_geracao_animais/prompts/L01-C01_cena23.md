═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l01_c01_cena23_geracao_animais

 (Final filename on disk: aristoteles_23_l01_c01_cena23_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, BOOK I (sem CHAPTER) (sub-cena 23 of 29).
- **Audio Position in This Work:** This is audio 23 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK I, Capítulo BOOK I (sem CHAPTER) (Cena 23/29)"
...
**Starts at:** "Therefore, when there has been a plentiful discharge - and yet the evacuation still continues, though not so copiously that the discharge of moisture carries the semen away with it, that is the tim"
**Ends at:** "to be acted upon» It * See 718 a 4, 738 a 1, etc."
