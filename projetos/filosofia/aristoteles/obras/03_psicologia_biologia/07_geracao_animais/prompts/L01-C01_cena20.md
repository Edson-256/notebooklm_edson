═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l01_c01_cena20_geracao_animais

 (Final filename on disk: aristoteles_23_l01_c01_cena20_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, BOOK I (sem CHAPTER) (sub-cena 20 of 29).
- **Audio Position in This Work:** This is audio 20 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK I, Capítulo BOOK I (sem CHAPTER) (Cena 20/29)"
...
**Starts at:** "_ “go goaty,” rampaging all over the place because _ they are getting too much nourishment. (The reason for the phrase “ go goaty ”’ is that they behave just like he-goats, which when they get fat"
