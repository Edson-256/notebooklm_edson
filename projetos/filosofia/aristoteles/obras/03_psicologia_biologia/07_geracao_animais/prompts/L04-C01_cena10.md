═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l04_c01_cena10_geracao_animais

 (Final filename on disk: aristoteles_23_l04_c01_cena10_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IV, BOOK IV (sem CHAPTER) (sub-cena 10 of 25).
- **Audio Position in This Work:** This is audio 93 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK IV, Capítulo BOOK IV (sem CHAPTER) (Cena 10/25)"
...
**Starts at:** "the agent in its turn gets acted upon by that upon which it acts (e.g., a thing which cuts gets blunted and by the thing which is cut, anda thing which heats gets cooled by the thing which is heate"
**Ends at:** "(2) One more type of explanation of the resemblance remains to be mentioned, and those who adopt it make a better show all round, including this particular question."
