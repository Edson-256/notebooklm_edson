═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l02_c01_cena06_geracao_animais

 (Final filename on disk: aristoteles_23_l02_c01_cena06_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, BOOK II (sem CHAPTER) (sub-cena 6 of 54).
- **Audio Position in This Work:** This is audio 35 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK II, Capítulo BOOK II (sem CHAPTER) (Cena 6/54)"
...
**Starts at:** "ex Too Suvdyie, TowovTov."
**Ends at:** "Some one thing—it is so far just that one thing whi is able to cause lies which contains the principle of GENERATION OF ANIMALS, II."
