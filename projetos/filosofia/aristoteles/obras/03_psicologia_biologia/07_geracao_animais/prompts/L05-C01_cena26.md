═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l05_c01_cena26_geracao_animais

 (Final filename on disk: aristoteles_23_l05_c01_cena26_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK V, BOOK V (sem CHAPTER) (sub-cena 26 of 32).
- **Audio Position in This Work:** This is audio 134 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK V, Capítulo BOOK V (sem CHAPTER) (Cena 26/32)"
...
**Starts at:** "accelerate natural movement (¢.g., itcan make a stone go downwards more quickly than it would do naturally) or it can produce movement contrary to Nature (e.g., it can make a stone go upwards) ; it"
**Ends at:** "e both trans- parent."
