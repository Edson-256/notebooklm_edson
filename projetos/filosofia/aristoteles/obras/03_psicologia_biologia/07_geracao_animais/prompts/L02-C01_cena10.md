═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l02_c01_cena10_geracao_animais

 (Final filename on disk: aristoteles_23_l02_c01_cena10_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, BOOK II (sem CHAPTER) (sub-cena 10 of 54).
- **Audio Position in This Work:** This is audio 39 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK II, Capítulo BOOK II (sem CHAPTER) (Cena 10/54)"
...
**Starts at:** "plant. And it is clear we should follow a similar line also in our statements about sentient Soul and rational Soul, since a thing must of necessity possess every one of the sorts of Soul potential"
**Ends at:** "| (This it is which, when ‘it is emitted by the male, is ."
