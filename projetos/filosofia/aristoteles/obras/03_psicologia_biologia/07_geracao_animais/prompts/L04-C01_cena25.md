═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l04_c01_cena25_geracao_animais

 (Final filename on disk: aristoteles_23_l04_c01_cena25_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IV, BOOK IV (sem CHAPTER) (sub-cena 25 of 25).
- **Audio Position in This Work:** This is audio 108 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK IV, Capítulo BOOK IV (sem CHAPTER) (Cena 25/25)"
...
**Starts at:** "not to the mere illumination of its surface by another body, and it is a period which differs in length from the lunation or “ phase-period **—a fact which was probably better known to Aristotle th"
**Ends at:** "3 éxa Peck (idem Richards) : évios vulg."
