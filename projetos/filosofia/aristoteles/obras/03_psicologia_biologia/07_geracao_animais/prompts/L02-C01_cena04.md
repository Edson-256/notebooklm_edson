═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l02_c01_cena04_geracao_animais

 (Final filename on disk: aristoteles_23_l02_c01_cena04_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, BOOK II (sem CHAPTER) (sub-cena 4 of 54).
- **Audio Position in This Work:** This is audio 33 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK II, Capítulo BOOK II (sem CHAPTER) (Cena 4/54)"
...
**Starts at:** "they all grow in size after they have been produced), and these young which they generate are. living creatures inside them from the outset. (2) The second class do not generate perfect animals wit"
**Ends at:** "* -It must, then, _ persist."
