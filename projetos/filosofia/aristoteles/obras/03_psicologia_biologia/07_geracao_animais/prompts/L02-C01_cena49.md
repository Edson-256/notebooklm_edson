═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l02_c01_cena49_geracao_animais

 (Final filename on disk: aristoteles_23_l02_c01_cena49_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, BOOK II (sem CHAPTER) (sub-cena 49 of 54).
- **Audio Position in This Work:** This is audio 78 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK II, Capítulo BOOK II (sem CHAPTER) (Cena 49/54)"
...
**Starts at:** "* Part of this sentence is inconsistent with what has already been said about the comparative sizes of the three _ kinds, and part anticipates what is to be said in the next sentence. * I suppose"
**Ends at:** "” Various animals proper to various - Elements."
