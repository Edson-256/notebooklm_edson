═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l02_c01_cena33_geracao_animais

 (Final filename on disk: aristoteles_23_l02_c01_cena33_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, BOOK II (sem CHAPTER) (sub-cena 33 of 54).
- **Audio Position in This Work:** This is audio 62 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK II, Capítulo BOOK II (sem CHAPTER) (Cena 33/54)"
...
**Starts at:** "in others, and in.some just enough to serve as an indication.* Similarly, there i is no discharge i in fishes, any more than i in birds : and therefore in fishes too, {just as in birds, _fetations"
**Ends at:** "In the group of animals which lay their eggs exter- nally, birds produce their eggs in a perfected state, fish in an imperfect state ; but fishes’ eggs continue and finish their growth apart from the "
