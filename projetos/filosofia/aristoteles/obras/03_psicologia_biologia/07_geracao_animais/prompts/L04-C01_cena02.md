═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l04_c01_cena02_geracao_animais

 (Final filename on disk: aristoteles_23_l04_c01_cena02_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IV, BOOK IV (sem CHAPTER) (sub-cena 2 of 25).
- **Audio Position in This Work:** This is audio 85 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK IV, Capítulo BOOK IV (sem CHAPTER) (Cena 2/25)"
...
**Starts at:** "male and the other all the parts of the female, they were to be put into the uterus as though it were into an oven, the one which has a uterus into a hot oven, and the one which has no uterus into"
**Ends at:** "ing, if female, should also take after its mother, and if male after its father.’ Besides, it is fantastic to imagine that these parts alone can be formed, without the whole body also having under-"
