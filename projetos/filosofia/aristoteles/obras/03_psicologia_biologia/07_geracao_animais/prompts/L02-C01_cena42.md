═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l02_c01_cena42_geracao_animais

 (Final filename on disk: aristoteles_23_l02_c01_cena42_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, BOOK II (sem CHAPTER) (sub-cena 42 of 54).
- **Audio Position in This Work:** This is audio 71 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK II, Capítulo BOOK II (sem CHAPTER) (Cena 42/54)"
...
**Starts at:** "a perfected state when they are discharged, this must happen while they are as yet within the mother ; but the eggs of fish, without exception, are imperfect when discharged and continue their grow"
**Ends at:** "the tail a line similar to the female pudendum."
