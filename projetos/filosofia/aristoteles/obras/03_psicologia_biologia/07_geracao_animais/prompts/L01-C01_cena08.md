═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l01_c01_cena08_geracao_animais

 (Final filename on disk: aristoteles_23_l01_c01_cena08_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, BOOK I (sem CHAPTER) (sub-cena 8 of 29).
- **Audio Position in This Work:** This is audio 8 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK I, Capítulo BOOK I (sem CHAPTER) (Cena 8/29)"
...
**Starts at:** "When the animal is formed out of the egg, the _ process of formation is-for the most part the same as for birds: (the eggs) descend, and: the young _ animals are formed close by the pudenda, as occ"
**Ends at:** "719 b XIII 720 a or ."
