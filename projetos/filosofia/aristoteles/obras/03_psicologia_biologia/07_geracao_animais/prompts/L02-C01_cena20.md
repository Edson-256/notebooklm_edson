═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l02_c01_cena20_geracao_animais

 (Final filename on disk: aristoteles_23_l02_c01_cena20_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, BOOK II (sem CHAPTER) (sub-cena 20 of 54).
- **Audio Position in This Work:** This is audio 49 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK II, Capítulo BOOK II (sem CHAPTER) (Cena 20/54)"
...
**Starts at:** "EVEKG. EoTW ws’, apxy), doa de: pa) TOLadTAa."
**Ends at:** "1013 a 4— that from which, being present within it, a thing first comes into being (d0ev mp@rov yiyveras IL © He has repeated it almost continuously."
