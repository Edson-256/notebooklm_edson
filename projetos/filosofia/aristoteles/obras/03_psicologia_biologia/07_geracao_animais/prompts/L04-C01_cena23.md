═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_23_l04_c01_cena23_geracao_animais

 (Final filename on disk: aristoteles_23_l04_c01_cena23_geracao_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IV, BOOK IV (sem CHAPTER) (sub-cena 23 of 25).
- **Audio Position in This Work:** This is audio 106 of 140 for *On the Generation of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Geração dos Animais — BOOK IV, Capítulo BOOK IV (sem CHAPTER) (Cena 23/25)"
...
**Starts at:** "sufficient independent supply of nourishment and be able to, go about from place to place.) It is from here, 9 that the seminal residue is drawn: the reason is given in the earlier chapters of our"
**Ends at:** "is no longer sufficient for the fetus, owing to its size; at that same time the milk is becoming serviceable, and when no nourishment is entering by way of the umbilical cord, then the blood-vessels t"
