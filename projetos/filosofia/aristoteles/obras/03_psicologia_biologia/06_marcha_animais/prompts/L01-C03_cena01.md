═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_22_l01_c03_cena01_marcha_animais

 (Final filename on disk: aristoteles_22_l01_c03_cena01_marcha_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 3 of 19 for *On the Gait of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Marcha dos Animais — BOOK I (inferido), Capítulo Part 3 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Gait of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I (inferido), Part 3, bounded by:

**Starts at:** "After these preliminaries, we go on to the next questions in order."
**Ends at:** "It follows then that nothing without parts can move itself in this way, for it has not in it the distinction of the part which is passive and that which is active."
