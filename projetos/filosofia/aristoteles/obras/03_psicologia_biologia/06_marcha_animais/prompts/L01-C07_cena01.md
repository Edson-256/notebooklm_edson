═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_22_l01_c07_cena01_marcha_animais

 (Final filename on disk: aristoteles_22_l01_c07_cena01_marcha_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I (inferido), Part 7 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 7 of 19 for *On the Gait of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Marcha dos Animais — BOOK I (inferido), Capítulo Part 7 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Gait of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I (inferido), Part 7, bounded by:

**Starts at:** "It is clear then how locomotion belongs to those animals only which make their changes of place by means of two or four points in their structure, or to such animals par excellence. Moreover, since th"
**Ends at:** "On this account too those that are accustomed to live on land, for example all the eels, move with fewer flexions in a fluid than on land, while the kind of cestreus which has two fins, by its flexion"
