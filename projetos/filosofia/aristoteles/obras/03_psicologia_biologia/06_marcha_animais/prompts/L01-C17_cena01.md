═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_22_l01_c17_cena01_marcha_animais

 (Final filename on disk: aristoteles_22_l01_c17_cena01_marcha_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I (inferido), Part 17 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 17 of 19 for *On the Gait of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Marcha dos Animais — BOOK I (inferido), Capítulo Part 17 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Gait of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I (inferido), Part 17, bounded by:

**Starts at:** "Now the rest have bandy legs because they are soft-skinned, but the crayfish is hard-skinned and its limbs are for swimming and not for walking (and so are not bandy). Crabs, too, have their limbs ben"
**Ends at:** "Broad feet are more useful than long for pushing away the water when they are swimming."
