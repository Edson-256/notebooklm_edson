═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_22_l01_c14_cena01_marcha_animais

 (Final filename on disk: aristoteles_22_l01_c14_cena01_marcha_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I (inferido), Part 14 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 14 of 19 for *On the Gait of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Marcha dos Animais — BOOK I (inferido), Capítulo Part 14 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Gait of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I (inferido), Part 14, bounded by:

**Starts at:** "This is the way then the limbs bend, and for the reasons given."
**Ends at:** "Yet since forwards is a distinction relative to the line of vision, Nature has made its eyes able to conform to its limbs, for its eyes can move themselves obliquely, and therefore after a fashion cra"
