═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_22_l01_c13_cena01_marcha_animais

 (Final filename on disk: aristoteles_22_l01_c13_cena01_marcha_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I (inferido), Part 13 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 13 of 19 for *On the Gait of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Marcha dos Animais — BOOK I (inferido), Capítulo Part 13 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Gait of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I (inferido), Part 13, bounded by:

**Starts at:** "Now there are four modes of flexion if we take the combinations in pairs. Fore and hind may bend either both backwards, as the figures marked A, or in the opposite way both forwards, as in B, or in co"
**Ends at:** "And plainly the lower limbs are opposed in this respect to the upper, because the first joints are opposites, the shoulder bending forwards, the hip backwards; wherefore also the ankle bends backwards"
