═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_22_l01_c15_cena01_marcha_animais

 (Final filename on disk: aristoteles_22_l01_c15_cena01_marcha_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I (inferido), Part 15 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 15 of 19 for *On the Gait of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Marcha dos Animais — BOOK I (inferido), Capítulo Part 15 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Gait of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I (inferido), Part 15, bounded by:

**Starts at:** "Birds bend their legs in the same way as quadrupeds."
**Ends at:** "In view of this they cannot bend them otherwise than outwards."
