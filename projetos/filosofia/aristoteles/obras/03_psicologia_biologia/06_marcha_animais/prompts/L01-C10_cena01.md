═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_22_l01_c10_cena01_marcha_animais

 (Final filename on disk: aristoteles_22_l01_c10_cena01_marcha_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 10 of 19 for *On the Gait of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Marcha dos Animais — BOOK I (inferido), Capítulo Part 10 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Gait of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I (inferido), Part 10, bounded by:

**Starts at:** "A difficulty might perhaps be raised about birds."
**Ends at:** "The hind-quarters, too, are light and taper again, in order to conform to the movement of the front and not by their breadth to suck the air."
