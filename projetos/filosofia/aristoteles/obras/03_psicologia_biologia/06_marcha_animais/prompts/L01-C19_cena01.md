═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_22_l01_c19_cena01_marcha_animais

 (Final filename on disk: aristoteles_22_l01_c19_cena01_marcha_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I (inferido), Part 19 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 19 of 19 for *On the Gait of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Marcha dos Animais — BOOK I (inferido), Capítulo Part 19 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Gait of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I (inferido), Part 19, bounded by:

**Starts at:** "A difficulty may be suggested as to the movements of molluscs, that is, as to where that movement originates; for they have no distinction of left and right. Now observation shows them moving. We must"
**Ends at:** "It remains, after determining these questions, to investigate the problems of Life and Death."
