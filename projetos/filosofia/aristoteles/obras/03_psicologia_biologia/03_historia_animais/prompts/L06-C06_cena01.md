═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l06_c06_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l06_c06_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VI, Part 6 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 112 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK VI, Capítulo Part 6 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VI, Part 6, bounded by:

**Starts at:** "The eagle lays three eggs and hatches two of them, as it is said in the verses ascribed to Musaeus: That lays three, hatches two, and cares for one. This is the case in most instances, though occa"
**Ends at:** "This bird for a considerable time takes charge of her young; for, even when her young can fly, she flies alongside of them and supplies them with food."
