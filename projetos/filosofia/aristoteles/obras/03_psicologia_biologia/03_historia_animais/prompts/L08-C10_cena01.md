═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l08_c10_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l08_c10_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 167 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK VIII, Capítulo Part 10 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VIII, Part 10, bounded by:

**Starts at:** "Sheep and goats are graminivorous, but sheep browse assiduously and steadily, whereas goats shift their ground rapidly, and browse only on the tips of the herbage. Sheep are much improved in condition"
**Ends at:** "Sheep are healthier than goats, but goats are stronger than sheep."
