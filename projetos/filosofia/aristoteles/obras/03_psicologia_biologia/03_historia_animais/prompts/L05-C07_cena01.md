═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l05_c07_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l05_c07_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK V, Part 7 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 79 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK V, Capítulo Part 7 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK V, Part 7, bounded by:

**Starts at:** "Crustaceans copulate, as the crawfish, the lobster, the carid and the like, just like the opisthuretic quadrupeds, when the one animal turns up its tail and the other puts his tail on the other's tail"
**Ends at:** "In the copulative process of these animals there is no protrusion of a member from one animal into the other."
