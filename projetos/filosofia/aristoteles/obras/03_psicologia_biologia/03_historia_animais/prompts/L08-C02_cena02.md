═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l08_c02_cena02_historia_animais

 (Final filename on disk: aristoteles_19_l08_c02_cena02_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VIII, Part 2 (sub-cena 2 of 3).
- **Audio Position in This Work:** This is audio 158 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK VIII, Capítulo Part 2 (Cena 2/3)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VIII, Part 2, bounded by:

**Starts at:** "The sea-turtles feed on shell-fish-for, by the way, their mouths are extraordinarily hard; whatever object it seizes, stone or other, it crunches into bits, but when it leaves the water for dry land i"
**Ends at:** "As a general rule the larger fishes catch the smaller ones in their mouths whilst swimming straight after them in the ordinary position; but the selachians, the dolphin, and all the cetacea must first"
