═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l05_c26_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l05_c26_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK V, Part 26 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 98 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK V, Capítulo Part 26 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK V, Part 26, bounded by:

**Starts at:** "The land-scorpion also lays a number of egg shaped grubs, and broods over them. When the hatching is completed, the parent animal, as happens with the parent spider, is ejected and put to death by the"
**Ends at:** "When the hatching is completed, the parent animal, as happens with the parent spider, is ejected and put to death by the young ones; for very often the young ones are about eleven in number."
