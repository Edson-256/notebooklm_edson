═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l04_c01_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l04_c01_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 61 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK IV, Capítulo Part 1 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IV, Part 1, bounded by:

**Starts at:** "We have now treated, in regard to blooded animals of the parts they have in common and of the parts peculiar to this genus or that, and of the parts both composite and simple, whether without or withi"
**Ends at:** "So much for molluscs."
