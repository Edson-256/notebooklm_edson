═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l08_c11_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l08_c11_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VIII, Part 11 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 168 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK VIII, Capítulo Part 11 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VIII, Part 11, bounded by:

**Starts at:** "Of insects, such as have teeth are omnivorous; such as have a tongue feed on liquids only, extracting with that organ juices from all quarters. And of these latter some may be called omnivorous, inasm"
**Ends at:** "So much for the food of animals of the leading genera."
