═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l05_c31_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l05_c31_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK V, Part 31 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 103 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK V, Capítulo Part 31 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK V, Part 31, bounded by:

**Starts at:** "Of insects that are not carnivorous but that live on the juices of living flesh, such as lice and fleas and bugs, all, without exception, generate what are called 'nits', and these nits generate nothi"
**Ends at:** "This fish gets exceedingly fat from enjoying an abundance of food while the dolphin is out in pursuit of its prey."
