═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l06_c25_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l06_c25_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VI, Part 25 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 131 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK VI, Capítulo Part 25 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VI, Part 25, bounded by:

**Starts at:** "Breeders and trainers can distinguish between young and old quadrupeds."
**Ends at:** "If, when drawn back from the jaw, the skin at once goes back to its place, the animal is young; if it remains long wrinkled up, the animal is old."
