═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l09_c30_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l09_c30_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IX, Part 30 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 218 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK IX, Capítulo Part 30 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IX, Part 30, bounded by:

**Starts at:** "It has already been stated that the footless bird, which some term the cypselus, resembles the swallow; indeed, it is not easy to distinguish between the two birds, excepting in the fact that the cyps"
**Ends at:** "It is dim-sighted in the day-time, but sees well enough by night."
