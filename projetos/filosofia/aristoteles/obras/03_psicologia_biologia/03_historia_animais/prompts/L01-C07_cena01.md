═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l01_c07_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l01_c07_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 8 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK I, Capítulo Part 7 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 7, bounded by:

**Starts at:** "The chief parts into which the body as a whole is subdivided, are the head, the neck, the trunk (extending from the neck to the privy parts), which is called the thorax, two arms and two legs. Of the"
**Ends at:** "In some cases the parting is double; that is to say, some men are double crowned, not in regard to the bony skull, but in consequence of the double fall or set of the hair."
