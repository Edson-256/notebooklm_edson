═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l03_c20_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l03_c20_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK III, Part 20 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 58 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK III, Capítulo Part 20 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, Part 20, bounded by:

**Starts at:** "We now proceed to discuss the properties of marrow; for this is one of the liquids found in certain sanguineous animals. All the natural liquids of the body are contained in vessels: as blood in veins"
**Ends at:** "The fig-juice is first squeezed out into wool; the wool is then washed and rinsed, and the rinsing put into a little milk, and if this be mixed with other milk it curdles Rennet is a kind of milk, for"
