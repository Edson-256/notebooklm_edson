═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l05_c33_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l05_c33_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK V, Part 33 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 105 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK V, Capítulo Part 33 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK V, Part 33, bounded by:

**Starts at:** "In the case of animals that are quadrupeds and red-blooded and oviparous, generation takes place in the spring, but copulation does not take place in an uniform season. In some cases it takes place in"
**Ends at:** "For the egg is not larger than that of the goose, and the young crocodile is small, answering to the egg in size, but the full-grown animal attains the length of twenty-six feet; in fact, it is actual"
