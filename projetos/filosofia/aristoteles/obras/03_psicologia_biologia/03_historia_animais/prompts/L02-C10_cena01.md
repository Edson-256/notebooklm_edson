═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l02_c10_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l02_c10_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 30 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK II, Capítulo Part 10 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 10, bounded by:

**Starts at:** "Oviparous and blooded quadrupeds-and, by the way, no terrestrial blooded animal is oviparous unless it is quadrupedal or is devoid of feet altogether-are furnished with a head, a neck, a back, upper a"
**Ends at:** "As a rule, they pass the day-time on land and the nighttime in the water; for the temperature of the water is at night-time more genial than that of the open air."
