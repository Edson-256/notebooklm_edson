═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l05_c23_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l05_c23_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 95 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK V, Capítulo Part 23 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK V, Part 23, bounded by:

**Starts at:** "Anthrenae and wasps construct combs for their young."
**Ends at:** "And, by the way, the eggs and the grubs never rest at the bottom of the cells, but always cling on to the side wall."
