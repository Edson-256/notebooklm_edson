═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l04_c06_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l04_c06_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 67 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK IV, Capítulo Part 6 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IV, Part 6, bounded by:

**Starts at:** "The so-called tethyum or ascidian has of all these animals the most remarkable characteristics. It is the only mollusc that has its entire body concealed within its shell, and the shell is a substance"
**Ends at:** "So much for the external and the internal organs of molluscs, crustaceans, and testaceans."
