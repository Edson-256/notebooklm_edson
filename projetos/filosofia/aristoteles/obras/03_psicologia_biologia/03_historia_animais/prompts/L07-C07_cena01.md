═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l07_c07_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l07_c07_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VII, Part 7 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 150 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK VII, Capítulo Part 7 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VII, Part 7, bounded by:

**Starts at:** "In the emission of sperm there is a preliminary discharge of air, and the outflow is manifestly caused by a blast of air; for nothing is cast to a distance save by pneumatic pressure. After the seed r"
**Ends at:** "In between is a watery or sanguineous fluid, which the women folk call the forewaters."
