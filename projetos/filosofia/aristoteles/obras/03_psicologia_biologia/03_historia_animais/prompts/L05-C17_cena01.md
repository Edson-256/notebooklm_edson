═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l05_c17_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l05_c17_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK V, Part 17 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 89 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK V, Capítulo Part 17 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK V, Part 17, bounded by:

**Starts at:** "Of crustaceans, the female crawfish after copulation conceives and retains its eggs for about three months, from about the middle of May to about the middle of August; they then lay the eggs into the"
**Ends at:** "And, by the way, all crawfish are long lived."
