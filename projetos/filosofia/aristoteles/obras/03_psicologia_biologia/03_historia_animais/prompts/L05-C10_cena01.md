═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l05_c10_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l05_c10_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK V, Part 10 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 82 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK V, Capítulo Part 10 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK V, Part 10, bounded by:

**Starts at:** "Of cartilaginous fishes, the rhina or angelfish is the only one that breeds twice; for it breeds at the beginning of autumn, and at the setting of the Pleiads: and, of the two seasons, it is in better"
**Ends at:** "The orcys or large-sized tunny, the scorpis, and many other species spawn in the open sea."
