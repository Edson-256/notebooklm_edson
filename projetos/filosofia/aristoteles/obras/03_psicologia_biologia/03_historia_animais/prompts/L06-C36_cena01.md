═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l06_c36_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l06_c36_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VI, Part 36 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 142 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK VI, Capítulo Part 36 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VI, Part 36, bounded by:

**Starts at:** "There is found in Syria a so-called mule."
**Ends at:** "The number originally introduced was nine, and there are three there at the present day."
