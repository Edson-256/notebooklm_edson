═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l08_c03_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l08_c03_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 160 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK VIII, Capítulo Part 3 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VIII, Part 3, bounded by:

**Starts at:** "Of birds, such as have crooked talons are carnivorous without exception, and cannot swallow corn or bread-food even if it be put into their bills in tit-bits; as for instance, the eagle of every varie"
**Ends at:** "The kite has been seen to drink, but he certainly drinks very seldom."
