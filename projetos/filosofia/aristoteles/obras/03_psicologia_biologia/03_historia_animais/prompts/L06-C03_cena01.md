═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l06_c03_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l06_c03_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VI, Part 3 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 109 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK VI, Capítulo Part 3 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VI, Part 3, bounded by:

**Starts at:** "Generation from the egg proceeds in an identical manner with all birds, but the full periods from conception to birth differ, as has been said. With the common hen after three days and three nights th"
**Ends at:** "For instance, a hen has been known to lay eighteen eggs, and to hatch twins out of them all, except those that were wind-eggs; the rest were fertile (though, by the way, one of the twins is always big"
