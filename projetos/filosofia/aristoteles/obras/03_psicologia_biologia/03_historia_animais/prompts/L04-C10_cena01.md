═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l04_c10_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l04_c10_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IV, Part 10 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 71 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK IV, Capítulo Part 10 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IV, Part 10, bounded by:

**Starts at:** "With regard to the sleeping and waking of animals, all creatures that are red-blooded and provided with legs give sensible proof that they go to sleep and that they waken up from sleep; for, as a matt"
**Ends at:** "So much then for sensation and for the phenomena of sleeping and of awakening."
