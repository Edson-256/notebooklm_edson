═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l09_c15_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l09_c15_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IX, Part 15 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 203 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK IX, Capítulo Part 15 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IX, Part 15, bounded by:

**Starts at:** "The hoopoe usually constructs its nest out of human excrement."
**Ends at:** "The golden oriole is apt at learning, is clever at making a living, but is awkward in flight and has an ugly plumage."
