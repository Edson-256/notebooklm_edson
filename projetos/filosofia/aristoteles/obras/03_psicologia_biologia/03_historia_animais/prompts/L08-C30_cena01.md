═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l08_c30_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l08_c30_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VIII, Part 30 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 187 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK VIII, Capítulo Part 30 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VIII, Part 30, bounded by:

**Starts at:** "Animals also vary as to their condition of health in connexion with their pregnancy. Testaceans, such as scallops and all the oyster-family, and crustaceans, such as the lobster family, are best whe"
**Ends at:** "The eels that are called females are the best for the table: they look as though they were female, but they really are not so."
