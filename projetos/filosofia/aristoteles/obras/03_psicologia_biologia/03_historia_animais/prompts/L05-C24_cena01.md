═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l05_c24_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l05_c24_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK V, Part 24 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 96 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK V, Capítulo Part 24 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK V, Part 24, bounded by:

**Starts at:** "There is a kind of humble-bee that builds a cone-shaped nest of clay against a stone or in some similar situation, besmearing the clay with something like spittle. And this nest or hive is exceedingly"
**Ends at:** "Apart from the membrane there is found some wax in the honeycomb; and this a wax is much sallower in hue than the wax in the honeycomb of the bee."
