═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l09_c20_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l09_c20_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IX, Part 20 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 208 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK IX, Capítulo Part 20 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IX, Part 20, bounded by:

**Starts at:** "Of thrushes there are three species."
**Ends at:** "There is another species called the Illas; it is the smallest species of the three, and is less variegated in plumage than the others."
