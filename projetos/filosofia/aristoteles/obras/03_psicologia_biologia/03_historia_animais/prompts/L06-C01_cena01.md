═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l06_c01_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l06_c01_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VI, Part 1 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 107 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK VI, Capítulo Part 1 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VI, Part 1, bounded by:

**Starts at:** "So much for the generative processes in snakes and insects, and also in oviparous quadrupeds. Birds without exception lay eggs, but the pairing season and the times of parturition are not alike for al"
**Ends at:** "The tetrix, called ourax in Athens, builds neither on the ground nor on trees, but on low-lying shrubs."
