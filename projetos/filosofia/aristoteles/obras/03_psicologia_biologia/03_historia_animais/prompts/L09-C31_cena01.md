═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l09_c31_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l09_c31_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IX, Part 31 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 219 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK IX, Capítulo Part 31 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IX, Part 31, bounded by:

**Starts at:** "In narrow circumscribed districts where the food would be insufficient for more birds than two, ravens are only found in isolated pairs; when their young are old enough to fly, the parent couple first"
**Ends at:** "About the time when the mercenaries under Medius were slaughtered at Pharsalus, the districts about Athens and the Peloponnese were left destitute of ravens, from which it would appear that these bird"
