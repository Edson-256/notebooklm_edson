═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l09_c43_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l09_c43_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IX, Part 43 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 233 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK IX, Capítulo Part 43 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IX, Part 43, bounded by:

**Starts at:** "Humble-bees produce their young under a stone, right on the ground, in a couple of cells or little more; in these cells is found an attempt at honey, of a poor description. The tenthredon is like the"
**Ends at:** "So much for the methods of working and the habits of life of the bee, the wasp, and all the other similar insects."
