═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l01_c11_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l01_c11_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, Part 11 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 12 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK I, Capítulo Part 11 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 11, bounded by:

**Starts at:** "Furthermore, there is a portion of the head, whereby an animal hears, a part incapable of breathing, the 'ear'. I say 'incapable of breathing', for Alcmaeon is mistaken when he says that goats inspire"
**Ends at:** "If this pillar gets relaxed and inflamed it is called 'uvula' or 'bunch of grapes', and it then has a tendency to bring about suffocation."
