═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l09_c24_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l09_c24_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IX, Part 24 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 212 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK IX, Capítulo Part 24 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IX, Part 24, bounded by:

**Starts at:** "Of daws there are three species."
**Ends at:** "There is another kind of daw found in Lybia and Phrygia, which is web-footed."
