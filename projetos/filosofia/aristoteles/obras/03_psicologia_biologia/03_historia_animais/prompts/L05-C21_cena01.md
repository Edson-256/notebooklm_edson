═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l05_c21_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l05_c21_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK V, Part 21 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 93 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK V, Capítulo Part 21 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK V, Part 21, bounded by:

**Starts at:** "With regard to the generation of bees different hypotheses are in vogue. Some affirm that bees neither copulate nor give birth to young, but that they fetch their young. And some say that they fetch t"
**Ends at:** "The rulers are provided with stings, but they never use them; and this latter circumstance will account for the belief of some people that they have no stings at all."
