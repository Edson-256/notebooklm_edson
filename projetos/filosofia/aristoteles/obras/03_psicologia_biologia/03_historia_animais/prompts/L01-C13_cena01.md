═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l01_c13_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l01_c13_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 14 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK I, Capítulo Part 13 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 13, bounded by:

**Starts at:** "Next after the thorax and in front comes the 'belly', and its root the 'navel'. Underneath this root the bilateral part is the 'flank': the undivided part below the navel, the 'abdomen', the extremity"
**Ends at:** "But by and by we shall treat in an exhaustive way regarding all such parts."
