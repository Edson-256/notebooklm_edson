═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l05_c12_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l05_c12_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 84 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK V, Capítulo Part 12 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK V, Part 12, bounded by:

**Starts at:** "The molluscs also breed in spring."
**Ends at:** "Snails are found by observations to become in all cases impregnated about the same season."
