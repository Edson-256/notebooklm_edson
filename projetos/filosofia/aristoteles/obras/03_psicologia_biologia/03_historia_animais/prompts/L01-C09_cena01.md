═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l01_c09_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l01_c09_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 10 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK I, Capítulo Part 9 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 9, bounded by:

**Starts at:** "Underneath the forehead are two eyebrows."
**Ends at:** "For in point of absolute fact it cannot see, and has no eyes visible externally; but when the outer skin is removed, it is found to have the place where eyes are usually situated, and the black parts "
