═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l09_c42_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l09_c42_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IX, Part 42 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 232 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK IX, Capítulo Part 42 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IX, Part 42, bounded by:

**Starts at:** "So much for the habits of wasps."
**Ends at:** "Among bees both the drones and the kings are stingless, and so are certain wasps, as has been said; but anthrenae appear to be all furnished with stings: though, by the way, it would well be worth whi"
