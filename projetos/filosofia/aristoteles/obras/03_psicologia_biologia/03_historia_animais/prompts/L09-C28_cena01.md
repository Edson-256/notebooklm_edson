═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l09_c28_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l09_c28_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IX, Part 28 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 216 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK IX, Capítulo Part 28 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IX, Part 28, bounded by:

**Starts at:** "Of the little horned owls there are two kinds, and one is visible at all seasons, and for that reason has the nickname of 'all-the-year-round owl'; it is not sufficiently palatable to come to table; a"
**Ends at:** "With regard to their origin, nothing is known from ocular observation; the only fact known for certain is that they are first seen when a west wind is blowing."
