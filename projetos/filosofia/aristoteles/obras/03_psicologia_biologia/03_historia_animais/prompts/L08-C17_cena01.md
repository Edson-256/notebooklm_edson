═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l08_c17_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l08_c17_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VIII, Part 17 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 174 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK VIII, Capítulo Part 17 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VIII, Part 17, bounded by:

**Starts at:** "Of viviparous quadrupeds the porcupine and the bear retire into concealment."
**Ends at:** "So much for the animals that go into hiding or torpidity, for the times at which, and the ways in which, they go; and so much also for the animals that slough off their old-age, and for the times at w"
