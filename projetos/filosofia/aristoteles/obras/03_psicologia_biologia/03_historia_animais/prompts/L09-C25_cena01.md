═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l09_c25_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l09_c25_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IX, Part 25 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 213 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK IX, Capítulo Part 25 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IX, Part 25, bounded by:

**Starts at:** "Of larks there are two kinds."
**Ends at:** "One lives on the ground and has a crest on its head; the other is gregarious, and not sporadic like the first; it is, however, of the same coloured plumage, but is smaller, and has no crest; it is an "
