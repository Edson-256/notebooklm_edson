═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l05_c13_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l05_c13_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 85 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK V, Capítulo Part 13 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK V, Part 13, bounded by:

**Starts at:** "(Of birds the wild species, as has been stated, as a general rule pair and breed only once a year. The swallow, however, and the blackbird breed twice. With regard to the blackbird, however, its first"
**Ends at:** "The spring brood is the best, or the autumn brood."
