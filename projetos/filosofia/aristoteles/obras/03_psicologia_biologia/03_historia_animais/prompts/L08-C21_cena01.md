═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l08_c21_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l08_c21_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VIII, Part 21 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 178 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK VIII, Capítulo Part 21 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VIII, Part 21, bounded by:

**Starts at:** "To turn to quadrupeds, the pig suffers from three diseases, one of which is called branchos, a disease attended with swellings about the windpipe and the jaws. It may break out in any part of the body"
**Ends at:** "The pig is the only animal known to be subject to measles."
