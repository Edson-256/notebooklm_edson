═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l02_c08_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l02_c08_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 28 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK II, Capítulo Part 8 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 8, bounded by:

**Starts at:** "Some animals share the properties of man and the quadrupeds, as the ape, the monkey, and the baboon. The monkey is a tailed ape. The baboon resembles the ape in form, only that it is bigger and strong"
**Ends at:** "The genitals of the female resemble those of the female in the human species; those of the male are more like those of a dog than are those of a man."
