═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l06_c14_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l06_c14_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VI, Part 14 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 120 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK VI, Capítulo Part 14 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VI, Part 14, bounded by:

**Starts at:** "Marsh-fishes and river-fishes conceive at the age of five months as a general rule, and deposit their spawn towards the close of the year without exception. And with these fishes, like as with the mar"
**Ends at:** "The mullet goes up from the sea to marshes and rivers; the eels, on the contrary, make their way down from the marshes and rivers to the sea."
