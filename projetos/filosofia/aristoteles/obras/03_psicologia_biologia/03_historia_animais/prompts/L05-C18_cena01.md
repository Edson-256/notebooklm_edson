═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l05_c18_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l05_c18_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK V, Part 18 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 90 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK V, Capítulo Part 18 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK V, Part 18, bounded by:

**Starts at:** "Molluscs, after pairing and copulation, lay a white spawn; and this spawn, as in the case of the testacean, gets granular in time. The octopus discharges into its hole, or into a potsherd or into any"
**Ends at:** "In the sepia, apart from this distinction in the sexes, the male, as has been stated, is more mottled than the female."
