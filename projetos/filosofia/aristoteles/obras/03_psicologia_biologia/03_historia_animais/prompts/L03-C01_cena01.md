═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l03_c01_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l03_c01_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK III, Part 1 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 39 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK III, Capítulo Part 1 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, Part 1, bounded by:

**Starts at:** "Now that we have stated the magnitudes, the properties, and the relative differences of the other internal organs, it remains for us to treat of the organs that contribute to generation. These organs"
**Ends at:** "The parts, then, in animals that are not homogeneous with themselves and uniform in their texture, both parts external and parts internal, have the properties above assigned to them."
