═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l06_c04_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l06_c04_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 110 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK VI, Capítulo Part 4 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VI, Part 4, bounded by:

**Starts at:** "Birds of the pigeon kind, such as the ringdove and the turtle-dove, lay two eggs at a time; that is to say, they do so as a general rule, and they never lay more than three. The pigeon, as has been sa"
**Ends at:** "(The ring-dove, according to all accounts, lives up to forty years."
