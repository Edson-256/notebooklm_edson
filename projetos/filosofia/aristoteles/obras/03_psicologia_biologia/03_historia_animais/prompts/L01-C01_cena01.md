═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l01_c01_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l01_c01_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, Part 1 (sub-cena 1 of 2).
- **Audio Position in This Work:** This is audio 1 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK I, Capítulo Part 1 (Cena 1/2)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 1, bounded by:

**Starts at:** "Of the parts of animals some are simple: to wit, all such as divide into parts uniform with themselves, as flesh into flesh; others are composite, such as divide into parts not uniform with themselves"
**Ends at:** "But no creature is able only to move by flying, as the fish is able only to swim, for the animals with leathern wings can walk; the bat has feet and the seal has imperfect feet."
