═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l02_c14_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l02_c14_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 34 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK II, Capítulo Part 14 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 14, bounded by:

**Starts at:** "Of blooded animals there now remains the serpent genus."
**Ends at:** "So much, then, for the external parts of blooded animals, as regards their numbers, their properties, and their relative diversities."
