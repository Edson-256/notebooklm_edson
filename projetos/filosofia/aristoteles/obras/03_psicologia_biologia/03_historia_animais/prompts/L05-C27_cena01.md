═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l05_c27_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l05_c27_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK V, Part 27 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 99 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK V, Capítulo Part 27 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK V, Part 27, bounded by:

**Starts at:** "Spiders in all cases copulate in the way above mentioned, and generate at first small grubs. And these grubs metamorphose in their entirety, and not partially, into spiders; for, by the way, the grubs"
**Ends at:** "The spider attains its full growth in about four weeks."
