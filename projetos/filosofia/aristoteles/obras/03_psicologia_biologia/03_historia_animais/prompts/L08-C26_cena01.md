═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l08_c26_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l08_c26_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VIII, Part 26 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 183 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK VIII, Capítulo Part 26 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VIII, Part 26, bounded by:

**Starts at:** "Elephants suffer from flatulence, and when thus afflicted can void neither solid nor liquid residuum. If the elephant swallow earth-mould it suffers from relaxation; but if it go on taking it steadily"
**Ends at:** "So much, then, for quadrupeds."
