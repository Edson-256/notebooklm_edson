═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l08_c09_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l08_c09_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VIII, Part 9 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 166 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK VIII, Capítulo Part 9 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VIII, Part 9, bounded by:

**Starts at:** "The elephant at the most can eat nine Macedonian medimni of fodder at one meal; but so large an amount is unwholesome. As a general rule it can take six or seven medimni of fodder, five medimni of whe"
**Ends at:** "The elephant is said by some to live for about two hundred years; by others, for three hundred."
