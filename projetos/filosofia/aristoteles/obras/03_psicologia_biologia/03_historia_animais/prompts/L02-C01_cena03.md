═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l02_c01_cena03_historia_animais

 (Final filename on disk: aristoteles_19_l02_c01_cena03_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, Part 1 (sub-cena 3 of 3).
- **Audio Position in This Work:** This is audio 21 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK II, Capítulo Part 1 (Cena 3/3)"
...
**Starts at:** "When man has arrived at maturity, his upper part is smaller than the lower one, but with all other blooded animals the reverse holds good. By the 'upper' part we mean all extending from the head down"
**Ends at:** "The pig sheds none of its teeth at all."
