═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l08_c04_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l08_c04_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VIII, Part 4 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 161 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK VIII, Capítulo Part 4 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VIII, Part 4, bounded by:

**Starts at:** "Animals that are coated with tessellates-such as the lizard and the other quadrupeds, and the serpents-are omnivorous: at all events they are carnivorous and graminivorous; and serpents, by the way, a"
**Ends at:** "Spiders and snakes can both go without food for a long time; and this remark may be verified by observation of specimens kept alive in the shops of the apothecaries."
