═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l01_c15_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l01_c15_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, Part 15 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 16 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK I, Capítulo Part 15 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 15, bounded by:

**Starts at:** "Parts of the back are a pair of 'shoulderblades', the 'back-bone', and, underneath on a level with the belly in the trunk, the 'loins'. Common to the upper and lower part of the trunk are the 'ribs',"
**Ends at:** "Of the senses man has the sense of touch more refined than any animal, and so also, but in less degree, the sense of taste; in the development of the other senses he is surpassed by a great number of "
