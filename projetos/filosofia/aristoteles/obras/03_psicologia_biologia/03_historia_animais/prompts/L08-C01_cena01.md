═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l08_c01_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l08_c01_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VIII, Part 1 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 156 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK VIII, Capítulo Part 1 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VIII, Part 1, bounded by:

**Starts at:** "We have now discussed the physical characteristics of animals and their methods of generation. Their habits and their modes of living vary according to their character and their food. In the great m"
**Ends at:** "And whatsoever is in conformity with nature is pleasant, and all animals pursue pleasure in keeping with their nature."
