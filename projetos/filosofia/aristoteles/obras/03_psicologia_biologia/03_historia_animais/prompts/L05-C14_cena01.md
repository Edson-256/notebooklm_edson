═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l05_c14_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l05_c14_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK V, Part 14 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 86 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK V, Capítulo Part 14 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK V, Part 14, bounded by:

**Starts at:** "Further, animals differ from one another in regard to the time of life that is best adapted for sexual intercourse. To begin with, in most animals the secretion of the seminal fluid and its generati"
**Ends at:** "And the embryo is the size of a calf two or three months old."
