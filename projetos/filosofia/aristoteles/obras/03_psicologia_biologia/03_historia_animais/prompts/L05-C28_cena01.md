═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l05_c28_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l05_c28_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK V, Part 28 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 100 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK V, Capítulo Part 28 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK V, Part 28, bounded by:

**Starts at:** "Grasshoppers (or locusts) copulate in the same way as other insects; that is to say, with the lesser covering the larger, for the male is smaller than the female. The females first insert the hollow t"
**Ends at:** "During the winter their eggs remain in the ground; and with the coming of summer the last year's larva develops into the perfect grasshopper."
