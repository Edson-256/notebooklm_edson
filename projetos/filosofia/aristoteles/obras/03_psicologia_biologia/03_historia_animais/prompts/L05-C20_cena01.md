═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l05_c20_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l05_c20_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 92 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK V, Capítulo Part 20 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK V, Part 20, bounded by:

**Starts at:** "The wasps that are nicknamed 'the ichneumons' (or hunters), less in size, by the way, than the ordinary wasp, kill spiders and carry off the dead bodies to a wall or some such place with a hole in it;"
**Ends at:** "The myops dies from dropsy in the eyes."
