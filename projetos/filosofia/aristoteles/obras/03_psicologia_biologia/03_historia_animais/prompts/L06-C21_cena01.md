═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l06_c21_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l06_c21_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VI, Part 21 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 127 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK VI, Capítulo Part 21 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VI, Part 21, bounded by:

**Starts at:** "The bull impregnates the cow at a single mount, and mounts with such vigour as to weigh down the cow; if his effort be unsuccessful, the cow must be allowed an interval of twenty days before being aga"
**Ends at:** "Kine herd together like mares, but in lesser degree."
