═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l09_c03_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l09_c03_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IX, Part 3 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 191 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK IX, Capítulo Part 3 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IX, Part 3, bounded by:

**Starts at:** "The characters of animals, as has been observed, differ in respect to timidity, to gentleness, to courage, to tameness, to intelligence, and to stupidity. The sheep is said to be naturally dull and"
**Ends at:** "When the sun turns early towards its setting, the goats are said to lie no longer face to face, but back to back."
