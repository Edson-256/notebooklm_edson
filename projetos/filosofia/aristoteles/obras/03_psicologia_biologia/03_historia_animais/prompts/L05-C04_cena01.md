═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l05_c04_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l05_c04_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK V, Part 4 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 76 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK V, Capítulo Part 4 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK V, Part 4, bounded by:

**Starts at:** "Long animals devoid of feet, like serpents and muraenae, intertwine in coition, belly to belly. And, in fact, serpents coil round one another so tightly as to present the appearance of a single serpen"
**Ends at:** "The same mode is followed by the saurians; that is to say, they coil round one another in the act of coition."
