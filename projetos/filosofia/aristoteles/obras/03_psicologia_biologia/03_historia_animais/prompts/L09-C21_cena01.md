═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l09_c21_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l09_c21_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IX, Part 21 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 209 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK IX, Capítulo Part 21 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IX, Part 21, bounded by:

**Starts at:** "There is a bird that lives on rocks, called the blue-bird from its colour. It is comparatively common in Nisyros, and is somewhat less than the owsel and a little bigger than the chaffinch. It has lar"
**Ends at:** "It is steel-blue all over; its beak is long and slender; its legs are short, like those of the woodpecker."
