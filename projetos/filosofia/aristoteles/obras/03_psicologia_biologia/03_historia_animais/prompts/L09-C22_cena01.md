═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l09_c22_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l09_c22_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IX, Part 22 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 210 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK IX, Capítulo Part 22 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IX, Part 22, bounded by:

**Starts at:** "The oriole is yellow all over; it is not visible during winter, but puts in an appearance about the time of the summer solstice, and departs again at the rising of Arcturus; it is the size of the turt"
**Ends at:** "The bird-catcher usually catches it by help of the owl."
