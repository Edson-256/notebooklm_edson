═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l04_c02_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l04_c02_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 62 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK IV, Capítulo Part 2 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IV, Part 2, bounded by:

**Starts at:** "With regard to the Malacostraca or crustaceans, one species is that of the crawfish, and a second, resembling the first, is that of the lobster; the lobster differing from the crawfish in having claws"
**Ends at:** "Such are the parts, internal and external, of the carid."
