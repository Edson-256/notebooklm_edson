═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l05_c25_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l05_c25_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK V, Part 25 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 97 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK V, Capítulo Part 25 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK V, Part 25, bounded by:

**Starts at:** "Ants copulate and engender grubs; and these grubs attach themselves to nothing in particular, but grow on and on from small and rounded shapes until they become elongated and defined in shape: and the"
**Ends at:** "Ants copulate and engender grubs; and these grubs attach themselves to nothing in particular, but grow on and on from small and rounded shapes until they become elongated and defined in shape: and the"
