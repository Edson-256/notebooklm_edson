═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l06_c05_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l06_c05_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VI, Part 5 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 111 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK VI, Capítulo Part 5 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VI, Part 5, bounded by:

**Starts at:** "The vulture builds its nest on inaccessible cliffs; for which reason its nest and young are rarely seen. And therefore Herodorus, father of Bryson the Sophist, declares that vultures belong to some fo"
**Ends at:** "The swallow is the only carnivorous bird that builds a nest twice."
