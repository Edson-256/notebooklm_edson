═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l01_c08_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l01_c08_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I, Part 8 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 9 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK I, Capítulo Part 8 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I, Part 8, bounded by:

**Starts at:** "The part that lies under the skull is called the 'face': but in the case of man only, for the term is not applied to a fish or to an ox. In the face the part below the sinciput and between the eyes is"
**Ends at:** "When men have large foreheads, they are slow to move; when they have small ones, they are fickle; when they have broad ones, they are apt to be distraught; when they have foreheads rounded or bulging "
