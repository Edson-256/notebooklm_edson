═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l09_c17_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l09_c17_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IX, Part 17 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 205 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK IX, Capítulo Part 17 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IX, Part 17, bounded by:

**Starts at:** "The crake is quarrelsome, clever at making a living, but in other ways an unlucky bird. The bird called sitta is quarrelsome, but clever and tidy, makes its living with ease, and for its knowingness i"
**Ends at:** "The acanthis finds its food with difficulty; its plumage is poor, but its note is musical."
