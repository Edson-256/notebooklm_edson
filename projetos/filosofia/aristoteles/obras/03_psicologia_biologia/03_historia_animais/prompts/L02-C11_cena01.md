═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l02_c11_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l02_c11_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 31 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK II, Capítulo Part 11 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 11, bounded by:

**Starts at:** "The chameleon resembles the lizard in the general configuration of its body, but the ribs stretch downwards and meet together under the belly as is the case with fishes, and the spine sticks up as wit"
**Ends at:** "It hibernates, like the lizard."
