═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l06_c26_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l06_c26_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VI, Part 26 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 132 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK VI, Capítulo Part 26 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VI, Part 26, bounded by:

**Starts at:** "The camel carries its young for ten months, and bears but one at a time and never more; the young camel is removed from the mother when a year old. The animal lives for a long period, more than fifty"
**Ends at:** "The milk is drunk mixed with water in the proportion of either two to one or three to one."
