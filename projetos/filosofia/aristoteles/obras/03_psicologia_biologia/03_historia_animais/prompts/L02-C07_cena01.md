═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l02_c07_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l02_c07_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 27 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK II, Capítulo Part 7 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 7, bounded by:

**Starts at:** "Furthermore, animals differ from one another in the relative size of their mouths. In some animals the mouth opens wide, as is the case with the dog, the lion, and with all the saw-toothed animals; ot"
**Ends at:** "The hide is so thick that spears are made out of it."
