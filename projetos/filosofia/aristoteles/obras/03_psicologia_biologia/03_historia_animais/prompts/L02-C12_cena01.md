═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l02_c12_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l02_c12_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK II, Part 12 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 32 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK II, Capítulo Part 12 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 12, bounded by:

**Starts at:** "Birds also in some parts resemble the above mentioned animals; that is to say, they have in all cases a head, a neck, a back, a belly, and what is analogous to the chest. The bird is remarkable among"
**Ends at:** "As a general rule the crest sticks up, and is composed of feathers only; but the crest of the barn-door cock is exceptional in kind, for, whereas it is not just exactly flesh, at the same time it is n"
