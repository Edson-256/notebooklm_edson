═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l09_c08_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l09_c08_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IX, Part 8 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 196 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK IX, Capítulo Part 8 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IX, Part 8, bounded by:

**Starts at:** "Birds of a heavy build, such as quails, partridges, and the like, build no nests; indeed, where they are incapable of flight, it would be of no use if they could do so. After scraping a hole on a leve"
**Ends at:** "Further, for instance, of such birds, the lark and the woodcock, as well as the quail, do not perch on a branch, but squat upon the ground."
