═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l09_c38_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l09_c38_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IX, Part 38 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 226 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK IX, Capítulo Part 38 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IX, Part 38, bounded by:

**Starts at:** "Of all insects, one may also say of all living creatures, the most industrious are the ant, the bee, the hornet, the wasp, and in point of fact all creatures akin to these; of spiders some are more sk"
**Ends at:** "The way in which ants work is open to ordinary observation; how they all march one after the other when they are engaged in putting away and storing up their food; all this may be seen, for they carry"
