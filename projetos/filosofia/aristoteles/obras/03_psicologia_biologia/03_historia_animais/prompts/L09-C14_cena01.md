═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l09_c14_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l09_c14_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IX, Part 14 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 202 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK IX, Capítulo Part 14 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IX, Part 14, bounded by:

**Starts at:** "The halcyon is not much larger than the sparrow."
**Ends at:** "It lays generally about five eggs, and lays eggs all its life long, beginning to do so at the age of four months."
