═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l08_c14_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l08_c14_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VIII, Part 14 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 171 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK VIII, Capítulo Part 14 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VIII, Part 14, bounded by:

**Starts at:** "Insects almost all go into hiding, with the exception of such of them as live in human habitations or perish before the completion of the year. They hide in the winter; some of them for several days,"
**Ends at:** "Animals take their winter-sleep or summer-sleep by concealing themselves in warm places, or in places where they have been used to lie concealed."
