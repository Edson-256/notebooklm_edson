═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l03_c03_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l03_c03_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 41 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK III, Capítulo Part 3 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, Part 3, bounded by:

**Starts at:** "Such are the accounts given by Syennesis and Diogenes."
**Ends at:** "But of the remaining veins that branch off from the last mentioned vein some envelop the head, others close their courses in the organs of sense and at the roots of the teeth in veins exceedingly fine"
