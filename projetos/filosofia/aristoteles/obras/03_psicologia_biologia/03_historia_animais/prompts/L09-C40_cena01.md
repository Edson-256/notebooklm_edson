═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l09_c40_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l09_c40_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IX, Part 40 (sub-cena 1 of 3).
- **Audio Position in This Work:** This is audio 228 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK IX, Capítulo Part 40 (Cena 1/3)"
...
**Starts at:** "So much for the spider."
**Ends at:** "The cells for the drones are larger than the others; sometimes the bees construct cells for the drones apart, but usually they put them in amongst their own; and when this is the case the bee-keepers "
