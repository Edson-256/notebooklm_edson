═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_19_l09_c19_cena01_historia_animais

 (Final filename on disk: aristoteles_19_l09_c19_cena01_historia_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK IX, Part 19 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 207 of 240 for *The History of Animals*.
...
1. **Título Principal:** "Guia de Estudos: História dos Animais — BOOK IX, Capítulo Part 19 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *The History of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IX, Part 19, bounded by:

**Starts at:** "There are two kinds of owsels; the one is black, and is found everywhere, the other is quite white, about the same size as the other, and with the same pipe. This latter is found on Cyllene in Arcadia"
**Ends at:** "The laius, or blue-thrush, is like the black owsel, only a little smaller; it lives on cliffs or on tile roofings; it has not a red beak as the black owsel has."
