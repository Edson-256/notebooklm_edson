═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_11_l02_c05_cena01_de_anima

 (Final filename on disk: aristoteles_11_l02_c05_cena01_de_anima.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 11 of 31 for *On the Soul*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Alma (De Anima) — BOOK II, Capítulo Part 5 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Soul*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 5, bounded by:

**Starts at:** "Having made these distinctions let us now speak of sensation in the widest sense. Sensation depends, as we have said, on a process of movement or affection from without, for it is held to be some sort"
**Ends at:** "As we have said, has the power of sensation is potentially like what the perceived object is actually; that is, while at the beginning of the process of its being acted upon the two interacting factor"
