═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_11_l03_c11_cena01_de_anima

 (Final filename on disk: aristoteles_11_l03_c11_cena01_de_anima.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 29 of 31 for *On the Soul*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Alma (De Anima) — BOOK III, Capítulo Part 11 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Soul*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, Part 11, bounded by:

**Starts at:** "We must consider also in the case of imperfect animals, sc."
**Ends at:** "Since the one premiss or judgement is universal and the other deals with the particular (for the first tells us that such and such a kind of man should do such and such a kind of act, and the second t"
