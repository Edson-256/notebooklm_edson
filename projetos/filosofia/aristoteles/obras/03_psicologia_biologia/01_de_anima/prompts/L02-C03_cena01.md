═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_11_l02_c03_cena01_de_anima

 (Final filename on disk: aristoteles_11_l02_c03_cena01_de_anima.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 9 of 31 for *On the Soul*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Alma (De Anima) — BOOK II, Capítulo Part 3 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Soul*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 3, bounded by:

**Starts at:** "Of the psychic powers above enumerated some kinds of living things, as we have said, possess all, some less than all, others one only. Those we have mentioned are the nutritive, the appetitive, the se"
**Ends at:** "It is evident that the way to give the most adequate definition of soul is to seek in the case of each of its forms for the most appropriate definition."
