═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_11_l02_c11_cena01_de_anima

 (Final filename on disk: aristoteles_11_l02_c11_cena01_de_anima.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 17 of 31 for *On the Soul*.
...
1. **Título Principal:** "Guia de Estudos: Sobre a Alma (De Anima) — BOOK II, Capítulo Part 11 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Soul*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK II, Part 11, bounded by:

**Starts at:** "Whatever can be said of what is tangible, can be said of touch, and vice versa; if touch is not a single sense but a group of senses, there must be several kinds of what is tangible. It is a problem w"
**Ends at:** "We have now given an outline account of each of the several senses."
