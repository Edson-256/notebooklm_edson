═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_21_l01_c01_cena01_movimento_animais

 (Final filename on disk: aristoteles_21_l01_c01_cena01_movimento_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 1 of 11 for *On the Motion of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre o Movimento dos Animais — BOOK I (inferido), Capítulo Part 1 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Motion of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I (inferido), Part 1, bounded by:

**Starts at:** "Elsewhere we have investigated in detail the movement of animals after their various kinds, the differences between them, and the reasons for their particular characters (for some animals fly, some sw"
**Ends at:** "Accordingly it is plain that each animal as a whole must have within itself a point at rest, whence will be the origin of that which is moved, and supporting itself upon which it will be moved both as"
