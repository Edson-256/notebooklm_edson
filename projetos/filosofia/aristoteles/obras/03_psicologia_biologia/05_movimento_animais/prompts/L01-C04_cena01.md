═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_21_l01_c04_cena01_movimento_animais

 (Final filename on disk: aristoteles_21_l01_c04_cena01_movimento_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 4 of 11 for *On the Motion of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre o Movimento dos Animais — BOOK I (inferido), Capítulo Part 4 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Motion of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I (inferido), Part 4, bounded by:

**Starts at:** "There is a further difficulty about the motions of the parts of the heavens which, as akin to what has gone before, may be considered next. For if one could overcome by force of motion the immobility"
**Ends at:** "Animals at any rate which move themselves are all moved supporting themselves on what is outside them, even when they inspire and expire; for there is no essential difference between casting a great a"
