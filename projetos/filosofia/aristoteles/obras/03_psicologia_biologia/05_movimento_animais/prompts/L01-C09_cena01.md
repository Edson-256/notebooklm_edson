═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_21_l01_c09_cena01_movimento_animais

 (Final filename on disk: aristoteles_21_l01_c09_cena01_movimento_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 9 of 11 for *On the Motion of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre o Movimento dos Animais — BOOK I (inferido), Capítulo Part 9 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Motion of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I (inferido), Part 9, bounded by:

**Starts at:** "Now since the left and the right sides are symmetrical, and these opposites are moved simultaneously, it cannot be that the left is moved by the right remaining stationary, nor vice versa; the origina"
**Ends at:** "This something is the soul, distinct from the spatial magnitude just described and yet located therein."
