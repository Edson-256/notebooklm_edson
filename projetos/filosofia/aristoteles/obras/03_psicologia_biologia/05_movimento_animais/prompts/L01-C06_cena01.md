═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_21_l01_c06_cena01_movimento_animais

 (Final filename on disk: aristoteles_21_l01_c06_cena01_movimento_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 6 of 11 for *On the Motion of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre o Movimento dos Animais — BOOK I (inferido), Capítulo Part 6 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Motion of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I (inferido), Part 6, bounded by:

**Starts at:** "Now whether the soul is moved or not, and how it is moved if it be moved, has been stated before in our treatise concerning it. And since all inorganic things are moved by some other thing- and the ma"
**Ends at:** "But it is not necessary for the last in the chain of things moved to move something else; wherefore it is plainly reasonable that motion in place should be the last of what happens in the region of th"
