═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_21_l01_c11_cena01_movimento_animais

 (Final filename on disk: aristoteles_21_l01_c11_cena01_movimento_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I (inferido), Part 11 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 11 of 11 for *On the Motion of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre o Movimento dos Animais — BOOK I (inferido), Capítulo Part 11 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Motion of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I (inferido), Part 11, bounded by:

**Starts at:** "So much then for the voluntary movements of animal bodies, and the reasons for them. These bodies, however, display in certain members involuntary movements too, but most often non-voluntary movements"
**Ends at:** "And so we have finished our account of the reasons for the parts of each kind of animal, of the soul, and furthere of sense-perception, of sleep, of memory, and of movement in general; it remains to s"
