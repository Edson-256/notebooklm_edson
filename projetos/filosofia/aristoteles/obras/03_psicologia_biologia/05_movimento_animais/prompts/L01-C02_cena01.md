═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_21_l01_c02_cena01_movimento_animais

 (Final filename on disk: aristoteles_21_l01_c02_cena01_movimento_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 2 of 11 for *On the Motion of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre o Movimento dos Animais — BOOK I (inferido), Capítulo Part 2 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Motion of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I (inferido), Part 2, bounded by:

**Starts at:** "But the point of rest in the animal is still quite ineffectual unless there be something without which is absolutely at rest and immovable. Now it is worth while to pause and consider what has been sa"
**Ends at:** "If, however, he pushes or pulls from outside he does move it, for the ground is no part of the boat."
