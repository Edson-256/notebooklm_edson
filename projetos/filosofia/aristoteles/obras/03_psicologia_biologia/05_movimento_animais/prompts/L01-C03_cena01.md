═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_21_l01_c03_cena01_movimento_animais

 (Final filename on disk: aristoteles_21_l01_c03_cena01_movimento_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 3 of 11 for *On the Motion of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre o Movimento dos Animais — BOOK I (inferido), Capítulo Part 3 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Motion of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I (inferido), Part 3, bounded by:

**Starts at:** "Here we may ask the difficult question whether if something moves the whole heavens this mover must be immovable, and moreover be no part of the heavens, nor in the heavens. For either it is moved its"
**Ends at:** "But if that is impossible, it follows that the heavens cannot possibly be moved by any force of this kind inside them."
