═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_21_l01_c10_cena01_movimento_animais

 (Final filename on disk: aristoteles_21_l01_c10_cena01_movimento_animais.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I (inferido), Part 10 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 10 of 11 for *On the Motion of Animals*.
...
1. **Título Principal:** "Guia de Estudos: Sobre o Movimento dos Animais — BOOK I (inferido), Capítulo Part 10 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On the Motion of Animals*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I (inferido), Part 10, bounded by:

**Starts at:** "Although from the point of view of the definition of movement- a definition which gives the cause- desire is the middle term or cause, and desire moves being moved, still in the material animated body"
**Ends at:** "There is no need then of a soul in each part, but she resides in a kind of central governing place of the body, and the remaining parts live by continuity of natural structure, and play the parts Natu"
