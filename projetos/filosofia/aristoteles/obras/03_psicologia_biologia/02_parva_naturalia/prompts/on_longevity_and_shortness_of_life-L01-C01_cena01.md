═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_17_l01_c01_cena01_on_longevity_and_shortness_of_life

 (Final filename on disk: aristoteles_17_l01_c01_cena01_on_longevity_and_shortness_of_life.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I (inferido), Part 1 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 2 of 54 for *On Longevity and Shortness of Life*.
...
1. **Título Principal:** "Guia de Estudos: Parva Naturalia — Sobre a Longevidade e a Brevidade da Vida — BOOK I (inferido), Capítulo Part 1 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Longevity and Shortness of Life*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I (inferido), Part 1, bounded by:

**Starts at:** "The reasons for some animals being long-lived and others short-lived, and, in a word, causes of the length and brevity of life call for investigation. The necessary beginning to our inquiry is a sta"
**Ends at:** "Likewise there are similar differences among individuals occupying the same locality."
