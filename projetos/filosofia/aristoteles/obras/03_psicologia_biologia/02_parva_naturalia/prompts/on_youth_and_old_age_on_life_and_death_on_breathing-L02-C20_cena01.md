═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_18_l02_c20_cena01_on_youth_and_old_age_on_life_and_death_on_breathing

 (Final filename on disk: aristoteles_18_l02_c20_cena01_on_youth_and_old_age_on_life_and_death_on_breathing.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 2, Part 20 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 47 of 54 for *On Youth and Old Age, On Life and Death, On Breathing*.
...
1. **Título Principal:** "Guia de Estudos: Parva Naturalia — Juventude e Velhice, Vida e Morte, Respiração — SECTION 2, Capítulo Part 20 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Youth and Old Age, On Life and Death, On Breathing*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 2, Part 20, bounded by:

**Starts at:** "Empedocles is then in error when he says that those animals which have the most warmth and fire live in the water to counterbalance the excess of heat in their constitution, in order that, since they"
**Ends at:** "This, then, is a sufficient explanation of why it is not owing to the heat in their constitution that some animals are aquatic, others terrestrial, as Empedocles maintains, and of why some possess lun"
