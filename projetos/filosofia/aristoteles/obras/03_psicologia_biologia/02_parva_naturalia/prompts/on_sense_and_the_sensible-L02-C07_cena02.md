═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_12_l02_c07_cena02_on_sense_and_the_sensible

 (Final filename on disk: aristoteles_12_l02_c07_cena02_on_sense_and_the_sensible.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 2, Part 7 (sub-cena 2 of 3).
- **Audio Position in This Work:** This is audio 40 of 54 for *On Sense and the Sensible*.
...
1. **Título Principal:** "Guia de Estudos: Parva Naturalia — Sobre o Sentido e o Sensível — SECTION 2, Capítulo Part 7 (Cena 2/3)"
...
**Starts at:** "Some of the writers who treat of concords assert that the sounds combined in these do not reach us simultaneously, but only appear to do so, their real successiveness being unnoticed whenever the time"
**Ends at:** "qua distinguishing its different simultaneous objects] in its actualization?"
