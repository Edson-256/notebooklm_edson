═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_12_l02_c06_cena01_on_sense_and_the_sensible

 (Final filename on disk: aristoteles_12_l02_c06_cena01_on_sense_and_the_sensible.m4a)
═══════════════════════════════════════════════════════════════════════════════

Act as a Senior Humanities Tutor specializing in the formative reading of Aristotle. Your goal is to write a detailed, highly pedagogical study guide (Guia de Estudos) to accompany and support the listener of the deep-dive audio overview of a specific passage from Aristotle's *On Sense and the Sensible*.

**Context & Anchoring:**
- **Work:** On Sense and the Sensible (Parva Naturalia — Sobre o Sentido e o Sensível), translated by Beare.
- **Passage Identifier:** SECTION 2, Part 6 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 38 of 54 for *On Sense and the Sensible*.
...
1. **Título Principal:** "Guia de Estudos: Parva Naturalia — Sobre o Sentido e o Sensível — SECTION 2, Capítulo Part 6 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Sense and the Sensible*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 2, Part 6, bounded by:

**Starts at:** "One might ask: if every body is infinitely divisible, are its sensible qualities- Colour, Savour, Odour, Sound, Weight, Cold or Heat, [Heaviness or] Lightness, Hardness or Softness-also infinitely div"
**Ends at:** "Naturally, then, the parts of media between a sensory organ and its object are not all affected at once- except in the case of Light [illumination] for the reason above stated, and also in the case of"
