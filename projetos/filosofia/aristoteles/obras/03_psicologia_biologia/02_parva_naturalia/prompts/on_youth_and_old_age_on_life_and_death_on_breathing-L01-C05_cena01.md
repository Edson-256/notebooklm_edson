═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_18_l01_c05_cena01_on_youth_and_old_age_on_life_and_death_on_breathing

 (Final filename on disk: aristoteles_18_l01_c05_cena01_on_youth_and_old_age_on_life_and_death_on_breathing.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 1, Part 5 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 26 of 54 for *On Youth and Old Age, On Life and Death, On Breathing*.
...
1. **Título Principal:** "Guia de Estudos: Parva Naturalia — Juventude e Velhice, Vida e Morte, Respiração — SECTION 1, Capítulo Part 5 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Youth and Old Age, On Life and Death, On Breathing*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 1, Part 5, bounded by:

**Starts at:** "However, it is to be noticed that there are two ways in which fire ceases to exist; it may go out either by exhaustion or by extinction. That which is self-caused we call exhaustion, that due to its o"
**Ends at:** "However, we have stated in The Problems the reasons why these operations, namely banking up and covering up a fire, have the opposite effects (in the one case the fire goes out, in the other it contin"
