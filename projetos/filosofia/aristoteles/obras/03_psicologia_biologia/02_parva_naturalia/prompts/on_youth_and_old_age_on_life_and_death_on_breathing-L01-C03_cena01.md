═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_18_l01_c03_cena01_on_youth_and_old_age_on_life_and_death_on_breathing

 (Final filename on disk: aristoteles_18_l01_c03_cena01_on_youth_and_old_age_on_life_and_death_on_breathing.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 1, Part 3 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 21 of 54 for *On Youth and Old Age, On Life and Death, On Breathing*.
...
1. **Título Principal:** "Guia de Estudos: Parva Naturalia — Juventude e Velhice, Vida e Morte, Respiração — SECTION 1, Capítulo Part 3 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Youth and Old Age, On Life and Death, On Breathing*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 1, Part 3, bounded by:

**Starts at:** "The same phenomenon is evident both in plants and in animals, and in plants we note it both in their propagation by seed and in grafts and cuttings. Genesis from seeds always starts from the middle. A"
**Ends at:** "Elsewhere in other works we have stated the reasons why some of the sense-organs are, as is evident, connected with the heart, while others are situated in the head."
