═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_17_l01_c04_cena01_on_longevity_and_shortness_of_life

 (Final filename on disk: aristoteles_17_l01_c04_cena01_on_longevity_and_shortness_of_life.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I (inferido), Part 4 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 22 of 54 for *On Longevity and Shortness of Life*.
...
1. **Título Principal:** "Guia de Estudos: Parva Naturalia — Sobre a Longevidade e a Brevidade da Vida — BOOK I (inferido), Capítulo Part 4 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Longevity and Shortness of Life*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I (inferido), Part 4, bounded by:

**Starts at:** "We find that a superior immunity from decay attaches neither to the largest animals (the horse has shorter life than man) nor to those that are small (for most insects live but for a year). Nor are pl"
**Ends at:** "As a matter of fact also it is a general rule that the larger live longer than the smaller, for the other long-lived animals too happen to be of a large size, as are also those I have mentioned."
