═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_14_l01_c03_cena01_on_sleep_and_sleeplessness

 (Final filename on disk: aristoteles_14_l01_c03_cena01_on_sleep_and_sleeplessness.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 20 of 54 for *On Sleep and Sleeplessness*.
...
1. **Título Principal:** "Guia de Estudos: Parva Naturalia — Sobre o Sono e a Vigília — BOOK I (inferido), Capítulo Part 3 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Sleep and Sleeplessness*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I (inferido), Part 3, bounded by:

**Starts at:** "The point for consideration next in order to the preceding is:-What are the processes in which the affection of waking and sleeping originates, and whence do they arise? Now, since it is when it has s"
**Ends at:** "for the sake of its conservation; since remission of movement tends to the conservation of animals."
