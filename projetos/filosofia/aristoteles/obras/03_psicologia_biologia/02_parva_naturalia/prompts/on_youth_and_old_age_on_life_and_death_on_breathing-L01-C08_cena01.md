═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_18_l01_c08_cena01_on_youth_and_old_age_on_life_and_death_on_breathing

 (Final filename on disk: aristoteles_18_l01_c08_cena01_on_youth_and_old_age_on_life_and_death_on_breathing.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 1, Part 8 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 30 of 54 for *On Youth and Old Age, On Life and Death, On Breathing*.
...
1. **Título Principal:** "Guia de Estudos: Parva Naturalia — Juventude e Velhice, Vida e Morte, Respiração — SECTION 1, Capítulo Part 8 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Youth and Old Age, On Life and Death, On Breathing*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 1, Part 8, bounded by:

**Starts at:** "Democritus of Abdera and certain others who have treated of respiration, while saying nothing definite about the lungless animals, nevertheless seem to speak as if all breathed. But Anaxagoras and Dio"
**Ends at:** "Hence, if respiring creatures must both exhale and inhale the air, and if none of these animals can breathe out, evidently none can respire at all."
