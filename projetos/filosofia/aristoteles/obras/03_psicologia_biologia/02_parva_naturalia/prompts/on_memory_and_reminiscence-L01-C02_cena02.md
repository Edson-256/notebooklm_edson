═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_13_l01_c02_cena02_on_memory_and_reminiscence

 (Final filename on disk: aristoteles_13_l01_c02_cena02_on_memory_and_reminiscence.m4a)
═══════════════════════════════════════════════════════════════════════════════

Act as a Senior Humanities Tutor specializing in the formative reading of Aristotle. Your goal is to write a detailed, highly pedagogical study guide (Guia de Estudos) to accompany and support the listener of the deep-dive audio overview of a specific passage from Aristotle's *On Memory and Reminiscence*.

**Context & Anchoring:**
- **Work:** On Memory and Reminiscence (Parva Naturalia — Sobre a Memória e a Reminiscência), translated by Beare.
- **Passage Identifier:** BOOK I (inferido), Part 2 (sub-cena 2 of 3).
- **Audio Position in This Work:** This is audio 15 of 54 for *On Memory and Reminiscence*.
...
1. **Título Principal:** "Guia de Estudos: Parva Naturalia — Sobre a Memória e a Reminiscência — BOOK I (inferido), Capítulo Part 2 (Cena 2/3)"
...
The sources uploaded to NotebookLM contain the full text of *On Memory and Reminiscence*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I (inferido), Part 2, bounded by:

**Starts at:** "It seems true in general that the middle point also among all things is a good mnemonic starting-point from which to reach any of them. For if one does not recollect before, he will do so when he has"
**Ends at:** "But to investigate in this way belongs naturally to those animals alone which are also endowed with the faculty of deliberation; (which proves what was said above), for deliberation is a form of infer"
