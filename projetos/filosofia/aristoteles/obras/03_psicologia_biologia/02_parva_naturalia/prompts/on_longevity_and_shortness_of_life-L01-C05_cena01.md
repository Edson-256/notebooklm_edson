═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_17_l01_c05_cena01_on_longevity_and_shortness_of_life

 (Final filename on disk: aristoteles_17_l01_c05_cena01_on_longevity_and_shortness_of_life.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I (inferido), Part 5 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 25 of 54 for *On Longevity and Shortness of Life*.
...
1. **Título Principal:** "Guia de Estudos: Parva Naturalia — Sobre a Longevidade e a Brevidade da Vida — BOOK I (inferido), Capítulo Part 5 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Longevity and Shortness of Life*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I (inferido), Part 5, bounded by:

**Starts at:** "The following considerations may enable us to understand the reasons for all these facts. We must remember that an animal is by nature humid and warm, and to live is to be of such a constitution, whil"
**Ends at:** "In animals fat is sweet, and hence bees are longer-lived than other animals of larger size."
