═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_18_l02_c21_cena01_on_youth_and_old_age_on_life_and_death_on_breathing

 (Final filename on disk: aristoteles_18_l02_c21_cena01_on_youth_and_old_age_on_life_and_death_on_breathing.m4a)
═══════════════════════════════════════════════════════════════════════════════

Act as a Senior Humanities Tutor specializing in the formative reading of Aristotle. Your goal is to write a detailed, highly pedagogical study guide (Guia de Estudos) to accompany and support the listener of the deep-dive audio overview of a specific passage from Aristotle's *On Youth and Old Age, On Life and Death, On Breathing*.

**Context & Anchoring:**
- **Work:** On Youth and Old Age, On Life and Death, On Breathing (Parva Naturalia — Juventude e Velhice, Vida e Morte, Respiração), translated by Ross.
- **Passage Identifier:** SECTION 2, Part 21 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 48 of 54 for *On Youth and Old Age, On Life and Death, On Breathing*.
...
1. **Título Principal:** "Guia de Estudos: Parva Naturalia — Juventude e Velhice, Vida e Morte, Respiração — SECTION 2, Capítulo Part 21 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Youth and Old Age, On Life and Death, On Breathing*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 2, Part 21, bounded by:

**Starts at:** "The explanation of the admission of air and respiration in those animals in which a lung is found, and especially in those in which it is full of blood, is to be found in the fact that it is of a spon"
**Ends at:** "The reason why animals with a full-blooded lung respire most is hence manifest; the more heat there is, the greater is the need for refrigeration, and at the same time breath can easily pass to the so"
