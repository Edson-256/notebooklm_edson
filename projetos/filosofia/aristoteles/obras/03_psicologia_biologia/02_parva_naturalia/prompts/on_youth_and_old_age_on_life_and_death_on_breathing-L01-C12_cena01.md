═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_18_l01_c12_cena01_on_youth_and_old_age_on_life_and_death_on_breathing

 (Final filename on disk: aristoteles_18_l01_c12_cena01_on_youth_and_old_age_on_life_and_death_on_breathing.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 1, Part 12 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 34 of 54 for *On Youth and Old Age, On Life and Death, On Breathing*.
...
1. **Título Principal:** "Guia de Estudos: Parva Naturalia — Juventude e Velhice, Vida e Morte, Respiração — SECTION 1, Capítulo Part 12 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Youth and Old Age, On Life and Death, On Breathing*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 1, Part 12, bounded by:

**Starts at:** "It is certain, however, that we must not entertain the notion that it is for purposes of nutrition that respiration is designed, and believe that the internal fire is fed by the breath; respiration, a"
**Ends at:** "A consequence also of this theory is that the nutriment would enter and the refuse be discharged by the same channel, but this does not appear to occur in the other instances."
