═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_16_l01_c01_cena01_on_prophesying_by_dreams

 (Final filename on disk: aristoteles_16_l01_c01_cena01_on_prophesying_by_dreams.m4a)
═══════════════════════════════════════════════════════════════════════════════

Act as a Senior Humanities Tutor specializing in the formative reading of Aristotle. Your goal is to write a detailed, highly pedagogical study guide (Guia de Estudos) to accompany and support the listener of the deep-dive audio overview of a specific passage from Aristotle's *On Prophesying by Dreams*.

**Context & Anchoring:**
- **Work:** On Prophesying by Dreams (Parva Naturalia — Sobre a Adivinhação pelos Sonhos), translated by Beare.
- **Passage Identifier:** BOOK I (inferido), Part 1 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 4 of 54 for *On Prophesying by Dreams*.
...
1. **Título Principal:** "Guia de Estudos: Parva Naturalia — Sobre a Adivinhação pelos Sonhos — BOOK I (inferido), Capítulo Part 1 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Prophesying by Dreams*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I (inferido), Part 1, bounded by:

**Starts at:** "As to the divination which takes place in sleep, and is said to be based on dreams, we cannot lightly either dismiss it with contempt or give it implicit confidence. The fact that all persons, or many"
**Ends at:** "Hence the fact that many dreams have no 'fulfilment', for coincidence do not occur according to any universal or general law."
