═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_17_l01_c06_cena01_on_longevity_and_shortness_of_life

 (Final filename on disk: aristoteles_17_l01_c06_cena01_on_longevity_and_shortness_of_life.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I (inferido), Part 6 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 27 of 54 for *On Longevity and Shortness of Life*.
...
1. **Título Principal:** "Guia de Estudos: Parva Naturalia — Sobre a Longevidade e a Brevidade da Vida — BOOK I (inferido), Capítulo Part 6 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Longevity and Shortness of Life*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I (inferido), Part 6, bounded by:

**Starts at:** "It is amongst the plants that we find the longest life-more than among the animals, for, in the first place, they are less watery and hence less easily frozen. Further they have an oiliness and a visc"
**Ends at:** "To come to a definite understanding about these matters would complete our course of study on animals."
