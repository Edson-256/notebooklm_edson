═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_12_l01_c01_cena01_on_sense_and_the_sensible

 (Final filename on disk: aristoteles_12_l01_c01_cena01_on_sense_and_the_sensible.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 5 of 54 for *On Sense and the Sensible*.
...
1. **Título Principal:** "Guia de Estudos: Parva Naturalia — Sobre o Sentido e o Sensível — SECTION 1, Capítulo Part 1 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Sense and the Sensible*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 1, Part 1, bounded by:

**Starts at:** "Having now definitely considered the soul, by itself, and its several faculties, we must next make a survey of animals and all living things, in order to ascertain what functions are peculiar, and wha"
**Ends at:** "Accordingly, of persons destitute from birth of either sense, the blind are more intelligent than the deaf and dumb."
