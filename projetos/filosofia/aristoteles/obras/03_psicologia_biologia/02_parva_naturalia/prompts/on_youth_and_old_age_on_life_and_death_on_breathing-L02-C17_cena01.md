═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_18_l02_c17_cena01_on_youth_and_old_age_on_life_and_death_on_breathing

 (Final filename on disk: aristoteles_18_l02_c17_cena01_on_youth_and_old_age_on_life_and_death_on_breathing.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 2, Part 17 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 44 of 54 for *On Youth and Old Age, On Life and Death, On Breathing*.
...
1. **Título Principal:** "Guia de Estudos: Parva Naturalia — Juventude e Velhice, Vida e Morte, Respiração — SECTION 2, Capítulo Part 17 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Youth and Old Age, On Life and Death, On Breathing*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 2, Part 17, bounded by:

**Starts at:** "Every animal in order to exist requires nutriment, in order to prevent itself from dying, refrigeration; and so Nature employs the same organ for both purposes. For, as in some cases the tongue serves"
**Ends at:** "For these reasons the expulsion of water and the seizing of their food is rapid, and their teeth are sharp and in almost all cases arranged in a saw-like fashion, for they are debarred from chewing th"
