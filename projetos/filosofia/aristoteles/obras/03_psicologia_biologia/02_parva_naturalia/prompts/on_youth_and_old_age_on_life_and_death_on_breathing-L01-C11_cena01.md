═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_18_l01_c11_cena01_on_youth_and_old_age_on_life_and_death_on_breathing

 (Final filename on disk: aristoteles_18_l01_c11_cena01_on_youth_and_old_age_on_life_and_death_on_breathing.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** SECTION 1, Part 11 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 33 of 54 for *On Youth and Old Age, On Life and Death, On Breathing*.
...
1. **Título Principal:** "Guia de Estudos: Parva Naturalia — Juventude e Velhice, Vida e Morte, Respiração — SECTION 1, Capítulo Part 11 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Youth and Old Age, On Life and Death, On Breathing*. For this specific guide, focus EXCLUSIVELY on the passage from SECTION 1, Part 11, bounded by:

**Starts at:** "The theory found in the Timaeus, of the passing round of the breath by pushing, by no means determines how, in the case of the animals other than land-animals, their heat is preserved, and whether it"
**Ends at:** "When it is hot we pant in breathing, for, because what enters does not adequately perform its cooling function, we have as a consequence to draw the breath frequently."
