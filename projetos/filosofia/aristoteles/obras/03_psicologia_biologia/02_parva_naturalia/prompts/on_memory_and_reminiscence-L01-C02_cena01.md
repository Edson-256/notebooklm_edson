═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_13_l01_c02_cena01_on_memory_and_reminiscence

 (Final filename on disk: aristoteles_13_l01_c02_cena01_on_memory_and_reminiscence.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK I (inferido), Part 2 (sub-cena 1 of 3).
- **Audio Position in This Work:** This is audio 10 of 54 for *On Memory and Reminiscence*.
...
1. **Título Principal:** "Guia de Estudos: Parva Naturalia — Sobre a Memória e a Reminiscência — BOOK I (inferido), Capítulo Part 2 (Cena 1/3)"
...
**Starts at:** "Next comes the subject of Recollection, in dealing with which we must assume as fundamental the truths elicited above in our introductory discussions. For recollection is not the 'recovery' or 'acquis"
**Ends at:** "from milk to white, from white to mist, and thence to moist, from which one remembers Autumn (the 'season of mists'), if this be the season he is trying to recollect."
