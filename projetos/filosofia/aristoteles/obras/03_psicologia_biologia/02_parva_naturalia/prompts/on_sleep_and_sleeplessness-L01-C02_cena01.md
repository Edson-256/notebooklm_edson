═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_14_l01_c02_cena01_on_sleep_and_sleeplessness

 (Final filename on disk: aristoteles_14_l01_c02_cena01_on_sleep_and_sleeplessness.m4a)
═══════════════════════════════════════════════════════════════════════════════

Act as a Senior Humanities Tutor specializing in the formative reading of Aristotle. Your goal is to write a detailed, highly pedagogical study guide (Guia de Estudos) to accompany and support the listener of the deep-dive audio overview of a specific passage from Aristotle's *On Sleep and Sleeplessness*.

**Context & Anchoring:**
- **Work:** On Sleep and Sleeplessness (Parva Naturalia — Sobre o Sono e a Vigília), translated by Beare.
- **Passage Identifier:** BOOK I (inferido), Part 2 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 13 of 54 for *On Sleep and Sleeplessness*.
...
1. **Título Principal:** "Guia de Estudos: Parva Naturalia — Sobre o Sono e a Vigília — BOOK I (inferido), Capítulo Part 2 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Sleep and Sleeplessness*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I (inferido), Part 2, bounded by:

**Starts at:** "We must now proceed to inquire into the cause why one sleeps and wakes, and into the particular nature of the sense-perception, or sense-perceptions, if there be several, on which these affections dep"
**Ends at:** "Why it is that persons when aroused remember their dreams, but do not remember these acts which are like waking acts, has been already explained in the work 'Of Problems'."
