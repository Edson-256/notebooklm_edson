═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_15_l01_c01_cena01_on_dreams

 (Final filename on disk: aristoteles_15_l01_c01_cena01_on_dreams.m4a)
═══════════════════════════════════════════════════════════════════════════════

Act as a Senior Humanities Tutor specializing in the formative reading of Aristotle. Your goal is to write a detailed, highly pedagogical study guide (Guia de Estudos) to accompany and support the listener of the deep-dive audio overview of a specific passage from Aristotle's *On Dreams*.

**Context & Anchoring:**
- **Work:** On Dreams (Parva Naturalia — Sobre os Sonhos), translated by Beare.
- **Passage Identifier:** BOOK I (inferido), Part 1 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 1 of 54 for *On Dreams*.
...
1. **Título Principal:** "Guia de Estudos: Parva Naturalia — Sobre os Sonhos — BOOK I (inferido), Capítulo Part 1 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *On Dreams*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK I (inferido), Part 1, bounded by:

**Starts at:** "We must, in the next place, investigate the subject of the dream, and first inquire to which of the faculties of the soul it presents itself, i.e. whether the affection is one which pertains to the fa"
**Ends at:** "h the essential notion of a faculty of presentation is different from that of a faculty of sense-perception; and since presentation is the movement set up by a sensory faculty when actually dischargin"
