═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_24_l10_c04_cena01_metafisica

 (Final filename on disk: aristoteles_24_l10_c04_cena01_metafisica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK X, Part 4 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 102 of 146 for *Metaphysics*.
...
1. **Título Principal:** "Guia de Estudos: Metafísica — BOOK X, Capítulo Part 4 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Metaphysics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK X, Part 4, bounded by:

**Starts at:** "\"Since things which differ may differ from one another more or less, there is also a greatest difference, and this I call contrariety. That contrariety is the greatest difference is made clear by indu"
**Ends at:** "the one and the many; for the others can be reduced to these."
