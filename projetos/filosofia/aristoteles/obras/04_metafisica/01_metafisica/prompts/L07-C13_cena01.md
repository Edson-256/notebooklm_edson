═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_24_l07_c13_cena01_metafisica

 (Final filename on disk: aristoteles_24_l07_c13_cena01_metafisica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Passage Identifier:** BOOK VII, Part 13 (sub-cena 1 of 1).
- **Audio Position in This Work:** This is audio 78 of 146 for *Metaphysics*.
...
1. **Título Principal:** "Guia de Estudos: Metafísica — BOOK VII, Capítulo Part 13 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Metaphysics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK VII, Part 13, bounded by:

**Starts at:** "\"Let us return to the subject of our inquiry, which is substance."
**Ends at:** "And what we are saying will be plainer from what follows."
