═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_24_l03_c04_cena02_metafisica

 (Final filename on disk: aristoteles_24_l03_c04_cena02_metafisica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 19 of 146 for *Metaphysics*.
...
1. **Título Principal:** "Guia de Estudos: Metafísica — BOOK III, Capítulo Part 4 (Cena 2/2)"
...
The sources uploaded to NotebookLM contain the full text of *Metaphysics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK III, Part 4, bounded by:

**Starts at:** "\"Let this suffice as proof of the fact that the principles cannot be the same. But if there are different principles, one difficulty is whether these also will be imperishable or perishable. For if th"
**Ends at:** "For it is not evident how magnitudes could proceed either from the one and this principle, or from some number and this principle."
