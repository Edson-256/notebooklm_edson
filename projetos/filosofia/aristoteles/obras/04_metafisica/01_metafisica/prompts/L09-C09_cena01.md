═══════════════════════════════════════════════════════════════════════════════
 AUDIO TITLE — rename the generated audio in NLM Studio to exactly this:
    ...
    aristoteles_24_l09_c09_cena01_metafisica

 (Final filename on disk: aristoteles_24_l09_c09_cena01_metafisica.m4a)
═══════════════════════════════════════════════════════════════════════════════
...
- **Audio Position in This Work:** This is audio 97 of 146 for *Metaphysics*.
...
1. **Título Principal:** "Guia de Estudos: Metafísica — BOOK IX, Capítulo Part 9 (Cena 1/1)"
...
The sources uploaded to NotebookLM contain the full text of *Metaphysics*. For this specific guide, focus EXCLUSIVELY on the passage from BOOK IX, Part 9, bounded by:

**Starts at:** "\"That the actuality is also better and more valuable than the good potency is evident from the following argument. Everything of which we say that it can do something, is alike capable of contraries,"
**Ends at:** "Obviously, therefore, the potentially existing constructions are discovered by being brought to actuality; the reason is that the geometer's thinking is an actuality; so that the potency proceeds from"
