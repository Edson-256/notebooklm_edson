...
**Context & Anchoring:**
- **Scene Identifier:** C_05-Promesi Sposi_cena004
...
**Starts at:** "-- Ma questo -- replicava, non meno urlando, il podestà, -- questo è un di più, un mero di più, un ornamento poetico, giacché il messaggiero è di una natura inviolabile, per diritto delle genti, jure ..."
**Ends at:** "-- Scuse magre: -- gridarono i due cugini: -- vogliamo la sentenza."
