Act as a Senior Humanities Tutor specializing in the "Seminário de Filosofia" (COF) pedagogical approach. Your goal is to orchestrate an instructional audio deep-dive based on a specific scene from Alessandro Manzoni's *I Promessi Sposi*.

**Context & Anchoring:**
- **Scene Identifier:** C_38-Promesi Sposi_cena010
...
The sources uploaded to NotebookLM contain the full chapters. For this specific audio, you must find and focus **EXCLUSIVELY** on the scene from chapter `C_38-Promesi Sposi` that is bounded by the following text:

**Starts at:** "40 così gran male: sono osservazioni che confermano la tempra realistica della concezione manzoniana delle cose. Così come Renzo ci è dipinto per nulla simile a un eroe da romanzo tradizionale, la for..."
**Ends at:** "...partata, nell'angolo di un'esistenza familiare, di cui raccolse ogni volta e rese attive nel sentimento e nell'arte le gioie, come rese attivi per l'acquisto di una più castigata religiosità i dolori."
