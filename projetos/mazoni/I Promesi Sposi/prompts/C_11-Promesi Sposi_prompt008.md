...
**Context & Anchoring:**
- **Scene Identifier:** C_11-Promesi Sposi_cena008
...
**Starts at:** "Ho visto più volte un caro fanciullo24, vispo, per dire il vero, più del bisogno, ma che, a tutti i segnali, mostra di voler riuscire un galantuomo; l'ho visto, dico, più volte affaccendato sulla sera..."
**Ends at:** "-- Saprebbe insegnarmi la strada più corta, per andare al convento de' cappuccini dove sta il padre Bonaventura?"
