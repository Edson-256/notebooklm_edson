...
**Context & Anchoring:**
- **Scene Identifier:** C_21-Promesi Sposi_cena009
...
The sources uploaded to NotebookLM contain the full chapters. For this specific audio, you must find and focus **EXCLUSIVELY** on the scene from chapter `C_21-Promesi Sposi` that is bounded by the following text:

**Starts at:** "8 salir di corsa il Nibbio: si noti il tono assorto della constatazione dell'innominato in attesa; quasiché egli dovesse far forza su se stesso per riportarsi a quel che gli succede sotto gli occhi."
**Ends at:** "...6 una chiamata interna: proprio come avviene nei momenti più gravi della vita, tutto diventa in questa notte arcano e allusivo. Così, questo soprassalto di ripresa della coscienza imbevuta di terrore."
